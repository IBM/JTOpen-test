...
@exception Exception If an exception occurs.
**/
   public JDRSStressTest (String[] args)
   throws Exception
   {
      super (args);
   }
...
**/
   public void createTestcases2 ()
   {
      ...
      addTestcase (new JDRSStress (systemObject_,
					   namesAndVars_, runMode_, fileOutputStream_, 
					   password_));
      addTestcase (new JDRSStressScroll (systemObject_,
					   namesAndVars_, runMode_, fileOutputStream_, 
					   password_));
      addTestcase (new JDRSStressPS (systemObject_,
					   namesAndVars_, runMode_, fileOutputStream_, 
					   password_));

      addTestcase (new JDRSStressPSBatch (systemObject_,
					   namesAndVars_, runMode_, fileOutputStream_, 
					   password_));

      addTestcase (new JDRSStressUpdatePS (systemObject_,
					   namesAndVars_, runMode_, fileOutputStream_, 
					   password_));

      addTestcase (new JDRSStressScrollPS (systemObject_,
					   namesAndVars_, runMode_, fileOutputStream_, 
					   password_));

	  addTestcase (new JDRSStressDirectMap (systemObject_,
						namesAndVars_, runMode_, fileOutputStream_, 
						password_));
	  addTestcase (new JDRSStressScrollDirectMap (systemObject_,
						namesAndVars_, runMode_, fileOutputStream_, 
						password_));

	  addTestcase (new JDRSStressPSDirectMap (systemObject_,
						namesAndVars_, runMode_, fileOutputStream_, 
						password_));
	  addTestcase (new JDRSStressScrollPSDirectMap (systemObject_,
						namesAndVars_, runMode_, fileOutputStream_, 
						password_));
	  addTestcase (new JDRSStressUpdatePSDirectMap (systemObject_,
						namesAndVars_, runMode_, fileOutputStream_, 
						password_));

	  addTestcase (new JDRSStressNoBlockPSDirectMap (systemObject_,
						namesAndVars_, runMode_, fileOutputStream_, 
						password_));
