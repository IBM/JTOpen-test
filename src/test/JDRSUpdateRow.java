...
/**
Testcase JDRSUpdateRow.  This tests the following method
...
Constructor.
**/
    public JDRSUpdateRow (AS400 systemObject,
                                    ...
                                    String password)
    {
        super (systemObject, "JDRSUpdateRow",
...
/**
updateRow() - Should throw exception when the result set is
closed.
**/
    public void Var001()
    {   
...
/**
updateRow() - Should throw exception when cursor is not pointing
to a row.
**/
    public void Var003()
    {
...
/**
updateRow() - Should update exactly 3 columns when updates are
pending.
**/
    public void Var006()
    {
...
/**
updateRow() - Updated row should be reflected in the result set
...
/**
updateRow() - Should update appropriately when the result set
...
/**
updateRow() - Columns specified for a previous update should not
...
<P>
SQL400 - Today, the native JDBC driver has no chance of handling the 
         cursor name that is mixed case and has a space in it.  It 
         appears that the SQ path we end up taking uppercases all 
         cursor names.  This will be investigated as there is time.
<P>
<B>Note:</B> The JDBC specification states that getting a value from a SMALLINT
database column with getObject() will return an java.lang.Integer object, not a 
java.lang.Short object.  This testcase has been changed to match that expectation.
...
/**
rowUpdated() - Should return false on all rows in another result set
after repositioning.
**/
    public void Var012()
    {
...
/**
cancelRowUpdates() - Should throw exception when the result set is
closed.
**/
    public void Var014()
    {
...
/**
cancelRowUpdates() - Should have no effect when cursor is not pointing
to a row.
**/
    public void Var016()
    {
...
/**
cancelRowUpdates() - Should  not preclude the ability to update
afterwards.
**/
    public void Var019()
    {
    ...
    public void Var021()
    {
       ...
       {                 
          if (getRelease() > JDTestDriver.RELEASE_V5R1M0)
          {
             ...
             notApplicable("Testcase requires OS/400 v5r2 or later");
       }
    }
...
**/
    public void Var023()
    {
	   ...
	   if ( getRelease() <= JDTestDriver.RELEASE_V5R2M0 &&            // @E2A
		getDriver() == JDTestDriver.DRIVER_NATIVE )	{
		   ...
		   ResultSet rs = s.executeQuery("SELECT * FROM " + table1 + " WHERE SSN IS NOT NULL AND SSN NOT IN (SELECT SSN FROM " + table2 + ")"); 
		   String before = null;
		   String after = null;
		   ...
		   rs = s.executeQuery("SELECT * FROM " + table1 + " WHERE SSN IS NOT NULL AND SSN NOT IN (SELECT SSN FROM " + table2 + ")"); 
		   if(rs.next())
		       afterRowUpdate = rs.getString(1);
		   rs.close();
		   s.close();
		   
		   assertCondition("123456789".equals(before) && 
		         "369258147".equals(after) && 
		         "369258147".equals(afterRowUpdate) 
		         && numRows == 2);
    ...
    /**
    updateRow() - Using column alias with "extended metadata" connection property set to true           //@E3A
    **/
    public void Var024() 
    {
    ...
    /**
    updateRow() - Using column alias with "extended metadata" connection property set to false           //@E3A
    **/
    public void Var025() 
    {
	if(checkJdbc20())
