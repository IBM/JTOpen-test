...
/**
Testcase JDRSUpdateBinaryStream.  This tests the following method
...
**/
    public JDRSUpdateBinaryStream (AS400 systemObject,
                                    ...
                                    String password)
    {
        super (systemObject, "JDRSUpdateBinaryStream",
...
/**
updateBinaryStream() - Should throw exception when the result set is
closed.
**/
    public void Var001()
    {
...
/**
updateBinaryStream() - Should throw exception when cursor is not pointing
to a row.
**/
    public void Var003()
    {
        ...
        try {
            ...
            rs_.updateBinaryStream ("C_VARBINARY_20", new ByteArrayInputStream (new byte[] { (byte) 12, (byte) 34, (byte) 98 }), 3);
            rs_.updateRow(); 
            failed ("Didn't throw SQLException");
        }
        catch (Exception e) {
...
/**
updateBinaryStream() - Should throw an exception when the column
is an invalid index.
**/
    public void Var004()
    {
...
/**
updateBinaryStream() - Should update to SQL NULL when the column
value is null.
**/
    public void Var012()
    {
...
**/
    public void Var013()
    {
        ...
        try {
            JDRSTest.position (rs_, key_);
            rs_.updateBinaryStream ("C_VARBINARY_20", new ByteArrayInputStream (new byte[] { (byte) 12, (byte) 34, (byte) 98 }), -1);
            failed ("Didn't throw SQLException");
        }
        catch (Exception e) {
            assertExceptionIsInstanceOf (e, "java.sql.SQLException");
...
/**
updateBinaryStream() - Should be reflected by get, even if update has
...
/**
updateBinaryStream() - Should be reflected by get, after update has
...
/**
updateBinaryStream() - Should work when the current row is the insert
row.
**/
    public void Var017()
    {
...
**/
    public void Var030 ()
    {
        ...
        try {
            ...
            rs_.updateBinaryStream ("C_BINARY_1", new ByteArrayInputStream (new byte[] { (byte) 54, (byte) 64, (byte) 0 }), 3);
            rs_.updateRow ();
            failed ("Didn't throw SQLException");
        }
        catch (Exception e) {
...
/**
updateBinaryStream() - Update a VARBINARY with a "normal" binary stream,
and the length equal to the full stream.
**/
    public void Var031 ()
    {
        if (checkJdbc20 ()) {
...
/**
updateBinaryStream() - Update a VARBINARY with a "normal" binary stream,
and the length less than the full stream.
**/
    public void Var032 ()
    {
        if (checkJdbc20 ()) {
...
/**
updateBinaryStream() - Update a VARBINARY with a "normal" binary stream,
and the length greater than the full stream.
**/
    public void Var033 ()
    {
        if (checkJdbc20 ()) {
...
**/
    public void Var046 ()
    {
        ...
        if (checkDatalinkSupport ()) {
            ...
            try {
                JDRSTest.position (rs_, key_);
                rs_.updateBinaryStream ("C_DATALINK", new ByteArrayInputStream (new byte[] { (byte) 113 }), 1);
                failed ("Didn't throw SQLException");
            }
            catch (Exception e) {
                assertExceptionIsInstanceOf (e, "java.sql.SQLException");
