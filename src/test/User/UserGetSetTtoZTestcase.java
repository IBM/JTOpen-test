...
/**
 * Testcase UserGetSetTestcase. This tests the get and set methods of the User
 * class.
 **/
public class UserGetSetTtoZTestcase extends Testcase {
  ...
  private boolean checkArray(String[] returnValue, String[] expectedValue) {
    if (returnValue.length != expectedValue.length)
      return false;
    for (int i = 0; i < returnValue.length; ++i) {
      if (!returnValue[i].equals(expectedValue[i]))
        return false;
    }
    return true;
  }
   ...
   * <dl>
   * <dt>Test:</dt>
   * <dd>Call User::getUserActionAuditLevel() before setting.</dd>
   * <dt>Result:</dt>
   * <dd>Verify correct initial value is returned.</dd>
   * </dl>
   **/
  public void Var001() {
    try {
   ...
   * <dl>
   * <dt>Test:</dt>
   * <dd>Call User::setUserActionAuditLevel(String[]) with a valid parameter of
   * *NONE.</dd>
   * <dt>Result:</dt>
   * <dd>Verify User::getUserActionAuditLevel() returns a zero length array.</dd>
   * </dl>
   **/
  public void Var002() {
    try {
   ...
   * *CMD.</dd>
   * <dt>Result:</dt>
   * <dd>Verify User::getUserActionAuditLevel() returns *CMD.</dd>
   * </dl>
   **/
  public void Var003() {
    try {
   ...
   * *CREATE.</dd>
   * <dt>Result:</dt>
   * <dd>Verify User::getUserActionAuditLevel() returns *CREATE.</dd>
   * </dl>
   **/
  public void Var004() {
    try {
   ...
   * *DELETE.</dd>
   * <dt>Result:</dt>
   * <dd>Verify User::getUserActionAuditLevel() returns *DELETE.</dd>
   * </dl>
   **/
  public void Var005() {
    try {
   ...
   * *JOBDTA.</dd>
   * <dt>Result:</dt>
   * <dd>Verify User::getUserActionAuditLevel() returns *JOBDTA.</dd>
   * </dl>
   **/
  public void Var006() {
    try {
   ...
   * *OBJMGT.</dd>
   * <dt>Result:</dt>
   * <dd>Verify User::getUserActionAuditLevel() returns *OBJMGT.</dd>
   * </dl>
   **/
  public void Var007() {
    try {
   ...
   * *OFCSRV.</dd>
   * <dt>Result:</dt>
   * <dd>Verify User::getUserActionAuditLevel() returns *OFCSRV.</dd>
   * </dl>
   **/
  public void Var008() {
    try {
   ...
   * *PGMADP.</dd>
   * <dt>Result:</dt>
   * <dd>Verify User::getUserActionAuditLevel() returns *PGMADP.</dd>
   * </dl>
   **/
  public void Var009() {
    try {
   ...
   * *SAVRST.</dd>
   * <dt>Result:</dt>
   * <dd>Verify User::getUserActionAuditLevel() returns *SAVRST.</dd>
   * </dl>
   **/
  public void Var010() {
    try {
   ...
   * *SECURITY.</dd>
   * <dt>Result:</dt>
   * <dd>Verify User::getUserActionAuditLevel() returns *SECURITY.</dd>
   * </dl>
   **/
  public void Var011() {
    try {
   ...
   * *SERVICE.</dd>
   * <dt>Result:</dt>
   * <dd>Verify User::getUserActionAuditLevel() returns *SERVICE.</dd>
   * </dl>
   **/
  public void Var012() {
    try {
   ...
   * *SPLFDTA.</dd>
   * <dt>Result:</dt>
   * <dd>Verify User::getUserActionAuditLevel() returns *SPLFDTA.</dd>
   * </dl>
   **/
  public void Var013() {
    try {
   ...
   * *SYSMGT.</dd>
   * <dt>Result:</dt>
   * <dd>Verify User::getUserActionAuditLevel() returns *SYSMGT.</dd>
   * </dl>
   **/
  public void Var014() {
    try {
   ...
   * *OPTICAL.</dd>
   * <dt>Result:</dt>
   * <dd>Verify User::getUserActionAuditLevel() returns *OPTICAL.</dd>
   * </dl>
   **/
  public void Var015() {
    try {
   ...
   * length 2.</dd>
   * <dt>Result:</dt>
   * <dd>Verify User::getUserActionAuditLevel() returns the values.</dd>
   * </dl>
   **/
  public void Var016() {
    try {
   ...
   * <dt>Test:</dt>
   * <dd>Call User::setUserActionAuditLevel(String[]) with a valid parameter of
   * length 4 with a duplicate.</dd>
   * <dt>Result:</dt>
   * <dd>Verify User::getUserActionAuditLevel() returns the 3 unique values.</dd>
   * </dl>
   **/
  public void Var019() {
    try {
  ...
  public void Var022() {
    try {
      ...
      String[] expectedValue = new String[] { "*CMD", "*CREATE", "*DELETE", "*JOBDTA", "*OFCSRV", "*PGMADP",
          "*SERVICE" };
      u.setUserActionAuditLevel(testValue);
      String[] returnValue = u.getUserActionAuditLevel();
      assertCondition(checkArray(returnValue, expectedValue));
  ...
  public void Var023() {
    try {
      User u = new User(pwrSys_, sandbox_.createUser());
      String[] testValue = new String[] { "*DELETE", "*OFCSRV", "*JOBDTA", "*OBJMGT", "*PGMADP", "*SERVICE", "*CMD",
          "*CREATE" };
      String[] expectedValue = new String[] { "*CMD", "*CREATE", "*DELETE", "*JOBDTA", "*OBJMGT", "*OFCSRV", "*PGMADP",
          "*SERVICE" };
      u.setUserActionAuditLevel(testValue);
      String[] returnValue = u.getUserActionAuditLevel();
      assertCondition(checkArray(returnValue, expectedValue));
  ...
  public void Var024() {
    try {
      User u = new User(pwrSys_, sandbox_.createUser());
      String[] testValue = new String[] { "*DELETE", "*OPTICAL", "*OFCSRV", "*SAVRST", "*JOBDTA", "*OBJMGT", "*SPLFDTA",
          "*PGMADP", "*SERVICE", "*SYSMGT", "*CMD", "*CREATE", "*SECURITY" };
      String[] expectedValue = new String[] { "*CMD", "*CREATE", "*DELETE", "*JOBDTA", "*OBJMGT", "*OFCSRV", "*PGMADP",
          "*SAVRST", "*SECURITY", "*SERVICE", "*SPLFDTA", "*SYSMGT", "*OPTICAL" };
      u.setUserActionAuditLevel(testValue);
      String[] returnValue = u.getUserActionAuditLevel();
      assertCondition(checkArray(returnValue, expectedValue));
    } catch (Exception e) {
   ...
   * <dl>
   * <dt>Test:</dt>
   * <dd>Call User::setUserActionAuditLevel(String[]) with a zero length array
   * parameter.</dd>
   * <dt>Result:</dt>
   * <dd>Verify User::getUserActionAuditLevel() returns a zero length array.</dd>
   * </dl>
   ...
   * <dl>
   * <dt>Test:</dt>
   * <dd>Call User::setUserActionAuditLevel(String[]) with a parameter of empty
   * string.</dd>
   * <dt>Result:</dt>
   * <dd>Verify that an AS400Exception is thrown.</dd>
   * </dl>
   **/
  public void Var026() {
    try {
   ...
   * <dl>
   * <dt>Test:</dt>
   * <dd>Call User::setUserActionAuditLevel(String[]) with a parameter of
   * "*SAME".</dd>
   * <dt>Result:</dt>
   * <dd>Verify that an AS400Exception is thrown.</dd>
   * </dl>
   ...
   * <dl>
   * <dt>Test:</dt>
   * <dd>Call User::setUserActionAuditLevel(String[]) with a not valid value
   * parameter of *NONE and another value.</dd>
   * <dt>Result:</dt>
   * <dd>Verify that an AS400Exception is thrown.</dd>
   * </dl>
   **/
   ...
   * <dt>Test:</dt>
   * <dd>Call User::setUserActionAuditLevel(String[]) with a not valid value
   * parameter as an element of the array.</dd>
   * <dt>Result:</dt>
   * <dd>Verify that an AS400Exception is thrown.</dd>
   * </dl>
   **/
   ...
   * <dl>
   * <dt>Test:</dt>
   * <dd>Call User::setUserActionAuditLevel(String[]) with a not valid over length
   * parameter.</dd>
   * <dt>Result:</dt>
   * <dd>Verify that an AS400Exception is thrown.</dd>
   * </dl>
   ...
   * <dl>
   * <dt>Test:</dt>
   * <dd>Call User::setUserActionAuditLevel(String[]) with a null parameter.</dd>
   * <dt>Result:</dt>
   ...
   * <dl>
   * <dt>Test:</dt>
   * <dd>Call User::setUserActionAuditLevel(String[]) with an array parameter that
   * is just a null value.</dd>
   * <dt>Result:</dt>
   * <dd>Verify that a AS400Exception is thrown.</dd>
   * </dl>
   **/
  public void Var033() {
    try {
   ...
   * <dl>
   * <dt>Test:</dt>
   * <dd>Call User::setUserActionAuditLevel(String[]) before system is set.</dd>
   * <dt>Result:</dt>
   * <dd>Verify that a ExtendedIllegalStateException is thrown.</dd>
   * </dl>
   **/
  public void Var035() {
    try {
   ...
   * <dl>
   * <dt>Test:</dt>
   * <dd>Call User::setUserActionAuditLevel(String[]) before name is set.</dd>
   * <dt>Result:</dt>
   * <dd>Verify that a ExtendedIllegalStateException is thrown.</dd>
   * </dl>
   **/
  public void Var036() {
    try {
      ...
      try {
        ...
        assertExceptionStartsWith(e, "ExtendedIllegalStateException", "name: ",
            ExtendedIllegalStateException.PROPERTY_NOT_SET);
      }
    } catch (Exception e) {
      failed(e, "Unexpected exception.");
   ...
   * <dl>
   * <dt>Test:</dt>
   * <dd>Call User::getUserClassName() before setting.</dd>
   * <dt>Result:</dt>
   * <dd>Verify correct initial value is returned.</dd>
   * </dl>
   **/
   ...
   * <dl>
   * <dt>Test:</dt>
   * <dd>Call User::setUserClassName(String) with a valid parameter of *USER.</dd>
   * <dt>Result:</dt>
   * <dd>Verify User::getUserClassName() returns *USER.</dd>
   * </dl>
   **/
  public void Var038() {
    try {
   ...
   * <dl>
   * <dt>Test:</dt>
   * <dd>Call User::setUserClassName(String) with a valid parameter of
   * *SYSOPR.</dd>
   * <dt>Result:</dt>
   * <dd>Verify User::getUserClassName() returns *SYSOPR.</dd>
   * </dl>
   **/
  public void Var039() {
    try {
   ...
   * <dl>
   * <dt>Test:</dt>
   * <dd>Call User::setUserClassName(String) with a valid parameter of *PGMR.</dd>
   * <dt>Result:</dt>
   * <dd>Verify User::getUserClassName() returns *PGMR.</dd>
   * </dl>
   **/
  public void Var040() {
    try {
   ...
   * *SECADM.</dd>
   * <dt>Result:</dt>
   * <dd>Verify User::getUserClassName() returns *SECADM.</dd>
   * </dl>
   **/
  public void Var041() {
    try {
   ...
   * *SECOFR.</dd>
   * <dt>Result:</dt>
   * <dd>Verify User::getUserClassName() returns *SECOFR.</dd>
   * </dl>
   **/
  public void Var042() {
    try {
   ...
   * <dl>
   * <dt>Test:</dt>
   * <dd>Call User::setUserClassName(String) with a parameter of empty
   * string.</dd>
   * <dt>Result:</dt>
   * <dd>Verify User::getUserClassName() returns *USER.</dd>
   * </dl>
   ...
   * <dl>
   * <dt>Test:</dt>
   * <dd>Call User::setUserClassName(String) with a parameter of "*SAME".</dd>
   * <dt>Result:</dt>
   * <dd>Verify User::getUserClassName() returns *USER.</dd>
   * </dl>
   **/
   ...
   * <dl>
   * <dt>Test:</dt>
   * <dd>Call User::setUserClassName(String) with a not valid value
   * parameter.</dd>
   * <dt>Result:</dt>
   * <dd>Verify that an AS400Exception is thrown.</dd>
   * </dl>
   ...
   * <dl>
   * <dt>Test:</dt>
   * <dd>Call User::setUserClassName(String) with a not valid over length
   * parameter.</dd>
   * <dt>Result:</dt>
   * <dd>Verify that an AS400Exception is thrown.</dd>
   * </dl>
   ...
   * <dl>
   * <dt>Test:</dt>
   * <dd>Call User::setUserClassName(String) with a null parameter.</dd>
   * <dt>Result:</dt>
   * <dd>Verify that a NullPointerException is thrown.</dd>
   * </dl>
   **/
   ...
   * <dl>
   * <dt>Test:</dt>
   * <dd>Call User::setUserClassName(String) before system is set.</dd>
   * <dt>Result:</dt>
   * <dd>Verify that a ExtendedIllegalStateException is thrown.</dd>
   * </dl>
   **/
   ...
   * <dl>
   * <dt>Test:</dt>
   * <dd>Call User::setUserClassName(String) before name is set.</dd>
   * <dt>Result:</dt>
   * <dd>Verify that a ExtendedIllegalStateException is thrown.</dd>
   * </dl>
   **/
   ...
   * <dl>
   * <dt>Test:</dt>
   * <dd>Call User::getUserID() before setting.</dd>
   * <dt>Result:</dt>
   * <dd>Verify correct initial value is returned.</dd>
   * </dl>
   **/
   ...
   * <dl>
   * <dt>Test:</dt>
   * <dd>Call User::getUserIDNumber() before setting.</dd>
   * <dt>Result:</dt>
   * <dd>Verify correct initial value is returned.</dd>
   * </dl>
   **/
   ...
   * <dl>
   * <dt>Test:</dt>
   * <dd>Call User::setUserID(long) with a valid parameter of 147823.</dd>
   * <dt>Result:</dt>
   * <dd>Verify User::getUserID() returns 147823.</dd>
   * </dl>
   **/
  public void Var052() {
    try {
   ...
   * <dl>
   * <dt>Test:</dt>
   * <dd>Call User::setUserID(long) with a valid parameter of 147824.</dd>
   * <dt>Result:</dt>
   * <dd>Verify User::getUserIDNumber() returns 147824.</dd>
   * </dl>
   **/
  public void Var053() {
    try {
   ...
   * <dl>
   * <dt>Test:</dt>
   * <dd>Call User::setUserID(long) with a valid parameter of 147827 on a group
   * profile.</dd>
   * <dt>Result:</dt>
   * <dd>Verify User::getUserID() returns 147827.</dd>
   * </dl>
   **/
  public void Var054() {
    try {
   ...
   * <dl>
   * <dt>Test:</dt>
   * <dd>Call User::setUserID(long) with a valid parameter of 147828 on a group
   * profile.</dd>
   * <dt>Result:</dt>
   * <dd>Verify User::getUserIDNumber() returns 147828.</dd>
   * </dl>
   **/
  public void Var055() {
    try {
   ...
   * <dl>
   * <dt>Test:</dt>
   * <dd>Call User::setUserID(long) with a valid parameter of 1.</dd>
   * <dt>Result:</dt>
   * <dd>Verify User::getUserID() returns 1.</dd>
   * </dl>
   **/
  public void Var056() {
    try {
   ...
   * <dd>Call User::setUserID(long) with a valid parameter of 1.</dd>
   * <dt>Result:</dt>
   * <dd>Verify User::getUserIDNumber() returns 1.</dd>
   * </dl>
   **/
  public void Var057() {
    try {
   ...
   * <dl>
   * <dt>Test:</dt>
   * <dd>Call User::setUserID(long) with a valid parameter of 4294967294.</dd>
   * <dt>Result:</dt>
   * <dd>Verify User::getUserID() returns 4294967294.</dd>
   * </dl>
   **/
  public void Var058() {
    try {
   ...
   * <dd>Call User::setUserID(long) with a valid parameter of 4294967294.</dd>
   * <dt>Result:</dt>
   * <dd>Verify User::getUserIDNumber() returns -2.</dd>
   * </dl>
   **/
  public void Var059() {
   ...
   * <dl>
   * <dt>Test:</dt>
   * <dd>Call User::setUserID(long) with a not valid value parameter that is
   * already taken.</dd>
   * <dt>Result:</dt>
   * <dd>Verify that an AS400Exception is thrown.</dd>
   * </dl>
   ...
   * <dl>
   * <dt>Test:</dt>
   * <dd>Call User::setUserID(long) with a not valid value parameter of -1.</dd>
   * <dt>Result:</dt>
   * <dd>Verify that an AS400Exception is thrown.</dd>
   * </dl>
   **/
   ...
   * <dl>
   * <dt>Test:</dt>
   * <dd>Call User::setUserID(long) with a not valid parameter of 0.</dd>
   * <dt>Result:</dt>
   * <dd>Verify that an AS400Exception is thrown.</dd>
   * </dl>
   **/
   ...
   * <dl>
   * <dt>Test:</dt>
   * <dd>Call User::setUserID(long) with a not valid value parameter of
   * 4294967295.</dd>
   * <dt>Result:</dt>
   * <dd>Verify that an AS400Exception is thrown.</dd>
   * </dl>
   ...
   * <dl>
   * <dt>Test:</dt>
   * <dd>Call User::setUserID(long) before system is set.</dd>
   * <dt>Result:</dt>
   * <dd>Verify that a ExtendedIllegalStateException is thrown.</dd>
   * </dl>
   **/
   ...
   * <dl>
   * <dt>Test:</dt>
   * <dd>Call User::setUserID(long) before name is set.</dd>
   * <dt>Result:</dt>
   * <dd>Verify that a ExtendedIllegalStateException is thrown.</dd>
   * </dl>
   **/
   ...
   * <dl>
   * <dt>Test:</dt>
   * <dd>Call User::getUserOptions() before setting.</dd>
   * <dt>Result:</dt>
   * <dd>Verify correct initial value is returned.</dd>
   * </dl>
   **/
   ...
   * <dl>
   * <dt>Test:</dt>
   * <dd>Call User::setUserOptions(String[]) with a valid parameter of *NONE.</dd>
   * <dt>Result:</dt>
   * <dd>Verify User::getUserOptions() returns a zero length array.</dd>
   * </dl>
   **/
  public void Var067() {
    try {
   ...
   * <dl>
   * <dt>Test:</dt>
   * <dd>Call User::setUserOptions(String[]) with a valid parameter of
   * *CLKWD.</dd>
   * <dt>Result:</dt>
   * <dd>Verify User::getUserOptions() returns *CLKWD.</dd>
   * </dl>
   **/
  public void Var068() {
    try {
   ...
   * *EXPERT.</dd>
   * <dt>Result:</dt>
   * <dd>Verify User::getUserOptions() returns *EXPERT.</dd>
   * </dl>
   **/
  public void Var069() {
    try {
   ...
   * *HLPFULL.</dd>
   * <dt>Result:</dt>
   * <dd>Verify User::getUserOptions() returns *HLPFULL.</dd>
   * </dl>
   **/
  public void Var070() {
    try {
   ...
   * *STSMSG.</dd>
   * <dt>Result:</dt>
   * <dd>Verify User::getUserOptions() returns *STSMSG.</dd>
   * </dl>
   **/
  public void Var071() {
    try {
   ...
   * *NOSTSMSG.</dd>
   * <dt>Result:</dt>
   * <dd>Verify User::getUserOptions() returns *NOSTSMSG.</dd>
   * </dl>
   **/
  public void Var072() {
    try {
   ...
   * *ROLLKEY.</dd>
   * <dt>Result:</dt>
   * <dd>Verify User::getUserOptions() returns *ROLLKEY.</dd>
   * </dl>
   **/
  public void Var073() {
    try {
   ...
   * *PRTMSG.</dd>
   * <dt>Result:</dt>
   * <dd>Verify User::getUserOptions() returns *PRTMSG.</dd>
   * </dl>
   **/
  public void Var074() {
    try {
   ...
   * <dl>
   * <dt>Test:</dt>
   * <dd>Call User::setUserOptions(String[]) with a valid parameter of length
   * 2.</dd>
   * <dt>Result:</dt>
   * <dd>Verify User::getUserOptions() returns the values.</dd>
   * </dl>
   **/
  public void Var075() {
    try {
   ...
   * <dl>
   * <dt>Test:</dt>
   * <dd>Call User::setUserOptions(String[]) with a valid parameter of length 4
   * with a duplicate.</dd>
   * <dt>Result:</dt>
   * <dd>Verify User::getUserOptions() returns the 3 unique values.</dd>
   * </dl>
   **/
  public void Var078() {
    try {
   ...
   * <dl>
   * <dt>Test:</dt>
   * <dd>Call User::setUserOptions(String[]) with a zero length array
   * parameter.</dd>
   * <dt>Result:</dt>
   * <dd>Verify User::getUserOptions() returns a zero length array.</dd>
   * </dl>
   ...
   * <dl>
   * <dt>Test:</dt>
   * <dd>Call User::setUserOptions(String[]) with a parameter of empty
   * string.</dd>
   * <dt>Result:</dt>
   * <dd>Verify User::getUserOptions() returns a zero length array.</dd>
   * </dl>
   ...
   * <dl>
   * <dt>Test:</dt>
   * <dd>Call User::setUserOptions(String[]) with a parameter of "*SAME".</dd>
   * <dt>Result:</dt>
   * <dd>Verify User::getUserOptions() returns a zero length array.</dd>
   * </dl>
   **/
   ...
   * <dl>
   * <dt>Test:</dt>
   * <dd>Call User::setUserOptions(String[]) with a not valid value parameter of
   * *STSMSG and *NOSTSMSG.</dd>
   * <dt>Result:</dt>
   * <dd>Verify that an AS400Exception is thrown.</dd>
   * </dl>
   **/
   ...
   * <dt>Test:</dt>
   * <dd>Call User::setUserOptions(String[]) with a not valid value parameter of
   * *STSMSG and *NOSTSMSG as part of all 7 options.</dd>
   * <dt>Result:</dt>
   * <dd>Verify that an AS400Exception is thrown.</dd>
   * </dl>
   **/
  public void Var085() {
    try {
      User u = new User(pwrSys_, sandbox_.createUser());
      String[] testValue = new String[] { "*CLKWD", "*EXPERT", "*HLPFULL", "*STSMSG", "*NOSTSMSG", "*ROLLKEY",
          "*PRTMSG" };
      try {
        u.setUserOptions(testValue);
        failed("No exception.");
   ...
   * <dl>
   * <dt>Test:</dt>
   * <dd>Call User::setUserOptions(String[]) with a not valid value
   * parameter.</dd>
   * <dt>Result:</dt>
   * <dd>Verify that an AS400Exception is thrown.</dd>
   * </dl>
   ...
   * <dl>
   * <dt>Test:</dt>
   * <dd>Call User::setUserOptions(String[]) with a not valid value parameter as
   * an element of the array.</dd>
   * <dt>Result:</dt>
   * <dd>Verify that an AS400Exception is thrown.</dd>
   * </dl>
   **/
   ...
   * <dl>
   * <dt>Test:</dt>
   * <dd>Call User::setUserOptions(String[]) with a not valid over length
   * parameter.</dd>
   * <dt>Result:</dt>
   * <dd>Verify that an AS400Exception is thrown.</dd>
   * </dl>
   ...
   * <dl>
   * <dt>Test:</dt>
   * <dd>Call User::setUserOptions(String[]) with a null parameter.</dd>
   * <dt>Result:</dt>
   * <dd>Verify that a NullPointerException is thrown.</dd>
   * </dl>
   **/
   ...
   * <dl>
   * <dt>Test:</dt>
   * <dd>Call User::setUserOptions(String[]) with an array parameter that is just
   * a null value.</dd>
   * <dt>Result:</dt>
   * <dd>Verify that a AS400Exception is thrown.</dd>
   * </dl>
   ...
   * <dl>
   * <dt>Test:</dt>
   * <dd>Call User::setUserOptions(String[]) with an array parameter that contains
   * a null element.</dd>
   * <dt>Result:</dt>
   * <dd>Verify that a AS400Exception is thrown.</dd>
   * </dl>
   ...
   * <dl>
   * <dt>Test:</dt>
   * <dd>Call User::setUserOptions(String[]) before system is set.</dd>
   * <dt>Result:</dt>
   * <dd>Verify that a ExtendedIllegalStateException is thrown.</dd>
   * </dl>
   **/
   ...
   * <dl>
   * <dt>Test:</dt>
   * <dd>Call User::setUserOptions(String[]) before name is set.</dd>
   * <dt>Result:</dt>
   * <dd>Verify that a ExtendedIllegalStateException is thrown.</dd>
   * </dl>
   **/
   ...
   * <dl>
   * <dt>Test:</dt>
   * <dd>Call User::getUserExpirationAction .</dd>
   * <dt>Result:</dt>
   * <dd>Should be successful and return null.</dd>
   * </dl>
   **/
  public void Var095() {
    try {
   ...
   * <dd>Call User::getUserExpirationAction .</dd>
   * <dt>Result:</dt>
   * <dd>Should be successful and return *DELETE.</dd>
   * </dl>
   **/
  public void Var096() {
    try {
   ...
   * <dd>Call User::getUserExpirationAction .</dd>
   * <dt>Result:</dt>
   * <dd>Should be successful and return *DISABLE.</dd>
   * </dl>
   **/
  public void Var097() {
    try {
   ...
   * <dd>Call User::getUserExpirationAction .</dd>
   * <dt>Result:</dt>
   * <dd>Should be successful and return *NONE.</dd>
   * </dl>
   **/
  public void Var098() {
    try {
   ...
   * <dl>
   * <dt>Test:</dt>
   * <dd>Call User::setUserExpirationDate.</dd>
   * <dt>Result:</dt>
   * <dd>Calling getUserExpirationDate, should return the same date.</dd>
   * </dl>
   **/
  public void Var099() {
   ...
   * <dd>Call User::setUserExpirationDate .</dd>
   * <dt>Result:</dt>
   * <dd>Should throw an exception since a bad date is used.</dd>
   * </dl>
   **/
  public void Var101() {
   ...
   * <dd>Call User::setUserExpirationDate .</dd>
   * <dt>Result:</dt>
   * <dd>Should throw an exception.</dd>
   * </dl>
   **/
  public void Var102() {
   ...
   * <dl>
   * <dt>Test:</dt>
   * <dd>Call User::u.setUserExpirationDate().</dd>
   * <dt>Result:</dt>
   * <dd>Should throw an exception.</dd>
   * </dl>
   **/
   ...
   * <dl>
   * <dt>Test:</dt>
   * <dd>Call User::getUserExpirationDate .</dd>
   * <dt>Result:</dt>
   * <dd>Calling getUserExpirationDate, should return null.</dd>
   * </dl>
   **/
  public void Var104() {
   ...
   * <dl>
   * <dt>Test:</dt>
   * <dd>Call User::setUserExpirationInterval .</dd>
   * <dt>Result:</dt>
   * <dd>Calling getUserExpirationInterval should return the set interval.</dd>
   * </dl>
   **/
  public void Var105() {
    try {
      ...
      if (systemObject_.getVersion() >= 7) {
        try {
          ...
          assertExceptionIs(e, "ExtendedIllegalArgumentException",
              "expirationInterval (0): The parameter value is out of the allowed range.");
        }
      } else {
        notApplicable("Only for V7R1 and later");
      }
    ...
    try {
      ...
      if (systemObject_.getVersion() >= 7) {
        try {
          ...
          assertExceptionIs(e, "ExtendedIllegalArgumentException",
              "expirationInterval (367): The parameter value is out of the allowed range.");
        }
      } else {
        notApplicable("Only for V7R1 and later");
      }
    ...
    try {
      ...
      if (systemObject_.getVersion() >= 7) {
        try {
          ...
          u.setUserExpirationInterval(210);
          failed("Should throw an exception.  Verify that user profile " + systemObject_.getUserId()
              + " doesn't have *SECADM authority.");
   ...
   * <dl>
   * <dt>Test:</dt>
   * <dd>Call User::isUserEntitlementRequired.</dd>
   * <dt>Result:</dt>
   * <dd>Calling isUserEntitlementRequired should be successful.</dd>
   * </dl>
   **/
  public void Var111() {
