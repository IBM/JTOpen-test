...
/**
 * Testcase JDSDSProperties. This tests the following methods of the JDBC Driver
 * class:
 * 
 * <ul>
 ...
 * </ul>
 **/
public class JDSDSProperties extends JDTestcase {
   ...
   * Constructor.
   **/
  public JDSDSProperties(AS400 systemObject, Hashtable<String, Vector<String>> namesAndVars, int runMode,
      FileOutputStream fileOutputStream,

      String password) {
    super(systemObject, "JDSDSProperties", namesAndVars, runMode, fileOutputStream, password);
  }
  ...
  public void Var038() {
    if (checkJdbc20StdExt()) {
      try {
        ...
        // assertCondition(JDReflectionUtil.callMethod_S(ds,"getLibraries().equals(userId_));
        // may be a bug
        ctx_.unbind(bindName_);
      } catch (Exception e) {
        failed(e, "Unexpected Exception");
  ...
  /**
   * setTraceActive(),getTraceActive() - set the TraceActive property and then
   * verify it was set.
   **/
...
//NERYKAL
  ...
  public void Var051() {
    if (checkJdbc20StdExt()) {
      try {
        ...
        ctx_.rebind(bindName_, dataSource_);
        DataSource ds = (DataSource) ctx_.lookup(bindName_);
        assertCondition(JDReflectionUtil.callMethod_B(ds, "getAutoCommit") == true,
  ...
  public void Var052() {
    if (checkJdbc20StdExt()) {
      try {
        ...
        ctx_.rebind(bindName_, dataSource_);
        DataSource ds = (DataSource) ctx_.lookup(bindName_);
        assertCondition(JDReflectionUtil.callMethod_B(ds, "getAutoCommit") == false,
  ...
  /**
   * getIgnoreWarning() -- call getIgnoreWarnings() to check the default value,
   * should be ""
   **/
  public void Var096() {
    String added = " -- new V5R5 property added by native driver 05/22/07";
