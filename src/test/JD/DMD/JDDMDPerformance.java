...
/**
 * Testcase JDDMDPerformance. This tests the following methods of the JDBC
 ...
 * </ul>
 **/
public class JDDMDPerformance extends JDTestcase {
   ...
   * Constructor.
   **/
  public JDDMDPerformance(AS400 systemObject, Hashtable<String, Vector<String>> namesAndVars, int runMode,
      FileOutputStream fileOutputStream,

      String password) {
    super(systemObject, "JDDMDPerformance", namesAndVars, runMode, fileOutputStream, password);
  }
  ...
  String[][] indexTable1 = { { indexNamePrefix + "01", tableNamePrefix + "01" }, { "COLUMN1" } };
  String[][] columnsTable1 = { { tableNamePrefix + "01" }, { "COLUMN1", "SMALLINT" }, { "COLUMN2", "INTEGER" },
      { "COLUMN3", "BIGINT" }, { "COLUMN4", "REAL" }, { "COLUMN5", "FLOAT" }, { "COLUMN6", "DOUBLE" },
      { "COLUMN7", "DECIMAL(5,2)" }, { "COLUMN8", "NUMERIC(5,2)" }, { "COLUMN9", "CHAR(10)" },
      { "COLUMN10", "VARCHAR(10)" }, { "COLUMN11", "BINARY(10)" }, { "COLUMN12", "VARBINARY(10)" },
      { "COLUMN13", "GRAPHIC(10) CCSID 13488" }, { "COLUMN14", "VARGRAPHIC(10) CCSID 13488 " }, { "COLUMN15", "DATE" },
      { "COLUMN16", "TIME" }, { "COLUMN17", "TIMESTAMP" }, { "COLUMN18", "CLOB(100)" }, { "COLUMN19", "BLOB(100)" },
      { "COLUMN20", "DBCLOB(100) CCSID 13488 " }, { "COLUMN21", "VARCHAR(10) CCSID 1208" },
      { "COLUMN22", "VARCHAR(10) CCSID 500 " }, { "COLUMN23", "VARCHAR(10) CCSID 37" }, { "COLUMN24", "INTEGER" },
      { "COLUMN25", "INTEGER" }, { "COLUMN26", "INTEGER" }, { "COLUMN27", "INTEGER" }, { "COLUMN28", "INTEGER" },
      { "COLUMN29", "INTEGER" }, { "COLUMN30", "INTEGER" }, };

  String[][] indexTable2 = { { indexNamePrefix + "02", tableNamePrefix + "02" }, { "COLUMN2" } };
  String[][] columnsTable2 = { { tableNamePrefix + "02" }, { "COLUMN1", "SMALLINT" }, { "COLUMN2", "INTEGER" },
      { "COLUMN3", "BIGINT" }, { "COLUMN4", "REAL" }, { "COLUMN5", "FLOAT" }, { "COLUMN6", "DOUBLE" },
      { "COLUMN7", "DECIMAL(5,2)" }, { "COLUMN8", "NUMERIC(5,2)" }, { "COLUMN9", "CHAR(10)" },
      { "COLUMN10", "VARCHAR(10)" }, { "COLUMN11", "BINARY(10)" }, { "COLUMN12", "VARBINARY(10)" },
      { "COLUMN13", "GRAPHIC(10) CCSID 13488" }, { "COLUMN14", "VARGRAPHIC(10) CCSID 13488 " }, { "COLUMN15", "DATE" },
  ...
  String[][] indexTable3 = { { indexNamePrefix + "03", tableNamePrefix + "03" }, { "COLUMN3" } };

  String[][] columnsTable3 = { { tableNamePrefix + "03" }, { "COLUMN1", "SMALLINT" }, { "COLUMN2", "INTEGER" },
      { "COLUMN3", "BIGINT" }, { "COLUMN4", "REAL" }, { "COLUMN5", "FLOAT" }, { "COLUMN6", "DOUBLE" },
      { "COLUMN7", "DECIMAL(5,2)" }, { "COLUMN8", "NUMERIC(5,2)" }, { "COLUMN9", "CHAR(10)" },
      { "COLUMN10", "VARCHAR(10)" }, { "COLUMN11", "BINARY(10)" }, { "COLUMN12", "VARBINARY(10)" },
      { "COLUMN13", "GRAPHIC(10) CCSID 13488" }, { "COLUMN14", "VARGRAPHIC(10) CCSID 13488 " }, { "COLUMN15", "DATE" },
  ...
  String[][] indexTable4 = { { indexNamePrefix + "04", tableNamePrefix + "04" }, { "COLUMN4" }, { "COLUMN3" } };

  String[][] columnsTable4 = { { tableNamePrefix + "04" }, { "COLUMN1", "SMALLINT" }, { "COLUMN2", "INTEGER" },
      { "COLUMN3", "BIGINT" }, { "COLUMN4", "REAL" }, { "COLUMN5", "FLOAT" }, { "COLUMN6", "DOUBLE" },
      { "COLUMN7", "DECIMAL(5,2)" }, { "COLUMN8", "NUMERIC(5,2)" }, { "COLUMN9", "CHAR(10)" },
      { "COLUMN10", "VARCHAR(10)" }, { "COLUMN11", "BINARY(10)" }, { "COLUMN12", "VARBINARY(10)" },
      { "COLUMN13", "GRAPHIC(10) CCSID 13488" }, { "COLUMN14", "VARGRAPHIC(10) CCSID 13488 " }, { "COLUMN15", "DATE" },
  ...
  String[][] indexTable5 = { { indexNamePrefix + "05", tableNamePrefix + "05" }, { "COLUMN5" } };

  String[][] columnsTable5 = { { tableNamePrefix + "05" }, { "COLUMN1", "SMALLINT" }, { "COLUMN2", "INTEGER" },
      { "COLUMN3", "BIGINT" }, { "COLUMN4", "REAL" }, { "COLUMN5", "FLOAT" }, { "COLUMN6", "DOUBLE" },
      { "COLUMN7", "DECIMAL(5,2)" }, { "COLUMN8", "NUMERIC(5,2)" }, { "COLUMN9", "CHAR(10)" },
      { "COLUMN10", "VARCHAR(10)" }, { "COLUMN11", "BINARY(10)" }, { "COLUMN12", "VARBINARY(10)" },
      { "COLUMN13", "GRAPHIC(10) CCSID 13488" }, { "COLUMN14", "VARGRAPHIC(10) CCSID 13488 " }, { "COLUMN15", "DATE" },
  ...
  String[][] indexTable6 = { { indexNamePrefix + "06", tableNamePrefix + "06" }, { "COLUMN6" } };

  String[][] columnsTable6 = { { tableNamePrefix + "06" }, { "COLUMN1", "SMALLINT" }, { "COLUMN2", "INTEGER" },
      { "COLUMN3", "BIGINT" }, { "COLUMN4", "REAL" }, { "COLUMN5", "FLOAT" }, { "COLUMN6", "DOUBLE" },
      { "COLUMN7", "DECIMAL(5,2)" }, { "COLUMN8", "NUMERIC(5,2)" }, { "COLUMN9", "CHAR(10)" },
      { "COLUMN10", "VARCHAR(10)" }, { "COLUMN11", "BINARY(10)" }, { "COLUMN12", "VARBINARY(10)" },
      { "COLUMN13", "GRAPHIC(10) CCSID 13488" }, { "COLUMN14", "VARGRAPHIC(10) CCSID 13488 " }, { "COLUMN15", "DATE" },
  ...
  String[][] indexTable7 = { { indexNamePrefix + "07", tableNamePrefix + "07" }, { "COLUMN7" } };

  String[][] columnsTable7 = { { tableNamePrefix + "07" }, { "COLUMN1", "SMALLINT" }, { "COLUMN2", "INTEGER" },
      { "COLUMN3", "BIGINT" }, { "COLUMN4", "REAL" }, { "COLUMN5", "FLOAT" }, { "COLUMN6", "DOUBLE" },
      { "COLUMN7", "DECIMAL(5,2)" }, { "COLUMN8", "NUMERIC(5,2)" }, { "COLUMN9", "CHAR(10)" },
      { "COLUMN10", "VARCHAR(10)" }, { "COLUMN11", "BINARY(10)" }, { "COLUMN12", "VARBINARY(10)" },
      { "COLUMN13", "GRAPHIC(10) CCSID 13488" }, { "COLUMN14", "VARGRAPHIC(10) CCSID 13488 " }, { "COLUMN15", "DATE" },
  ...
  String[][] indexTable8 = { { indexNamePrefix + "08", tableNamePrefix + "08" }, { "COLUMN8" } };

  String[][] columnsTable8 = { { tableNamePrefix + "08" }, { "COLUMN1", "SMALLINT" }, { "COLUMN2", "INTEGER" },
      { "COLUMN3", "BIGINT" }, { "COLUMN4", "REAL" }, { "COLUMN5", "FLOAT" }, { "COLUMN6", "DOUBLE" },
      { "COLUMN7", "DECIMAL(5,2)" }, { "COLUMN8", "NUMERIC(5,2)" }, { "COLUMN9", "CHAR(10)" },
      { "COLUMN10", "VARCHAR(10)" }, { "COLUMN11", "BINARY(10)" }, { "COLUMN12", "VARBINARY(10)" },
      { "COLUMN13", "GRAPHIC(10) CCSID 13488" }, { "COLUMN14", "VARGRAPHIC(10) CCSID 13488 " }, { "COLUMN15", "DATE" },
  ...
  String[][] indexTable9 = { { indexNamePrefix + "09", tableNamePrefix + "09" }, { "COLUMN9" } };

  String[][] columnsTable9 = { { tableNamePrefix + "09" }, { "COLUMN1", "SMALLINT" }, { "COLUMN2", "INTEGER" },
      { "COLUMN3", "BIGINT" }, { "COLUMN4", "REAL" }, { "COLUMN5", "FLOAT" }, { "COLUMN6", "DOUBLE" },
      { "COLUMN7", "DECIMAL(5,2)" }, { "COLUMN8", "NUMERIC(5,2)" }, { "COLUMN9", "CHAR(10)" },
      { "COLUMN10", "VARCHAR(10)" }, { "COLUMN11", "BINARY(10)" }, { "COLUMN12", "VARBINARY(10)" },
      { "COLUMN13", "GRAPHIC(10) CCSID 13488" }, { "COLUMN14", "VARGRAPHIC(10) CCSID 13488 " }, { "COLUMN15", "DATE" },
  ...
  String[][] indexTable10 = { { indexNamePrefix + "10", tableNamePrefix + "10" }, { "COLUMN15" } };

  String[][] columnsTable10 = { { tableNamePrefix + "10" }, { "COLUMN1", "SMALLINT" }, { "COLUMN2", "INTEGER" },
      { "COLUMN3", "BIGINT" }, { "COLUMN4", "REAL" }, { "COLUMN5", "FLOAT" }, { "COLUMN6", "DOUBLE" },
      { "COLUMN7", "DECIMAL(5,2)" }, { "COLUMN8", "NUMERIC(5,2)" }, { "COLUMN9", "CHAR(10)" },
      { "COLUMN10", "VARCHAR(10)" }, { "COLUMN11", "BINARY(10)" }, { "COLUMN12", "VARBINARY(10)" },
      { "COLUMN13", "GRAPHIC(10) CCSID 13488" }, { "COLUMN14", "VARGRAPHIC(10) CCSID 13488 " }, { "COLUMN15", "DATE" },
  ...
  /**
   * Measure the performance of getColumns. Make sure it is within 5% of the last
   * time it was run
   */
  public void Var001() {
    ...
    try {
      ...
      for (int i = 0; i < 10; i++) {
        ResultSet rs = dmd_.getColumns(null, JDDMDTest.COLLECTION, tableNamePrefix + "%", "%");
        int count = 0;
        while (rs.next()) {
          count++;
        }
      ...
      JDPerformanceUtil.recordTestRun(connection_, ts, testname, driverName, (endTime - startTime));
  ...
  /**
   * Measure the performance of getTables. Make sure it is within 5% of the last
   * time it was run
   */
  public void Var002() {
    ...
    try {
      long startTime = System.currentTimeMillis();
      for (int i = 0; i < 10; i++) {
        ResultSet rs = dmd_.getTables(null, JDDMDTest.COLLECTION, tableNamePrefix + "%", null);
        int count = 0;
        while (rs.next()) {
          count++;
        }
    ...
    try {
      ...
      for (int i = 0; i < 10; i++) {
        ...
        while (enumeration.hasMoreElements()) {
          ...
          ResultSet rs = dmd_.getIndexInfo(null, JDDMDTest.COLLECTION, tableName, false, false);
          while (rs.next()) {
            count++;
          }
          rs.close();
