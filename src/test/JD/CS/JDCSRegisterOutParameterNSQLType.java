...
//
// Filename:  JDCSRegisterOutParameterNSQLType.java
//
...
**/
public class JDCSRegisterOutParameterNSQLType
extends JDTestcase
{
  public static void main(String args[]) throws Exception {
    String[] newArgs = new String[args.length+2];
     newArgs[0] = "-tc";
     newArgs[1] = "JDCSRegisterOutParameterNSQLType";
...
**/
    public JDCSRegisterOutParameterNSQLType (AS400 systemObject,
                                    ...
                                    String password)
    {
        super (systemObject, "JDCSRegisterOutParameterNSQLType",
...
**/
  public void Var001()
  {
	  ...
	  try {
	      ...
	      JDReflectionUtil.callMethod_V(cs4_,"registerOutParameter","P_INTEGER", getSQLType(Types.INTEGER));
...
**/
  public void Var002()
  {
	  ...
	  try {
	      reconnect (PACKAGE_CACHE_NO);
	      JDReflectionUtil.callMethod_V(cs4_,"registerOutParameter","NONAME", getSQLType(Types.INTEGER));
...
**/
  public void Var006()
  {
     ...
     // }
	  ...
	  {
	      reconnect (PACKAGE_CACHE_NO);
	      JDReflectionUtil.callMethod_V(cs1_,"registerOutParameter","P2", 457);
	      assertCondition (true);
	  }
	  catch(Exception e)
	  {
...
**/
  public void Var007()
  {
	  ...
	  try {
	      reconnect (PACKAGE_CACHE_NO);
	      JDReflectionUtil.callMethod_V(cs1_,"registerOutParameter","P1", getSQLType(Types.INTEGER));
	      failed ("Didn't throw SQLException");
	  }
	  catch(Exception e) {
	      assertExceptionIsInstanceOf (e, "java.sql.SQLException");
...
**/
  public void Var008()
  {
	  ...
	  try {
	      reconnect (PACKAGE_CACHE_NO);
	      JDReflectionUtil.callMethod_V(cs1_,"registerOutParameter","P2", getSQLType(Types.INTEGER));
	      assertCondition (true);
	  }
	  catch(Exception e)
	  {
...
**/
  public void Var009()
  {
	  ...
	  try {
	      reconnect (PACKAGE_CACHE_NO);
	      cs1_.setInt ("P3", 123);
	      JDReflectionUtil.callMethod_V(cs1_,"registerOutParameter","P3", getSQLType(Types.INTEGER));
	      assertCondition (true);
	  }
	  catch(Exception e)
	  {
  ...
  public void Var010()
  {
     ...
     // }
	  ...
	  try
	  {
	      reconnect (PACKAGE_CACHE_NO);
	      cs1_.setInt ("P3", 123);
	      JDReflectionUtil.callMethod_V(cs1_,"registerOutParameter","P3", getSQLType(Types.VARBINARY));
	      assertCondition (true);
	  }
	  catch(Exception e)
	  {
...
**/
  public void Var014()
  {
	  ...
	  try {
	      reconnect (PACKAGE_CACHE_NO);
	      JDReflectionUtil.callMethod_V(cs4_,"registerOutParameter","P_DECIMAL_105", getSQLType(Types.DECIMAL), 5);
	      assertCondition (true);
	  }
	  catch(Exception e)
	  {
...
**/
  public void Var015()
  {
	  ...
	  try {
	      reconnect (PACKAGE_CACHE_NO);
	      JDReflectionUtil.callMethod_V(cs4_,"registerOutParameter","P_DECIMAL_50", getSQLType(Types.DECIMAL), -1);
	      failed ("Didn't throw SQLException");
	  }
	  catch(Exception e) {
	      assertExceptionIsInstanceOf (e, "java.sql.SQLException");
  ...
  public void Var017()
  {
	  ...
	  try {
	      ...
	      CallableStatement cs = connection_.prepareCall (
							      "CALL STPTEST4 (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
	      cs.close ();
	      JDReflectionUtil.callMethod_V(cs,"registerOutParameter", "P2", getSQLType(Types.INTEGER));
	      failed ("Didn't throw SQLException");
	  }
	  catch(Exception e) {
	      assertExceptionIsInstanceOf (e, "java.sql.SQLException");
...
**/
  public void Var024()
  {
	  ...
	  if (checkJdbc42()) {
	      try {
		  reconnect (PACKAGE_CACHE_NO);
		  JDReflectionUtil.callMethod_V(csRv_,"registerOutParameter","P3", getSQLType(Types.INTEGER));
		  assertCondition (true);
	      }
	      catch(Exception e)
	      {
 ...
 */
  public void Var027()
  {
	  ...
	  try {
	      reconnect (PACKAGE_CACHE_NO);
	      JDReflectionUtil.callMethod_V(cs4_,"registerOutParameter","P_INTEGER", getSQLType(Types.JAVA_OBJECT));
	      assertCondition (true);
	  }
	  catch(Exception e)
	  {
