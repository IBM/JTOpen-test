...
/**
Testcase JDCSNamed13.  This tests the use of named parameters.
**/
public class JDCSNamed13
extends JDCSNamed
{
...
Constructor.
**/
    public JDCSNamed13 (AS400 systemObject,
                                    ...
                                    String password)
    {
        super (systemObject, "JDCSNamed13",
  ...
  public void Var013() { 
    runRandomTestsRS(5,  /* parameterCount */
