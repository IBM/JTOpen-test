...
//
// Filename:  JDCSRegisterOutParameter.java
//
...
**/
public class JDCSRegisterOutParameter
extends JDTestcase
{
  public static void main(String args[]) throws Exception {
    String[] newArgs = new String[args.length+2];
     newArgs[0] = "-tc";
     newArgs[1] = "JDCSRegisterOutParameter";
...
**/
    public JDCSRegisterOutParameter (AS400 systemObject,
                                    ...
                                    String password)
    {
        super (systemObject, "JDCSRegisterOutParameter",
...
**/
  public void Var001()
  {
    try {
        ...
        cs4_.registerOutParameter (2, Types.INTEGER);
...
**/
  public void Var002()
  {
    try {
        reconnect (PACKAGE_CACHE_NO);
        cs4_.registerOutParameter (-1, Types.INTEGER);
...
**/
  public void Var006()
  {
     ...
     {
        reconnect (PACKAGE_CACHE_NO);
        cs1_.registerOutParameter (2, 457);
        assertCondition (true);
     }
     catch(Exception e)
     {
...
**/
  public void Var007()
  {
    try {
        reconnect (PACKAGE_CACHE_NO);
        cs1_.registerOutParameter (1, Types.INTEGER);
        failed ("Didn't throw SQLException");
    }
    catch(Exception e) {
        assertExceptionIsInstanceOf (e, "java.sql.SQLException");
...
**/
  public void Var008()
  {
    try {
        reconnect (PACKAGE_CACHE_NO);
        cs1_.registerOutParameter (2, Types.INTEGER);
        assertCondition (true);
    }
    catch(Exception e)
    {
...
**/
  public void Var009()
  {
    try {
        reconnect (PACKAGE_CACHE_NO);
        cs1_.setInt (3, 123);
        cs1_.registerOutParameter (3, Types.INTEGER);
        assertCondition (true);
    }
    catch(Exception e)
    {
...
**/
  public void Var014()
  {
    try {
        reconnect (PACKAGE_CACHE_NO);
        cs4_.registerOutParameter (7, Types.DECIMAL, 5);
        assertCondition (true);
    }
    catch(Exception e)
    {
...
**/
  public void Var015()
  {
    try {
        reconnect (PACKAGE_CACHE_NO);
        cs4_.registerOutParameter (6, Types.DECIMAL, -1);
        failed ("Didn't throw SQLException");
    }
    catch(Exception e) {
        assertExceptionIsInstanceOf (e, "java.sql.SQLException");
...
**/
  public void Var021()
  {
    ...
    try {
        reconnect (PACKAGE_CACHE_NO);
        csRv0_.registerOutParameter (1, Types.INTEGER);
        assertCondition (true);
    }
    catch(Exception e)
    {
...
**/
  public void Var022()
  {
    ...
    try {
        reconnect (PACKAGE_CACHE_NO);
        csRv0_.registerOutParameter (1, Types.INTEGER);
        csRv0_.registerOutParameter (2, Types.INTEGER);
        failed ("Didn't throw SQLException");
    }
    catch(Exception e) {
        assertExceptionIsInstanceOf (e, "java.sql.SQLException");
...
**/
  public void Var023()
  {
    ...
    try {
        reconnect (PACKAGE_CACHE_NO);
        csRv_.registerOutParameter (1, Types.INTEGER);
        assertCondition (true);
    }
    catch(Exception e)
    {
...
**/
  public void Var024()
  {
    ...
    try {
        reconnect (PACKAGE_CACHE_NO);
        csRv_.registerOutParameter (4, Types.INTEGER);
        assertCondition (true);
    }
    catch(Exception e)
    {
...
**/
  public void Var026()
  {
    ...
    try {
        reconnect (PACKAGE_CACHE_NO);
        csRv_.registerOutParameter (1, Types.SMALLINT);
        failed ("Didn't throw SQLException");
    }
    catch(Exception e) {
        assertExceptionIsInstanceOf (e, "java.sql.SQLException");
 ...
 */
  public void Var027()
  {
    try {
        reconnect (PACKAGE_CACHE_NO);
        cs4_.registerOutParameter (2, Types.JAVA_OBJECT);
        assertCondition (true);
    }
    catch(Exception e)
    {
