...
//
// Filename:  JDSCPDSConnectionCreateStatement.java
//
...
/**
Testcase JDSCPDSConnectionCreateStatement.  This tests the following methods
...
**/
public class JDSCPDSConnectionCreateStatement
extends JDTestcase {
  public static void main(String args[]) throws Exception {
    String[] newArgs = new String[args.length+2];
     newArgs[0] = "-tc";
     newArgs[1] = "JDSCPDSConnectionCreateStatement";
...
**/
    public JDSCPDSConnectionCreateStatement (AS400 systemObject,
                                            ...
                                            String password)
    {
        super (systemObject, "JDSCPDSConnectionCreateStatement",
...
**/
    ...
    throws Exception
    {
		table_ = JDSCPDSTest.COLLECTION + ".JDCCS";
		if (isJdbc20StdExt()) {
		...
		keysTable_  = JDSCPDSTest.COLLECTION + ".JDGENERATEDKEYS";
		try {
    ...
    public void Var011()
    {
        if (checkJdbc20StdExt()) {
            try {
                ...
                rs.close ();
                s.close ();
		if (getRelease() >= JDTestDriver.RELEASE_V7R1M0 && getDriver() == JDTestDriver.DRIVER_NATIVE) //@C1
		{
    ...
    public void Var028()
    {
        if (checkJdbc20StdExt()) {
            try {
                ...
                rs.close ();
                s.close ();
		if (getRelease() >= JDTestDriver.RELEASE_V7R1M0 && getDriver() == JDTestDriver.DRIVER_NATIVE) //@C2
		{
                assertCondition ((w == null) 
                        && (type == ResultSet.TYPE_FORWARD_ONLY)
                        && (concurrency == ResultSet.CONCUR_UPDATABLE)
