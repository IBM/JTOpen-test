...
//
// Filename:  JDSCPDSConnectionWarnings.java
//
...
/**
Testcase JDSCPDSConnectionWarnings.  This tests the following methods
...
**/
public class JDSCPDSConnectionWarnings
extends JDTestcase {
  public static void main(String args[]) throws Exception {
    String[] newArgs = new String[args.length+2];
     newArgs[0] = "-tc";
     newArgs[1] = "JDSCPDSConnectionWarnings";
...
Constructor.
**/
    public JDSCPDSConnectionWarnings (AS400 systemObject,
                                     ...
                                     String password)
    {
        super (systemObject, "JDSCPDSConnectionWarnings",
...
**/
    ...
    throws Exception
    {
        table_ = JDSCPDSTest.COLLECTION + ".JDCWARN";
        if (isJdbc20StdExt()) {
            // Create the table.
