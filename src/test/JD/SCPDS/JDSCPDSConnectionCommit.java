...
//
// Filename:  JDSCPDSConnectionCommit.java
//
...
/**
Testcase JDSCPDSConnectionCommit.  This tests the following methods
of the JDBC Connection class:
The connection is obtained by using DB2StdConnectionPool class.
<ul>
<li>commit()
<li>rollback()
<li>setAutoCommit()
...
**/
public class JDSCPDSConnectionCommit
extends JDTestcase {
  public static void main(String args[]) throws Exception {
    String[] newArgs = new String[args.length+2];
     newArgs[0] = "-tc";
     newArgs[1] = "JDSCPDSConnectionCommit";
...
Constructor.
**/
    public JDSCPDSConnectionCommit (AS400 systemObject,
                                   ...
                                   String password)
    {
        super (systemObject, "JDSCPDSConnectionCommit",
...
**/
    ...
    throws Exception
    {
        table_      = JDSCPDSTest.COLLECTION + ".JDCCOMMIT";
        if (isJdbc20StdExt()) {
