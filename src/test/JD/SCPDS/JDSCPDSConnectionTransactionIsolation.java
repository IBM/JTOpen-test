...
//
// Filename:  JDSCPDSConnectionTransactionIsolation.java
//
...
/**
Testcase JDSCPDSConnectionTransactionIsolation.  This tests
...
public class JDSCPDSConnectionTransactionIsolation
extends JDTestcase {
  public static void main(String args[]) throws Exception {
    String[] newArgs = new String[args.length+2];
     newArgs[0] = "-tc";
     newArgs[1] = "JDSCPDSConnectionTransactionIsolation";
...
Constructor.
**/
    public JDSCPDSConnectionTransactionIsolation (AS400 systemObject,
                                                 ...
                                                 String password)
    {
        super (systemObject, "JDSCPDSConnectionTransactionIsolation",
...
**/
    ...
    throws Exception
    {
        table_      = JDSCPDSTest.COLLECTION + ".JDCTXNISO";
        if (isJdbc20StdExt()) {
    ...
    public void Var016 ()
    {
        if (checkJdbc20StdExt()) {
            try {
                ...
                JDReflectionUtil.callMethod_V(dataSource,"setPassword",PasswordVault.decryptPasswordLeak(encryptedPassword_));
                JDReflectionUtil.callMethod_V(dataSource,"setTransactionIsolationLevel",
                		JDReflectionUtil.getStaticField_O("com.ibm.db2.jdbc.app.DB2Properties","TRANSACTION_ISOLATION_READ_COMMITTED"));
                Connection c = dataSource.getConnection ();
    ...
    public void Var017 ()
    {
        if (checkJdbc20StdExt()) {
            try {
                ...
                JDReflectionUtil.callMethod_V(dataSource,"setPassword",PasswordVault.decryptPasswordLeak(encryptedPassword_));
                JDReflectionUtil.callMethod_V(dataSource,"setTransactionIsolationLevel",
                		JDReflectionUtil.getStaticField_O("com.ibm.db2.jdbc.app.DB2Properties","TRANSACTION_ISOLATION_REPEATABLE_READ"));
