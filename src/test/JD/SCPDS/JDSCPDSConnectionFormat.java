...
//
// Filename:  JDSCPDSConnectionFormat.java
//
...
/**
Testcase JDSCPDSConnectionFormat.  This tests the following
properties with respect to the JDBC Connection class:
The connection is obtained using DB2StdConnectionPool class
<ul>
...
**/
public class JDSCPDSConnectionFormat
extends JDTestcase {
  public static void main(String args[]) throws Exception {
    String[] newArgs = new String[args.length+2];
     newArgs[0] = "-tc";
     newArgs[1] = "JDSCPDSConnectionFormat";
...
Constructor.
**/
    public JDSCPDSConnectionFormat (AS400 systemObject,
                                   ...
                                   String password)
    {
        super (systemObject, "JDSCPDSConnectionFormat",
...
**/
    ...
    throws Exception
    {
        table_      = JDSCPDSTest.COLLECTION + ".JDCFORMAT";
        if (isJdbc20StdExt()) {
    ...
    public void Var002 ()
    {
        if (checkJdbc20StdExt()) {
            try {
                ...
                JDReflectionUtil.callMethod_V(dataSource,"setUser",userId_);
                JDReflectionUtil.callMethod_V(dataSource,"setPassword",PasswordVault.decryptPasswordLeak(encryptedPassword_));
                JDReflectionUtil.callMethod_V(dataSource,"setDecimalSeparator","bogus");
    ...
    public void Var009 ()
    {
        ...
        if (checkJdbc20StdExt()) {
            try {
                ...
                JDReflectionUtil.callMethod_V(dataSource,"setDateDeparator","-");
                Connection c = dataSource.getConnection ();
                Statement s = c.createStatement ();
                s.executeUpdate ("INSERT INTO " + table_
    ...
    public void Var026 ()
    {
        if (checkJdbc20StdExt()) {
            try {
                ...
                JDReflectionUtil.callMethod_V(dataSource,"setUser",userId_);
                JDReflectionUtil.callMethod_V(dataSource,"setPassword",PasswordVault.decryptPasswordLeak(encryptedPassword_));
                JDReflectionUtil.callMethod_V(dataSource,"setDateDeparator","bogus");
                failed("Did not throw exception");
                /*
                Connection c = dataSource.getConnection ();
                 Statement s = c.createStatement ();
    ...
    public void Var035 ()
    {
        ...
        if (checkJdbc20StdExt()) {
            try {
                ...
                JDReflectionUtil.callMethod_V(dataSource,"setPassword",PasswordVault.decryptPasswordLeak(encryptedPassword_));
                JDReflectionUtil.callMethod_V(dataSource,"setDateFormat","mdy");
                JDReflectionUtil.callMethod_V(dataSource,"setDateDeparator","b");
                Connection c = dataSource.getConnection ();
                Statement s = c.createStatement ();
                s.executeUpdate ("INSERT INTO " + table_
                                 + " (COL2) VALUES ('03 19 98')");
