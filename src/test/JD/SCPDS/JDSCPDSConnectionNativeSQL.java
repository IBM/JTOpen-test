...
//
// Filename:  JDSCPDSConnectionNativeSQL.java
//
...
////////////////////////////////////////////////////////////////////////
//
// File Name:    JDSCPDSConnectionNativeSQL.java
//
// Classes:      JDSCPDSConnectionNativeSQL
//
////////////////////////////////////////////////////////////////////////
//
//
...
/**
 * Testcase JDSCPDSConnectionNativeSQL. This tests the following method of the
 ...
 * </ul>
 **/
public class JDSCPDSConnectionNativeSQL extends JDTestcase {
  public static void main(String args[]) throws Exception {
    String[] newArgs = new String[args.length + 2];
    newArgs[0] = "-tc";
    newArgs[1] = "JDSCPDSConnectionNativeSQL";
   ...
   * Constructor.
   **/
  public JDSCPDSConnectionNativeSQL(AS400 systemObject, Hashtable<String, Vector<String>> namesAndVars, int runMode,
      FileOutputStream fileOutputStream,

      String password) {
    super(systemObject, "JDSCPDSConnectionNativeSQL", namesAndVars, runMode, fileOutputStream, password);
  }
  ...
  public void Var070() {
    if (checkJdbc20StdExt()) {
      try {
        ...
        String expected;
        if (vrm_ < VRM_530) {
          expected = "SELECT SUBSTR(CHARCOL1, 1, 5 - 1) " + "|| CHARCOL2 || SUBSTR(CHARCOL1, 5 + 7) FROM MYTABLE";
        } else {
