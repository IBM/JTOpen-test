...
//
// Filename:  JDSCPDSConnectionSort.java
//
...
/**
Testcase JDSCPDSConnectionSort.  This tests the following methods
...
**/
public class JDSCPDSConnectionSort
extends JDTestcase {
  public static void main(String args[]) throws Exception {
    String[] newArgs = new String[args.length+2];
     newArgs[0] = "-tc";
     newArgs[1] = "JDSCPDSConnectionSort";
...
Constructor.
**/
    public JDSCPDSConnectionSort (AS400 systemObject,
                                 ...
                                 String password)
    {
        super (systemObject, "JDSCPDSConnectionSort",
