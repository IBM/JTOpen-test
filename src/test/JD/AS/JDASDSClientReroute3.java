...
//
// Filename:  JDASDSClientReroute3.java
//
 ...
 **/
public class JDASDSClientReroute3 extends JDASClientReroute
{
  public static void main(String args[]) throws Exception {
    String[] newArgs = new String[args.length+2];
     newArgs[0] = "-tc";
     newArgs[1] = "JDASDSClientReroute3";
     ...
     **/
    public JDASDSClientReroute3(AS400 systemObject,
 ...
 {
		super(systemObject, "JDASDSClientReroute3", namesAndVars, runMode,
	 ...
	 **/
	public void Var022() {
		testDSPSTypeParametersSwitch(psBinaryTransactions, psBinaryParms, JAVA_BYTEARRAY ,30); 
	}
	 ...
	 **/
	public void Var023() {
		testDSPSTypeParametersSwitch(psVarbinaryTransactions, psVarbinaryParms, JAVA_BYTEARRAY ,30); 
	}
	 ...
	 **/
	public void Var024() {
		testDSPSTypeParametersSwitch(psBlobTransactions, psBlobParms, JAVA_BYTEARRAY ,30); 
	}
	 ...
	 **/
	public void Var025() {
		testDSPSTypeParametersSwitch(psDateTransactions, psDateParms, JAVA_DATE ,30); 
	}
	 ...
	 **/
	public void Var026() {
		testDSPSTypeParametersSwitch(psTimeTransactions, psTimeParms, JAVA_TIME,30); 
	}
	 ...
	 **/
	public void Var027() {
		testDSPSTypeParametersSwitch(psTimestampTransactions, psTimestampParms, JAVA_TIMESTAMP,30); 
	}
