...
//
// Filename:  JDASDSSeamlessFailover1.java
//
 ...
 **/
public class JDASDSSeamlessFailover1 extends JDASSeamlessFailover {
  public static void main(String args[]) throws Exception {
    String[] newArgs = new String[args.length+2];
     newArgs[0] = "-tc";
     newArgs[1] = "JDASDSSeamlessFailover1";
   ...
   * Constructor.
   **/
  public JDASDSSeamlessFailover1(AS400 systemObject, Hashtable<String,Vector<String>> namesAndVars,
      int runMode, FileOutputStream fileOutputStream, 
      String password, String pwrSysUserID, String pwrSysPassword) {
    super(systemObject, "JDASDSSeamlessFailover1", namesAndVars, runMode,
  ...
  public void Var003() {
    ...
    if (checkToolboxFixDate(TOOLBOX_FIX_DATE)) {
      try {
        ...
        ds.setEnableSeamlessFailover(1);
        ds.setRetryIntervalForClientReroute(1);
        ds.setClientRerouteAlternateServerName("localhost,localhost");
