...
//
// Filename:  JDASClientReroute1.java
//
 ...
 **/
public class JDASClientReroute1 extends JDASClientReroute
{
  public static void main(String args[]) throws Exception {
    String[] newArgs = new String[args.length+2];
     newArgs[0] = "-tc";
     newArgs[1] = "JDASClientReroute1";
     ...
     **/
    public JDASClientReroute1(AS400 systemObject,
 ...
 {
		super(systemObject, "JDASClientReroute1", namesAndVars, runMode,
	...
	public void Var002() {
		...
		if (checkToolboxFixDate(TOOLBOX_FIX_DATE)) {
			try {
				...
				String url = "jdbc:as400:localhost:"+localPort1+";enableClientAffinitiesList=1;retryIntervalForClientReroute=10;"+
	...
	public void Var003() {
		...
		if (checkToolboxFixDate(TOOLBOX_FIX_DATE)) {
			try {
				...
				String url = "jdbc:as400:localhost:7;enableClientAffinitiesList=1;retryIntervalForClientReroute=10;"+
	...
	public void Var004() {
		...
		if (checkToolboxFixDate(TOOLBOX_FIX_DATE)) {
			try {
				...
				String url = "jdbc:as400:serverdoesnotexist.org;enableClientAffinitiesList=1;retryIntervalForClientReroute=10;"+
	 ...
	 **/
	public void Var007() {
		testPSTypeParametersSwitch(psIntTransactions, psIntParms, JAVA_INT,30); 
	}
	 ...
	 **/
	public void Var008() {
		testPSTypeParametersSwitch(psSmallintTransactions, psSmallintParms, JAVA_SHORT,30); 
	}
	 ...
	 **/
	public void Var009() {
		testPSTypeParametersSwitch(psBigintTransactions, psBigintParms, JAVA_LONG,30); 
	}
	 ...
	 **/
	public void Var010() {
		testPSTypeParametersSwitch(psRealTransactions, psRealParms, JAVA_FLOAT,30); 
	}
	 ...
	 **/
	public void Var011() {
		testPSTypeParametersSwitch(psFloatTransactions, psFloatParms, JAVA_DOUBLE,30); 
	}
	 ...
	 **/
	public void Var012() {
		testPSTypeParametersSwitch(psDoubleTransactions, psDoubleParms, JAVA_DOUBLE,30); 
	}
	 ...
	 **/
	public void Var013() {
		testPSTypeParametersSwitch(psDecimalTransactions, psDecimalParms, JAVA_BIGDECIMAL,30); 
	}
	 ...
	 **/
	public void Var014() {
		testPSTypeParametersSwitch(psNumericTransactions, psNumericParms, JAVA_BIGDECIMAL,30); 
	}
