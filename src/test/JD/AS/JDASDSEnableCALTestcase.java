...
//
// Filename:  JDASDSEnableCALTestcase.java
//
 ...
 **/
public class JDASDSEnableCALTestcase extends JDASTestcase
{
  public static void main(String args[]) throws Exception {
    String[] newArgs = new String[args.length+2];
     newArgs[0] = "-tc";
     newArgs[1] = "JDASDSEnableCALTestcase";
     ...
     **/
    public JDASDSEnableCALTestcase(AS400 systemObject,
 ...
 {
		super(systemObject, "JDASDSEnableCALTestcase", namesAndVars, runMode,
	...
	public void Var001() {
		...
		try {
			...
			if (checkToolboxFixDate(TOOLBOX_FIX_DATE)) {
				...
				sb.append("Connecting to " + url + " using data source\n");
   ...
   */ 
	...
	public void Var007() {
		...
		testDSPSTypeParameters(psIntTransactions, psIntParms, JAVA_INT, url, null,RUN_SECONDS,null); 
	}
	...
	public void Var008() {
		String url = url_ + ";enableClientAffinitiesList=1;transaction isolation=serializable";
		testDSPSTypeParameters(psSmallintTransactions, psSmallintParms, JAVA_SHORT, url, null,RUN_SECONDS,null); 
	}
	...
	public void Var009() {
		String url = url_ + ";enableClientAffinitiesList=1;transaction isolation=serializable";
		testDSPSTypeParameters(psBigintTransactions, psBigintParms, JAVA_LONG, url, null,RUN_SECONDS,null); 
	}
	...
	public void Var010() {
		String url = url_ + ";enableClientAffinitiesList=1;transaction isolation=serializable";
		testDSPSTypeParameters(psRealTransactions, psRealParms, JAVA_FLOAT, url, null,RUN_SECONDS,null); 
	}
	...
	public void Var011() {
		String url = url_ + ";enableClientAffinitiesList=1;transaction isolation=serializable";
		testDSPSTypeParameters(psFloatTransactions, psFloatParms, JAVA_DOUBLE, url, null,RUN_SECONDS,null); 
	}
	...
	public void Var012() {
		String url = url_ + ";enableClientAffinitiesList=1;transaction isolation=serializable";
		testDSPSTypeParameters(psDoubleTransactions, psDoubleParms, JAVA_DOUBLE, url, null,RUN_SECONDS,null); 
	}
	...
	public void Var013() {
		String url = url_ + ";enableClientAffinitiesList=1;transaction isolation=serializable";
		testDSPSTypeParameters(psDecimalTransactions, psDecimalParms, JAVA_BIGDECIMAL, url, null,RUN_SECONDS,null); 
	}
	...
	public void Var014() {
		String url = url_ + ";enableClientAffinitiesList=1;transaction isolation=serializable";
		testDSPSTypeParameters(psNumericTransactions, psNumericParms, JAVA_BIGDECIMAL, url, null,RUN_SECONDS,null); 
	}
	...
	public void Var015() {
		String url = url_ + ";enableClientAffinitiesList=1;transaction isolation=serializable";
		testDSPSTypeParameters(psDecfloatTransactions, psDecfloatParms, JAVA_BIGDECIMAL, url, null,RUN_SECONDS,null); 
	}
	...
	public void Var016() {
		String url = url_ + ";enableClientAffinitiesList=1;transaction isolation=serializable";
		testDSPSTypeParameters(psCharTransactions, psCharParms, JAVA_STRING , url, null,RUN_SECONDS,null); 
	}
	/**
	 * Run a test for 60 seconds where the connection is randomly killed. 
	...
	public void Var017() {
		String url = url_ + ";enableClientAffinitiesList=1;transaction isolation=serializable";
		testDSPSTypeParameters(psVarcharTransactions, psVarcharParms, JAVA_STRING, url, null,RUN_SECONDS,null); 
	}
	...
	public void Var018() {
		String url = url_ + ";enableClientAffinitiesList=1;transaction isolation=serializable";
		testDSPSTypeParameters(psGraphicTransactions, psGraphicParms, JAVA_STRING, url, null,RUN_SECONDS,null); 
	}
	/**
	 * Run a test for 60 seconds where the connection is randomly killed. 
	 * Tests preparedStatements organized as transactions with Varchar parameters. 
	...
	public void Var019() {
		String url = url_ + ";enableClientAffinitiesList=1;transaction isolation=serializable";
		testDSPSTypeParameters(psVargraphicTransactions, psVargraphicParms, JAVA_STRING, url, null,RUN_SECONDS,null); 
	}
	...
	public void Var020() {
		String url = url_ + ";enableClientAffinitiesList=1;transaction isolation=serializable";
		testDSPSTypeParameters(psClobTransactions, psClobParms, JAVA_STRING, url, null,RUN_SECONDS,null); 
	}
	...
	public void Var021() {
		String url = url_ + ";enableClientAffinitiesList=1;transaction isolation=serializable";
		testDSPSTypeParameters(psDBClobTransactions, psDBClobParms, JAVA_STRING, url, null,RUN_SECONDS,null); 
	}
	...
	public void Var022() {
		String url = url_ + ";enableClientAffinitiesList=1;transaction isolation=serializable";
		testDSPSTypeParameters(psBinaryTransactions, psBinaryParms, JAVA_BYTEARRAY, url, null,RUN_SECONDS,null); 
	}
	...
	public void Var023() {
		String url = url_ + ";enableClientAffinitiesList=1;transaction isolation=serializable";
		testDSPSTypeParameters(psVarbinaryTransactions, psVarbinaryParms, JAVA_BYTEARRAY, url, null,RUN_SECONDS,null); 
	}
	...
	public void Var024() {
		String url = url_ + ";enableClientAffinitiesList=1;transaction isolation=serializable";
		testDSPSTypeParameters(psBlobTransactions, psBlobParms, JAVA_BYTEARRAY , url, null,RUN_SECONDS,null); 
	}
	...
	public void Var025() {
		String url = url_ + ";enableClientAffinitiesList=1;transaction isolation=serializable";
		testDSPSTypeParameters(psDateTransactions, psDateParms, JAVA_DATE , url, null,RUN_SECONDS,null); 
	}
	...
	public void Var026() {
		String url = url_ + ";enableClientAffinitiesList=1;transaction isolation=serializable";
		testDSPSTypeParameters(psTimeTransactions, psTimeParms, JAVA_TIME, url, null,RUN_SECONDS,null); 
	}
	...
	public void Var027() {
		String url = url_ + ";enableClientAffinitiesList=1;transaction isolation=serializable";
		testDSPSTypeParameters(psTimestampTransactions, psTimestampParms, JAVA_TIMESTAMP, url, null,RUN_SECONDS,null); 
	}
	...
	public void Var033() {
		String url = url_ + ";enableClientAffinitiesList=1;transaction isolation=serializable";
		testDSCSTypeParameters(csSmallintTransactions, csSmallintParms, JAVA_SHORT, url, null,RUN_SECONDS, null); 
	}
	...
	public void Var034() {
		String url = url_ + ";enableClientAffinitiesList=1;transaction isolation=serializable";
		testDSCSTypeParameters(csBigintTransactions, csBigintParms, JAVA_LONG, url, null,RUN_SECONDS,null); 
	}
	...
	public void Var035() {
		String url = url_ + ";enableClientAffinitiesList=1;transaction isolation=serializable";
		testDSCSTypeParameters(csRealTransactions, csRealParms, JAVA_FLOAT, url, null,RUN_SECONDS,null); 
	}
	...
	public void Var036() {
		String url = url_ + ";enableClientAffinitiesList=1;transaction isolation=serializable";
		testDSCSTypeParameters(csFloatTransactions, csFloatParms, JAVA_DOUBLE, url, null,RUN_SECONDS,null); 
	}
	...
	public void Var037() {
		String url = url_ + ";enableClientAffinitiesList=1;transaction isolation=serializable";
		testDSCSTypeParameters(csDoubleTransactions, csDoubleParms, JAVA_DOUBLE, url, null,RUN_SECONDS,null); 
	}
	...
	public void Var038() {
		String url = url_ + ";enableClientAffinitiesList=1;transaction isolation=serializable";
		testDSCSTypeParameters(csDecimalTransactions, csDecimalParms, JAVA_BIGDECIMAL, url, null,RUN_SECONDS,null); 
	}
	...
	public void Var039() {
		String url = url_ + ";enableClientAffinitiesList=1;transaction isolation=serializable";
		testDSCSTypeParameters(csNumericTransactions, csNumericParms, JAVA_BIGDECIMAL, url, null,RUN_SECONDS,null); 
	}
	...
	public void Var040() {
		String url = url_ + ";enableClientAffinitiesList=1;transaction isolation=serializable";
		testDSCSTypeParameters(csDecfloatTransactions, csDecfloatParms, JAVA_BIGDECIMAL, url, null,RUN_SECONDS,null); 
	}
	...
	public void Var041() {
		String url = url_ + ";enableClientAffinitiesList=1;transaction isolation=serializable";
		testDSCSTypeParameters(csCharTransactions, csCharParms, JAVA_STRING, url, null,RUN_SECONDS,null); 
	}
	/**
	 * Run a test for 60 seconds where the connection is randomly killed. 
	 * Tests preparedStatements organized as transactions with Varchar parameters. 
	...
	public void Var042() {
		String url = url_ + ";enableClientAffinitiesList=1;transaction isolation=serializable";
		testDSCSTypeParameters(csVarcharTransactions, csVarcharParms, JAVA_STRING, url, null,RUN_SECONDS,null); 
	}
	...
	public void Var043() {
		String url = url_ + ";enableClientAffinitiesList=1;transaction isolation=serializable";
		testDSCSTypeParameters(csGraphicTransactions, csGraphicParms, JAVA_STRING, url, null,RUN_SECONDS,null); 
	}
	/**
	 * Run a test for 60 seconds where the connection is randomly killed. 
	 * Tests preparedStatements organized as transactions with Varchar parameters. 
	...
	public void Var044() {
		String url = url_ + ";enableClientAffinitiesList=1;transaction isolation=serializable";
		testDSCSTypeParameters(csVargraphicTransactions, csVargraphicParms, JAVA_STRING, url, null,RUN_SECONDS,null); 
	}
	...
	public void Var045() {
		String url = url_ + ";enableClientAffinitiesList=1;transaction isolation=serializable";
		testDSCSTypeParameters(csClobTransactions, csClobParms, JAVA_STRING , url, null,RUN_SECONDS,null); 
	}
	...
	public void Var046() {
		String url = url_ + ";enableClientAffinitiesList=1;transaction isolation=serializable";
		testDSCSTypeParameters(csDBClobTransactions, csDBClobParms, JAVA_STRING, url, null,RUN_SECONDS,null); 
	}
	...
	public void Var047() {
		String url = url_ + ";enableClientAffinitiesList=1;transaction isolation=serializable";
		testDSCSTypeParameters(csBinaryTransactions, csBinaryParms, JAVA_BYTEARRAY, url, null,RUN_SECONDS,null); 
	}
	...
	public void Var048() {
		String url = url_ + ";enableClientAffinitiesList=1;transaction isolation=serializable";
		testDSCSTypeParameters(csVarbinaryTransactions, csVarbinaryParms, JAVA_BYTEARRAY , url, null,RUN_SECONDS,null); 
	}
	...
	public void Var049() {
		String url = url_ + ";enableClientAffinitiesList=1;transaction isolation=serializable";
		testDSCSTypeParameters(csBlobTransactions, csBlobParms, JAVA_BYTEARRAY , url, null,RUN_SECONDS,null); 
	}
	...
	public void Var050() {
		String url = url_ + ";enableClientAffinitiesList=1;transaction isolation=serializable";
		testDSCSTypeParameters(csDateTransactions, csDateParms, JAVA_DATE, url, null,RUN_SECONDS,null); 
	}
	...
	public void Var051() {
		String url = url_ + ";enableClientAffinitiesList=1;transaction isolation=serializable";
		testDSCSTypeParameters(csTimeTransactions, csTimeParms, JAVA_TIME, url, null,RUN_SECONDS,null); 
	}
	...
	public void Var052() {
		String url = url_ + ";enableClientAffinitiesList=1;transaction isolation=serializable";
		testDSCSTypeParameters(csTimestampTransactions, csTimestampParms, JAVA_TIMESTAMP, url, null,RUN_SECONDS,null); 
	}
