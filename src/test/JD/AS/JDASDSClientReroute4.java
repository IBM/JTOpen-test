...
//
// Filename:  JDASDSClientReroute4.java
//
 ...
 **/
public class JDASDSClientReroute4 extends JDASClientReroute
{
  public static void main(String args[]) throws Exception {
    String[] newArgs = new String[args.length+2];
     newArgs[0] = "-tc";
     newArgs[1] = "JDASDSClientReroute4";
     ...
     **/
    public JDASDSClientReroute4(AS400 systemObject,
 ...
 {
		super(systemObject, "JDASDSClientReroute4", namesAndVars, runMode,
	 ...
	 **/
	public void Var032() {
		testDSCSTypeParametersSwitch (csIntTransactions, csIntParms, JAVA_INT,30); 
	}
