...
//
// Filename:  JDASClientReroute7.java
//
 ...
 **/
public class JDASClientReroute7 extends JDASClientReroute
{
  public static void main(String args[]) throws Exception {
    String[] newArgs = new String[args.length+2];
     newArgs[0] = "-tc";
     newArgs[1] = "JDASClientReroute7";
     ...
     **/
    public JDASClientReroute7(AS400 systemObject,
 ...
 {
		super(systemObject, "JDASClientReroute7", namesAndVars, runMode,
	 ...
	 **/
	public void Var050() {
		testCSTypeParametersSwitch(csDateTransactions, csDateParms, JAVA_DATE ,30); 
	}
	 ...
	 **/
	public void Var051() {
		testCSTypeParametersSwitch(csTimeTransactions, csTimeParms, JAVA_TIME ,30); 
	}
