...
/**
 * Testcase JDLobReader. This tests the following method of the JDBC Reader
 * class:
 * 
 * <ul>
 * <li>close()
 ...
 * </ul>
 **/
public class JDLobReader extends JDTestcase {
  public static void main(String args[]) throws Exception {
    String[] newArgs = new String[args.length + 2];
    newArgs[0] = "-tc";
    newArgs[1] = "JDLobReader";
  ...
  static {
    ...
    // Set a few locations in the array for testing to make sure we get the correct
    // characters
    LARGE_[0] = 'A'; // @K1A
    LARGE_[1000] = 'B'; // @K1A
    LARGE_[25000] = 'C'; // @K1A
   ...
   * Constructor.
   **/
  public JDLobReader(AS400 systemObject, Hashtable<String, Vector<String>> namesAndVars, int runMode,
      FileOutputStream fileOutputStream, String password) {
    super(systemObject, "JDLobReader", namesAndVars, runMode, fileOutputStream, password);
  }
    ...
    if (isJdbc20()) {
      if (areLobsSupported()) {
        String url = baseURL_ + ";user=" + systemObject_.getUserId() + ";password="
            + PasswordVault.decryptPasswordLeak(encryptedPassword_) + ";lob threshold=1";
        connection_ = testDriver_.getConnection(url, systemObject_.getUserId(), encryptedPassword_);
        connection_.setAutoCommit(false);
        connection_.setTransactionIsolation(Connection.TRANSACTION_READ_UNCOMMITTED);
        statement_ = connection_.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE, ResultSet.CONCUR_READ_ONLY);

        statement_.executeUpdate("CREATE TABLE " + TABLE_ + "(C_CLOB CLOB(" + WIDTH_ + "))");

        PreparedStatement ps = connection_.prepareStatement("INSERT INTO " + TABLE_ + " (C_CLOB) VALUES (?)");
      ...
      if (checkLobSupport()) {
        try {
          ...
          assertCondition(readResult == -1,
              "Calling read method returned " + readResult + " should have returned -1 for empty lob");
        } catch (Exception e) {
          failed(e, "Unexpected Exception");
        }
      }
  ...
  /**
   * read() - When the lob is not empty and 1 byte has been read.
   **/
  public void Var008() {
    if (checkJdbc20()) {
      if (checkLobSupport()) {
  ...
  /**
   * read() - When the lob is not empty and all but 1 byte have been read.
   **/
  public void Var009() {
    if (checkJdbc20()) {
      if (checkLobSupport()) {
  ...
  /**
   * read() - When the lob is not empty and all bytes have been read.
   **/
  public void Var010() {
    if (checkJdbc20()) {
      if (checkLobSupport()) {
  ...
  /**
   * read(char[],int,int) - When the lob is empty and nothing read, reading 0
   * bytes.
   **/
  public void Var012() {
    if (checkJdbc20()) {
  ...
  /**
   * read(char[],int,int) - When the lob is empty and nothing read, reading more
   * than 0 bytes.
   **/
  public void Var013() {
    if (checkJdbc20()) {
  ...
  /**
   * read(char[],int,int) - When the lob is not empty and nothing read, reading 0
   * bytes.
   **/
  public void Var014() {
    if (checkJdbc20()) {
  ...
  /**
   * read(char[],int,int) - When the lob is not empty and nothing read, reading 1
   * byte into the start of the array.
   **/
  public void Var015() {
    if (checkJdbc20()) {
      if (checkLobSupport()) {
  ...
  /**
   * read(char[],int,int) - When the lob is not empty and nothing read, reading 1
   * byte into the middle of the array.
   **/
  public void Var016() {
    if (checkJdbc20()) {
      if (checkLobSupport()) {
  ...
  /**
   * read(char[],int,int) - When the lob is not empty and nothing read, reading 1
   * byte into the end of the array.
   **/
  public void Var017() {
    if (checkJdbc20()) {
      if (checkLobSupport()) {
  ...
  /**
   * read(char[],int,int) - When the lob is not empty and some have been read,
   * reading 1 byte into the start of the array.
   **/
  public void Var018() {
    if (checkJdbc20()) {
      if (checkLobSupport()) {
  ...
  /**
   * read(char[],int,int) - When the lob is not empty and some have been read,
   * reading 1 byte into the middle of the array.
   **/
  public void Var019() {
    if (checkJdbc20()) {
      if (checkLobSupport()) {
  ...
  /**
   * read(char[],int,int) - When the lob is not empty and some have been read,
   * reading several bytes into the start of the array.
   **/
  public void Var020() {
    if (checkJdbc20()) {
      if (checkLobSupport()) {
  ...
  /**
   * read(char[],int,int) - When the lob is not empty and some have been read,
   * reading several bytes into the middle of the array.
   **/
  public void Var021() {
    if (checkJdbc20()) {
      if (checkLobSupport()) {
  ...
  /**
   * read(char[],int,int) - When the lob is not empty and some have been read,
   * reading several bytes into the end of the array.
   **/
  public void Var022() {
    if (checkJdbc20()) {
      if (checkLobSupport()) {
  ...
  /**
   * read(char[],int,int) - When the lob is not empty and reading the entire lob.
   **/
  public void Var023() {
    if (checkJdbc20()) {
      if (checkLobSupport()) {
        try {
          ...
          assertCondition(
              (count == length) && (p[0] == MEDIUM_.charAt(0)) && (p[length - 1] == MEDIUM_.charAt(length - 1)));
        } catch (Exception e) {
          failed(e, "Unexpected Exception");
        }
      }
  ...
  /**
   * read(char[],int,int) - When the lob is not empty and reading after the the
   * entire lob has been read.
   **/
  public void Var024() {
    if (checkJdbc20()) {
      if (checkLobSupport()) {
  ...
  /**
   * read(char[]) - When the lob is empty and nothing read, reading 0 bytes.
   **/
  public void Var031() {
    if (checkJdbc20()) {
      if (checkLobSupport()) {
  ...
  /**
   * read(char[]) - When the lob is not empty and nothing read, reading 0 bytes.
   **/
  public void Var032() {
    if (checkJdbc20()) {
      if (checkLobSupport()) {
  ...
  /**
   * read(char[]) - When the lob is not empty and nothing read, reading 1 byte.
   **/
  public void Var033() {
    if (checkJdbc20()) {
      if (checkLobSupport()) {
  ...
  /**
   * read(char[]) - When the lob is not empty and some have been read, reading 1
   * byte.
   **/
  public void Var034() {
    if (checkJdbc20()) {
    ...
    if (checkJdbc20()) {
      if (checkLobSupport()) {
        try {
          ...
          int count = v.read(p);
          assertCondition(
              (count == 23) && (p[0] == MEDIUM_.charAt(40)) && (p[22] == MEDIUM_.charAt(MEDIUM_.length() - 1)));
        } catch (Exception e) {
          failed(e, "Unexpected Exception");
        }
      }
  ...
  /**
   * read(char[]) - When the lob is not empty and reading the entire lob.
   **/
  public void Var037() {
    if (checkJdbc20()) {
      if (checkLobSupport()) {
  ...
  /**
   * read(char[]) - When the lob is not empty and reading after the the entire lob
   * has been read.
   **/
  public void Var038() {
    if (checkJdbc20()) {
   ...
   * 
   * SQL400 - There is data available to be read so the native driver expects the
   * value to be returned to be true here.
   **/
  public void Var042() {
    if (checkJdbc20()) {
      if (checkLobSupport()) {
  ...
  /**
   * ready() - When the lob is not empty and 1 byte has been read.
   **/
  public void Var043() {
    if (checkJdbc20()) {
      if (checkLobSupport()) {
  ...
  /**
   * ready() - When the lob is not empty and all but 1 byte have been read.
   **/
  public void Var044() {
    if (checkJdbc20()) {
      if (checkLobSupport()) {
  ...
  /**
   * ready() - When the lob is not empty and all bytes have been read.
   **/
  public void Var045() {
    if (checkJdbc20()) {
      if (checkLobSupport()) {
   ...
   * 
   * SQL400 - description says one thing and tests the other. The native driver
  ...
  /**
   * skip() - When the lob is empty and nothing read, skipping 0 bytes.
   **/
  public void Var048() {
    if (checkJdbc20()) {
      if (checkLobSupport()) {
  ...
  /**
   * skip() - When the lob is not empty and nothing read, skipping 0 bytes.
   **/
  public void Var049() {
    if (checkJdbc20()) {
      if (checkLobSupport()) {
  ...
  /**
   * skip() - When the lob is not empty and nothing read, skipping 1 byte.
   **/
  public void Var050() {
    if (checkJdbc20()) {
      if (checkLobSupport()) {
  ...
  /**
   * skip() - When the lob is not empty and some have been read, reading 1 byte.
   **/
  public void Var051() {
    if (checkJdbc20()) {
      if (checkLobSupport()) {
  ...
  /**
   * skip() - When the lob is not empty and some have been read, skipping several
   * bytes.
   **/
  public void Var052() {
    if (checkJdbc20()) {
  ...
  /**
   * skip() - When the lob is not empty and some have been read, skipping more
   * bytes than are ready.
   **/
  public void Var053() {
    if (checkJdbc20()) {
      if (checkLobSupport()) {
  ...
  /**
   * skip() - When the lob is not empty and skipping the entire lob.
   **/
  public void Var054() {
    if (checkJdbc20()) {
      if (checkLobSupport()) {
  ...
  /**
   * skip() - When the lob is not empty and skipping after the the entire lob has
   * been read.
   **/
  public void Var055() {
    if (checkJdbc20()) {
...
//@K1A
  /**
   * read() - When the lob is not empty and reading the entire lob.
   **/
  public void Var060() {
    if (checkJdbc20()) {
      if (checkLobSupport()) {
