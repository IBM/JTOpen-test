...
/**
 * Testcase JDConnectionPoolDataSource. This tests the following methods of the
 * JDBC class:
 * 
 * <ul>
 * <li>
...
public class JDConnectionPoolDataSource extends JDTestcase {
  ...
  private String NATIVE_DATA_SOURCE_CLASS = "com.ibm.db2.jdbc.app.DB2ConnectionPoolDataSource";

  /**
   * Constructor
   **/
  public JDConnectionPoolDataSource(AS400 systemObject, Hashtable<String, Vector<String>> namesAndVars, int runMode,
      FileOutputStream fileOutputStream,

      String password) {
    super(systemObject, "JDConnectionPoolDataSource", namesAndVars, runMode, fileOutputStream, password);
  }
    ...
    if (checkJdbc20StdExt()) {
      try {
        if (isToolboxDriver()) {
          ...
          ds = (ConnectionPoolDataSource) JDReflectionUtil.createObject(NATIVE_DATA_SOURCE_CLASS);
          ...
          c2 = ds.getPooledConnection(systemObject_.getUserId(),
              new String(PasswordVault.decryptPassword(encryptedPassword_))).getConnection();
          c3 = ds.getPooledConnection(systemObject_.getUserId(),
              new String(PasswordVault.decryptPassword(encryptedPassword_))).getConnection();
          c4 = ds.getPooledConnection(systemObject_.getUserId(),
              new String(PasswordVault.decryptPassword(encryptedPassword_))).getConnection();
          c5 = ds.getPooledConnection(systemObject_.getUserId(),
              new String(PasswordVault.decryptPassword(encryptedPassword_))).getConnection();
        }
  ...
  /**
   * Getting 6 connections from a pooled connection w/ only 5 connections should
   * work.
   **/
  public void Var009() {
    if (checkJdbc20StdExt()) {
      try {
        ...
        if (isToolboxDriver()) {
          ...
          c5 = ds.getPooledConnection(systemObject_.getUserId(),
              new String(PasswordVault.decryptPassword(encryptedPassword_))).getConnection();
          c6 = ds.getPooledConnection(systemObject_.getUserId(),
              new String(PasswordVault.decryptPassword(encryptedPassword_))).getConnection();
        }
        endTime = System.currentTimeMillis();
        output_.println("End Time " + endTime);
  ...
  /**
   * Make sure the cursor holdability (true) is still correct when reusing a
   * connection See CPS 9KZFRD.
   */
  public void Var010() {
    int i = 0;
    ...
    try {
      ...
      if (getDriver() == JDTestDriver.DRIVER_TOOLBOX) {
        ...
        ConnectionPoolDataSource ds1 = (ConnectionPoolDataSource) JDReflectionUtil
            .createObject(NATIVE_DATA_SOURCE_CLASS);

        JDReflectionUtil.callMethod_V(ds1, "setDatabaseName", systemObject_.getSystemName());
        JDReflectionUtil.callMethod_V(ds1, "setTransactionIsolationLevel", "read committed");
        sb.append("ds1.setAutoCommit(false)\n");
      ...
      PooledConnection pooledConnection = cpds.getPooledConnection(systemObject_.getUserId(),
  ...
  /**
   * Make sure the cursor holdability (false) is still correct when reusing a
   * connection See CPS 9KZFRD.
   */
  public void Var011() {
    int i = 0;
  ...
  /**
   * Make sure the cursor holdability (true) is still correct when reusing a
   * connection and it was set to false in the connection. See CPS 9KZFRD.
   */
  public void Var012() {
    int i = 0;
    StringBuffer sb = new StringBuffer();
    ...
    try {
      ...
      for (i = 0; errorCount < 10 && i < 50; i++) {
        ...
        sb.append("Setting holdability to CLOSE_CURSORS_AT_COMMIT should reset for new connection\n");
  ...
  /**
   * Make sure the cursor holdability (false) is still correct when reusing a
   * connection and the connection has changed the value. See CPS 9KZFRD.
   */
  public void Var013() {
    int i = 0;
    StringBuffer sb = new StringBuffer();
  ...
  public void testStringDataSourceProperty(String dataSourceSetMethod, String dataSourceSetValue, int setOperation,
      String setValue, String connectionGetMethod, String expectedGetValue) {
    testStringDataSourceProperty(dataSourceSetMethod, dataSourceSetValue, setOperation, setValue, false,
        connectionGetMethod, expectedGetValue);
  }

  public void testStringDataSourceProperty(String dataSourceSetMethod, String dataSourceSetValue, int setOperation,
      String setValue, boolean ignoreSetException, String connectionGetMethod, String expectedGetValue) {
    ...
    try {
      ...
      sb.append("Setting using " + dataSourceSetMethod + "(" + dataSourceSetValue + ")\n");

      if (dataSourceSetValue.equals("true")) {
        boolean setValueBoolean = true;
        JDReflectionUtil.callMethod_V(cpds, dataSourceSetMethod, setValueBoolean);
      } else if (dataSourceSetValue.equals("false")) {
        boolean setValueBoolean = true;
        JDReflectionUtil.callMethod_V(cpds, dataSourceSetMethod, setValueBoolean);

      } else {
        JDReflectionUtil.callMethod_V(cpds, dataSourceSetMethod, dataSourceSetValue);
      }
      PooledConnection pooledConnection = cpds.getPooledConnection(systemObject_.getUserId(),
          new String(PasswordVault.decryptPassword(encryptedPassword_)));
      for (i = 0; errorCount < 10 && i < 50; i++) {
        ...
        if (value instanceof String) {
          ...
          sb.append("Could not handle " + value + " of type " + value.getClass().getName() + "\n");
          errorCount++;
        }
        if (!expectedGetValue.equals(retrievedValue)) {
          errorCount++;
          sb.append("From " + connectionGetMethod + " got " + retrievedValue + " sb " + expectedGetValue + "\n");
        } else {
          sb.append("From " + connectionGetMethod + " got " + retrievedValue + " as expected\n");
  ...
  public void Var014() {
    testStringDataSourceProperty("setTransactionIsolationLevel", "none", SET_OPERATION_NONE, null, "getTransactionIsolation",
        "0");
  }

  public void Var015() {
    testStringDataSourceProperty("setTransactionIsolationLevel", "read uncommitted", SET_OPERATION_NONE, null,
        "getTransactionIsolation", "1");
  }

  public void Var016() {
    testStringDataSourceProperty("setTransactionIsolationLevel", "read committed", SET_OPERATION_NONE, null,
        "getTransactionIsolation", "2");
  }

  public void Var017() {
    testStringDataSourceProperty("setTransactionIsolationLevel", "repeatable read", SET_OPERATION_NONE, null,
        "getTransactionIsolation", "4");
  }

  public void Var018() {
    testStringDataSourceProperty("setTransactionIsolationLevel", "serializable", SET_OPERATION_NONE, null,
        "getTransactionIsolation", "8");
  }

  public void Var019() {
    testStringDataSourceProperty("setTransactionIsolationLevel", "none", SET_OPERATION_TRANSACTION_ISOLATION, "8",
        "getTransactionIsolation", "0");
  }

  public void Var020() {
    testStringDataSourceProperty("setTransactionIsolationLevel", "read uncommitted", SET_OPERATION_TRANSACTION_ISOLATION,
        "8", "getTransactionIsolation", "1");
  }

  public void Var021() {
    testStringDataSourceProperty("setTransactionIsolationLevel", "read committed", SET_OPERATION_TRANSACTION_ISOLATION, "8",
        "getTransactionIsolation", "2");
  }

  public void Var022() {
    testStringDataSourceProperty("setTransactionIsolationLevel", "repeatable read", SET_OPERATION_TRANSACTION_ISOLATION, "8",
        "getTransactionIsolation", "4");
  }

  public void Var023() {
    testStringDataSourceProperty("setTransactionIsolationLevel", "serializable", SET_OPERATION_TRANSACTION_ISOLATION, "4",
        "getTransactionIsolation", "8");
  }

  public void Var024() {
    testStringDataSourceProperty("setLibraries", "QGPL", SET_OPERATION_NONE, "", "getSchema", "QGPL");
  }

  public void Var025() {
    testStringDataSourceProperty("setLibraries", "QGPL", SET_OPERATION_SCHEMA, "QSYS", "getSchema", "QGPL");
  }

  public void Var026() {
    // Make sure default stays
    testStringDataSourceProperty("setTransactionIsolationLevel", "serializable", SET_OPERATION_SCHEMA, "QSYS", "getSchema",
        systemObject_.getUserId().toUpperCase());
  }

  /* Make sure the default auto commit value is good */
  public void Var027() {
    testStringDataSourceProperty("setLibraries", "QGPL", SET_OPERATION_NONE, "", "getAutoCommit", "true");
  }

  /* Make sure default auto commit value persists */

  public void Var028() {
    testStringDataSourceProperty("setLibraries", "QGPL", SET_OPERATION_AUTO_COMMIT, "false", "getAutoCommit", "true");
  }

  /* Make sure auto commit true is maintained */
  public void Var029() {
    testStringDataSourceProperty("setAutoCommit", "true", SET_OPERATION_NONE, "", "getAutoCommit", "true");
  }

  /* Make sure auto commit true is maintained */

  public void Var030() {
    testStringDataSourceProperty("setAutoCommit", "true", SET_OPERATION_AUTO_COMMIT, "false", "getAutoCommit", "true");
  }

  /* Make sure auto commit false is maintained */
  public void Var031() {
    testStringDataSourceProperty("setAutoCommit", "false", SET_OPERATION_NONE, "", "getAutoCommit", "false");
  }

  /* Make sure auto commit true is maintained */

  public void Var032() {
    testStringDataSourceProperty("setAutoCommit", "false", SET_OPERATION_AUTO_COMMIT, "true", "getAutoCommit", "false");
  }

  /* Make sure the default access value is good */
  public void Var033() {
    testStringDataSourceProperty("setLibraries", "QGPL", SET_OPERATION_NONE, "", "isReadOnly", "false");
  }

  /* Make sure default access value persists */

  public void Var034() {
    testStringDataSourceProperty("setLibraries", "QGPL", SET_OPERATION_READONLY, "true", "isReadOnly", "false");
  }

  /* Make sure access all is maintained */
  public void Var035() {
    testStringDataSourceProperty("setAccess", "all", SET_OPERATION_NONE, "", "isReadOnly", "false");
  }

  /* Make sure access all is maintained */

  public void Var036() {
    testStringDataSourceProperty("setAccess", "all", SET_OPERATION_READONLY, "true", "isReadOnly", "false");
  }

  /* Make sure access read only is maintained */
  public void Var037() {
    testStringDataSourceProperty("setAccess", "read only", SET_OPERATION_NONE, "", "isReadOnly", "true");
  }

  /* Make sure auto commit true is maintained */

  public void Var038() {
    testStringDataSourceProperty("setAccess", "read only", SET_OPERATION_READONLY, "false", true, "isReadOnly", "true");
  }
