...
//
// Filename:  JDStatementStressTest202.java
//
...
**/
public class JDStatementStressTest202
extends JDStatementStressTest
{
  public static void main(String args[]) throws Exception {
    String[] newArgs = new String[args.length+2];
     newArgs[0] = "-tc";
     newArgs[1] = "JDStatementStressTest202";
...
Constructor.
**/
    public JDStatementStressTest202 (AS400 systemObject,
                        ...
                        String miscParm)
    {
        super (systemObject, "JDStatementStressTest202",
  ...
  public void Var220() {     notApplicable("Moved to JDStatementStressTest206");   }
        ...
        **/
            public void Var202()
            {
                ...
                String updateTable = collection_+".JDSSU202"; 
		Statement stmt = null; 
                try {

                stmt = connection_.createStatement(); 
		initTable(stmt, updateTable,"( VALUE VARCHAR(80), KEY INT)");
                ...
                String selectStatement;
                    ...
                    JDStatementStressSelect sst[] = new JDStatementStressSelect[sstNum];
                    for(int i=1; i<=sst.length; i++) {
                      selectStatement = "SELECT CAST(VALUE AS VARCHAR("+(80 + i*10)+")) from  "+updateTable+" WHERE KEY > ? and KEY < ? ";
                        sst[i-1] = new JDStatementStressSelect(testDriver_, URL, userid, encryptedPassword,
                              i, runMillis_, selectStatement, (i-1)*keyBlock, i*keyBlock-1);
                    ...
                    while (isThreadStillAlive(null, null, sst)) {
                        Thread.sleep(100);
                    }
