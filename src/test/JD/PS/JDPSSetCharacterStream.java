...
/**
 * Testcase JDPSSetCharacterStream. This tests the following method of the JDBC
 ...
 * </ul>
 **/
public class JDPSSetCharacterStream extends JDTestcase {
   ...
   * Constructor.
   **/
  public JDPSSetCharacterStream(AS400 systemObject, Hashtable<String, Vector<String>> namesAndVars, int runMode,
      FileOutputStream fileOutputStream,

      String password) {
    super(systemObject, "JDPSSetCharacterStream", namesAndVars, runMode, fileOutputStream, password);
  }
  ...
  protected void setup() throws Exception {
    if (getDriver() == JDTestDriver.DRIVER_JCC) {
      ...
      String url = baseURL_
          ...
          + ";data truncation=true" + ";errors=full";
  ...
  /**
   * setCharacterStream() - Should throw exception when the prepared statement is
   * closed.
   **/
  public void Var001() {
    if (checkJdbc20()) {
      try {
        PreparedStatement ps = connection_
            .prepareStatement("INSERT INTO " + JDPSTest.PSTEST_SET + " (C_VARCHAR_50) VALUES (?)");
        ps.close();
  ...
  public void Var002() {
    if (checkJdbc20()) {
      try {
        PreparedStatement ps = connection_
            .prepareStatement("INSERT INTO " + JDPSTest.PSTEST_SET + " (C_INTEGER, C_SMALLINT) VALUES (?, ?)");
  ...
  /**
   * setCharacterStream() - Should work with a valid parameter index greater than
   * 1.
   **/
  public void Var006() {
    if (checkJdbc20()) {
      try {
        ...
        PreparedStatement ps = connection_
            .prepareStatement("INSERT INTO " + JDPSTest.PSTEST_SET + " (C_KEY, C_VARCHAR_50) VALUES (?, ?)");
  ...
  /**
   * setCharacterStream() - Should throw exception when the parameter is not an
   * input parameter.
   **/
  public void Var008() {
    if (checkJdbc20()) {
      ...
      try {
        PreparedStatement ps = connection_.prepareStatement("CALL " + JDSetupProcedure.STP_CSPARMS + " (?, ?, ?)");
  ...
  /**
   * setCharacterStream() - Verify that a data truncation warning is posted when
   * data is truncated.
   **/
  public void Var009() {
    if (checkJdbc20()) {
      ...
      try {
        ...
        assertCondition((dt.getIndex() == 1) && (dt.getParameter() == true) && (dt.getRead() == false)
            && (dt.getDataSize() == length) && (dt.getTransferSize() == 50));
      } catch (Exception e) {
        failed(e, "Unexpected Exception");
      }
    }
  ...
  public void Var010() {
    if (checkJdbc20()) {
      try {
        PreparedStatement ps = connection_
            .prepareStatement("INSERT INTO " + JDPSTest.PSTEST_SET + " (C_SMALLINT) VALUES (?)");
  ...
  public void Var011() {
    if (checkJdbc20()) {
      try {
        PreparedStatement ps = connection_
            .prepareStatement("INSERT INTO " + JDPSTest.PSTEST_SET + " (C_INTEGER) VALUES (?)");
  ...
  public void Var012() {
    if (checkJdbc20()) {
      try {
        PreparedStatement ps = connection_
            .prepareStatement("INSERT INTO " + JDPSTest.PSTEST_SET + " (C_REAL) VALUES (?)");
  ...
  public void Var013() {
    if (checkJdbc20()) {
      try {
        PreparedStatement ps = connection_
            .prepareStatement("INSERT INTO " + JDPSTest.PSTEST_SET + " (C_FLOAT) VALUES (?)");
  ...
  public void Var014() {
    if (checkJdbc20()) {
      try {
        PreparedStatement ps = connection_
            .prepareStatement("INSERT INTO " + JDPSTest.PSTEST_SET + " (C_DOUBLE) VALUES (?)");
  ...
  public void Var015() {
    if (checkJdbc20()) {
      try {
        PreparedStatement ps = connection_
            .prepareStatement("INSERT INTO " + JDPSTest.PSTEST_SET + " (C_DECIMAL_105) VALUES (?)");
  ...
  public void Var016() {
    if (checkJdbc20()) {
      try {
        PreparedStatement ps = connection_
            .prepareStatement("INSERT INTO " + JDPSTest.PSTEST_SET + " (C_NUMERIC_50) VALUES (?)");
  ...
  public void Var017() {
    if (checkJdbc20()) {
      try {
        ...
        PreparedStatement ps = connection_
            .prepareStatement("INSERT INTO " + JDPSTest.PSTEST_SET + " (C_CHAR_1) VALUES (?)");
  ...
  public void Var018() {
    if (checkJdbc20()) {
      try {
        ...
        PreparedStatement ps = connection_
            .prepareStatement("INSERT INTO " + JDPSTest.PSTEST_SET + " (C_CHAR_50) VALUES (?)");
  ...
  /**
   * setCharacterStream() - Set a VARCHAR(50) parameter, with the length equal to
   * the full stream.
   **/
  public void Var019() {
    if (checkJdbc20()) {
  ...
  /**
   * setCharacterStream() - Set a VARCHAR(50) parameter, with the length greater
  ...
  /**
   * setCharacterStream() - Set a VARCHAR(50) parameter, with the length set to 1
   * character.
   **/
  public void Var022() {
    if (checkJdbc20()) {
    ...
    if (checkJdbc20()) {
      if (checkLobSupport()) {
        try {
          ...
          PreparedStatement ps = connection_
              .prepareStatement("INSERT INTO " + JDPSTest.PSTEST_SET + " (C_CLOB) VALUES (?)");
  ...
  public void Var027() {
    if (checkJdbc20()) {
      if (checkLobSupport()) {
         ...
         * JDPSTest.PSTEST_SET + " (C_DBCLOB) VALUES (?)"); Reader r = new StringReader
         * ("Minnetonka"); ps.setCharacterStream (1, r, 10); ps.executeUpdate ();
         * ps.close ();
         * 
         * ResultSet rs = statement_.executeQuery ("SELECT C_DBCLOB FROM " +
         * JDPSTest.PSTEST_SET); rs.next (); String check = rs.getString (1); rs.close
         * ();
         * 
         * assertCondition (check.equals ("Minnetonka")); } catch (Exception e) { failed
  ...
  public void Var028() {
    if (checkJdbc20()) {
      try {
        ...
        PreparedStatement ps = connection_
            .prepareStatement("INSERT INTO " + JDPSTest.PSTEST_SET + " (C_BINARY_20) VALUES (?)");
  ...
  public void Var029() {
    if (checkJdbc20()) {
      try {
        ...
        PreparedStatement ps = connection_
            .prepareStatement("INSERT INTO " + JDPSTest.PSTEST_SET + " (C_VARBINARY_20) VALUES (?)");
        Reader r = new StringReader(expected);
  ...
  public void Var030() {
    if (checkJdbc20()) {
      try {
        PreparedStatement ps = connection_
            .prepareStatement("INSERT INTO " + JDPSTest.PSTEST_SET + " (C_BLOB) VALUES (?)");
  ...
  public void Var031() {
    if (checkJdbc20()) {
      try {
        PreparedStatement ps = connection_
            .prepareStatement("INSERT INTO " + JDPSTest.PSTEST_SET + " (C_DATE) VALUES (?)");
  ...
  public void Var032() {
    if (checkJdbc20()) {
      try {
        PreparedStatement ps = connection_
            .prepareStatement("INSERT INTO " + JDPSTest.PSTEST_SET + " (C_TIME) VALUES (?)");
  ...
  public void Var033() {
    if (checkJdbc20()) {
      try {
        PreparedStatement ps = connection_
            .prepareStatement("INSERT INTO " + JDPSTest.PSTEST_SET + " (C_TIMESTAMP) VALUES (?)");
      ...
      if (checkDatalinkSupport()) {
        try {
          ...
          PreparedStatement ps = connection_.prepareStatement(
              "INSERT INTO " + JDPSTest.PSTEST_SET + " (C_DATALINK) VALUES (DLVALUE( CAST(? AS VARCHAR(50))))");
  ...
  public void Var035() {
    if (checkJdbc20()) {
      if (checkLobSupport()) {
        try {
          PreparedStatement ps = connection_
              .prepareStatement("INSERT INTO " + JDPSTest.PSTEST_SET + " (C_DISTINCT) VALUES (?)");
  ...
  public void Var036() {
    if (checkJdbc20()) {
      if (checkBigintSupport()) {
        try {
          PreparedStatement ps = connection_
              .prepareStatement("INSERT INTO " + JDPSTest.PSTEST_SET + " (C_BIGINT) VALUES (?)");
  ...
  public void Var037() {
    if (checkJdbc20()) {
      try {
        String insert = "INSERT INTO " + JDPSTest.PSTEST_SET + " (C_VARCHAR_50) VALUES (?)";

        if (isToolboxDriver())
          JDSetupPackage.prime(systemObject_, PACKAGE, JDPSTest.COLLECTION, insert);
        else
          JDSetupPackage.prime(systemObject_, encryptedPassword_, PACKAGE, JDPSTest.COLLECTION, insert, "",
              getDriver());

        statement_.executeUpdate("DELETE FROM " + JDPSTest.PSTEST_SET);

        Connection c2 = testDriver_.getConnection(baseURL_ + ";extended dynamic=true;package=" + PACKAGE
            + ";package library=" + JDPSTest.COLLECTION + ";package cache=true", userId_, encryptedPassword_);
    ...
    if (checkJdbc20()) {
      if (checkLobSupport()) {
        try {
          ...
          failed(e,
              "Unexpected Exception -- Testcase added 06/02/04 by native driver to check 17 meg blobs -- this will fail for native in V5R2 with a malloc error ");
        }
      }
    }
  }
  ...
  public void Var039() {
    if (checkJdbc20()) {
      try {
        ...
        assertCondition(check.equals(""),
            "Check failed -- Test CLOB with 0 length -- Added 7/1/2004 by native driver ");
      } catch (Exception e) {
  ...
  public void Var042() {
    ...
    if (checkDecFloatSupport()) {
      try {
        PreparedStatement ps = connection_.prepareStatement("INSERT INTO " + JDPSTest.PSTEST_SETDFP16 + " VALUES (?)");
        Reader r = new StringReader("Maplewood");
        ps.setCharacterStream(1, r, 9);
        ps.executeUpdate();
        ps.close();
  ...
  public void Var043() {
    ...
    if (checkDecFloatSupport()) {
      try {
        PreparedStatement ps = connection_.prepareStatement("INSERT INTO " + JDPSTest.PSTEST_SETDFP34 + " VALUES (?)");
        Reader r = new StringReader("Maplewood");
        ps.setCharacterStream(1, r, 9);
        ps.executeUpdate();
        ps.close();
  ...
  public void setInvalidXML(String tablename, String data, String expectedException) {
    ...
    if (checkXmlSupport()) {
      try {
        ...
        String check = rs.getString(1);
        rs.close();
        failed("Didn't throw exception but got " + JDTestUtilities.getMixedString(check) + added);
  ...
  public void Var044() {
    setXML(JDPSTest.PSTEST_SETXML, "<Test>VAR044\u00a2</Test>", "<Test>VAR044\u00a2</Test>");
  }

  public void Var045() {
    setXML(JDPSTest.PSTEST_SETXML, "<?xml version=\"1.0\" encoding=\"UCS-2\"?><Test>VAR045\u00a2</Test>",
        "<Test>VAR045\u00a2</Test>");
  }
  ...
  public void Var047() {
    setXML(JDPSTest.PSTEST_SETXML13488, "<Test>VAR047</Test>", "<Test>VAR047</Test>");
  }

  public void Var048() {
    setXML(JDPSTest.PSTEST_SETXML13488, "<?xml version=\"1.0\" encoding=\"UCS-2\"?><Test>VAR048\u00a2</Test>",
        "<Test>VAR048\u00a2</Test>");
  }

  public void Var049() {
    setXML(JDPSTest.PSTEST_SETXML13488, "<?xml version=\"1.0\" encoding=\"UTF-16\"?>  <Test>VAR049\u0130\u3041</Test>",
        "<Test>VAR049\u0130\u3041</Test>");
  }

  public void Var050() {
    setXML(JDPSTest.PSTEST_SETXML1200, "<Test>VAR050</Test>", "<Test>VAR050</Test>");
  }

  public void Var051() {
    setXML(JDPSTest.PSTEST_SETXML1200, "<?xml version=\"1.0\" encoding=\"UCS-2\"?><Test>VAR051\u00a2</Test>",
        "<Test>VAR051\u00a2</Test>");
  }
  ...
  public void Var053() {
    setXML(JDPSTest.PSTEST_SETXML37, "<Test>VAR053\u00a2</Test>", "<Test>VAR053\u00a2</Test>");
  }

  public void Var054() {
    setXML(JDPSTest.PSTEST_SETXML37, "<?xml version=\"1.0\" encoding=\"UCS-2\"?><Test>VAR054\u00a2</Test>",
        "<Test>VAR054\u00a2</Test>");
  }

  public void Var055() {
    setXML(JDPSTest.PSTEST_SETXML37, "<?xml version=\"1.0\" encoding=\"UTF-16\"?>  <Test>VAR055\u00a2</Test>",
        "<Test>VAR055\u00a2</Test>");
  }

  public void Var056() {
    setXML(JDPSTest.PSTEST_SETXML937, "<Test>VAR056\u672b</Test>", "<Test>VAR056\u672b</Test>");
  }

  public void Var057() {
    setXML(JDPSTest.PSTEST_SETXML937, "<?xml version=\"1.0\" encoding=\"UCS-2\"?><Test>VAR057\u672b</Test>",
        "<Test>VAR057\u672b</Test>");
  }

  public void Var058() {
    setXML(JDPSTest.PSTEST_SETXML937, "<?xml version=\"1.0\" encoding=\"UTF-16\"?>  <Test>VAR058\u672b</Test>",
        "<Test>VAR058\u672b</Test>");
  }

  public void Var059() {
    setXML(JDPSTest.PSTEST_SETXML290, "<Test>VAR059</Test>", "<Test>VAR059</Test>");
  }

  public void Var060() {
    setXML(JDPSTest.PSTEST_SETXML290, "<?xml version=\"1.0\" encoding=\"UCS-2\"?><Test>VAR060\uff7a</Test>",
        "<Test>VAR060\uff7a</Test>");
  }

  public void Var061() {
    setXML(JDPSTest.PSTEST_SETXML290, "<?xml version=\"1.0\" encoding=\"UTF-16\"?>  <Test>VAR061\uff98</Test>",
        "<Test>VAR061\uff98</Test>");
  }

  /* Encoding is stripped for character data since we know is is UTF-16 */
  public void Var062() {
    setXML(JDPSTest.PSTEST_SETXML, "<?xml version=\"1.0\" encoding=\"UTF-8\"?><Test>VAR062</Test>",
        "<Test>VAR062</Test>");
  }

  public void Var063() {
    setInvalidXML(JDPSTest.PSTEST_SETXML, "<?xml version=\"1.0\" encoding=\"UTF-16\"?>  <Test>VAR063</Tes>",
        "XML parsing failed");
  }

  public void Var064() {
    setXML(JDPSTest.PSTEST_SETXML13488, "<?xml version=\"1.0\" encoding=\"IBM-037\"?><Test>VAR064</Test>",
        "<Test>VAR064</Test>");
  }

  public void Var065() {
    setInvalidXML(JDPSTest.PSTEST_SETXML13488, "<?xml version=\"1.0\" encoding=\"UTF-16\"?>  <Tes>VAR065</Test>",
        "XML parsing failed");
  }

  public void Var066() {
    setXML(JDPSTest.PSTEST_SETXML1200, "<?xml version=\"1.0\" encoding=\"UTF-8\"?><Test>VAR066</Test>",
        "<Test>VAR066</Test>");
  }

  public void Var067() {
    setInvalidXML(JDPSTest.PSTEST_SETXML1200, "<?xml version=\"1.0\" encoding=\"UTF-16\"?>  <Tes>VAR067</Test>",
        "XML parsing failed");
  }

  public void Var068() {
    setXML(JDPSTest.PSTEST_SETXML37, "<?xml version=\"1.0\" encoding=\"IBM-037\"?><Test>VAR068\u00a2</Test>",
        "<Test>VAR068\u00a2</Test>");
  }

  public void Var069() {
    setInvalidXML(JDPSTest.PSTEST_SETXML37, "<?xml version=\"1.0\" encoding=\"UTF-16\"?>  <Tet>VAR069</Test>",
        "XML parsing failed");
  }
  ...
  public void setInvalid(String column, String inputValue, String exceptionInfo) {
    ...
    try {
      ...
      PreparedStatement ps = connection_
          .prepareStatement("INSERT INTO " + JDPSTest.PSTEST_SET + " (" + column + ") VALUES (?)");
  ...
  public void setValidTest(String column, String inputValue, String outputValue) {
    try {
      ...
      ResultSet rs = statement_.executeQuery("SELECT " + column + " FROM " + JDPSTest.PSTEST_SET);
      rs.next();
      String check = rs.getString(1);
      rs.close();

      assertCondition(outputValue.equals(check), " check was " + check + " sb " + outputValue);
  ...
  /**
   * setAsciiStream() - Set a Boolean parameter. -- Streamss and CLOBs not
   * supported -- see JDBC spec for use of result set getter methods
   **/
  public void Var070() {
