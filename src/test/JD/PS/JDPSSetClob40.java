...
///////////////////////////////////////////////////////////////////////////////
 ...
 ////////////////////////////////////////////////////////////////////////
 //
 // File Name:    JDPSSetClob40.java
 //
 // Classes:      JDPSSetClob40
 //
 ////////////////////////////////////////////////////////////////////////
...
/**
Testcase JDPSSetClob40.  This tests the following method
...
Constructor.
**/
    public JDPSSetClob40 (AS400 systemObject,
                                    ...
                                    String password)
    {
        super (systemObject, "JDPSSetClob40",
...
if (checkJdbc40 ()) {
            try {
                ...
                JDReflectionUtil.callMethod_V(ps, "setClob", 1, r, (long) 9);
...
if (checkJdbc40 ()) {
            try {
                ...
                JDReflectionUtil.callMethod_V(ps, "setClob", 100, r, (long) 7);
...
if (checkJdbc40 ()) {
            try {
                ...
                JDReflectionUtil.callMethod_V(ps, "setClob", 0, r, (long) 11);
                ps.executeUpdate(); ps.close ();
                failed ("Didn't throw SQLException");
            }
            catch (Exception e) {
...
if (checkJdbc40 ()) {
            try {
                ...
                JDReflectionUtil.callMethod_V(ps, "setClob", 0, r, (long) 8);
                ps.executeUpdate(); ps.close ();
                failed ("Didn't throw SQLException");
            }
            catch (Exception e) {
...
if (checkJdbc40 ()) {
            try {
                ...
                PreparedStatement ps = connection_.prepareStatement (
                    "INSERT INTO " + pstestSet.getName()
                    + " (C_VARCHAR_50) VALUES (?)");
                JDReflectionUtil.callMethod_V(ps, "setClob", 1, (Reader) null, 0L);
                ps.executeUpdate ();
                ps.close ();
      ...
      pstestSet = JDPSTest.getPstestSet(connection_);
        if (checkJdbc40 ()) {
            try {
                ...
                JDReflectionUtil.callMethod_V(ps, "setClob", 2, r, (long) 12);
                ps.executeUpdate ();
                ps.close ();
        ...
        if (checkJdbc40 ()) {
          if (getDriver() == JDTestDriver.DRIVER_JCC) {
            ...
            try {
                ...
                JDReflectionUtil.callMethod_V(ps, "setClob", 2,r, 6L);
                ps.executeUpdate(); ps.close ();
                failed ("Didn't throw SQLException");
            }
            catch (Exception e) {
...
if (checkJdbc40 ()) {
            ...
            try {
                ...
                length = s.length ();
                JDReflectionUtil.callMethod_V(ps, "setClob", 1, r, (long) length);
                ps.executeUpdate(); ps.close ();
                failed ("Didn't throw SQLException");
            }
...
if (checkJdbc40 ()) {
            try {
                ...
                JDReflectionUtil.callMethod_V(ps, "setClob", 1, r, (long) 19);
                ps.executeUpdate(); ps.close ();
                failed ("Didn't throw SQLException");
            }
            catch (Exception e) {
...
if (checkJdbc40 ()) {
            try {
                ...
                JDReflectionUtil.callMethod_V(ps, "setClob", 1, r, (long) 5);
                ps.executeUpdate(); ps.close ();
                failed ("Didn't throw SQLException");
            }
            catch (Exception e) {
...
if (checkJdbc40 ()) {
            try {
                ...
                JDReflectionUtil.callMethod_V(ps, "setClob", 1, r, (long) 15);
                ps.executeUpdate(); ps.close ();
                failed ("Didn't throw SQLException");
            }
            catch (Exception e) {
...
if (checkJdbc40 ()) {
            try {
                ...
                JDReflectionUtil.callMethod_V(ps, "setClob", 1, r, (long) 11);
                ps.executeUpdate(); ps.close ();
                failed ("Didn't throw SQLException");
            }
            catch (Exception e) {
...
if (checkJdbc40 ()) {
            try {
                ...
                JDReflectionUtil.callMethod_V(ps, "setClob", 1, r, (long) 10);
                ps.executeUpdate(); ps.close ();
                failed ("Didn't throw SQLException");
            }
            catch (Exception e) {
...
if (checkJdbc40 ()) {
            try {
                ...
                JDReflectionUtil.callMethod_V(ps, "setClob", 1, r, (long) 8);
                ps.executeUpdate ();
                ps.close ();
...
if (checkJdbc40 ()) {
            try {
                ...
                JDReflectionUtil.callMethod_V(ps, "setClob", 1, r, (long) 2);
                failed ("Didn't throw SQLException");
            }
            catch (Exception e) {
                assertExceptionIsInstanceOf (e, "java.sql.SQLException");
...
if (checkJdbc40 ()) {
            if (checkLobSupport ()) {
                try {
                    ...
                    JDReflectionUtil.callMethod_V(ps, "setClob", 1, r, (long) 14);
                    ps.executeUpdate ();
                    ps.close ();
...
if (checkJdbc40 ()) {
            try {
               ...
               if (isToolboxDriver())
                ...
                JDReflectionUtil.callMethod_V(ps, "setClob", 1, r, (long) 16);
                ps.executeUpdate ();
                ps.close ();
        ...
        if (checkJdbc40 ()) {
            try {
               String expected = null;
                ...
                Reader r = new StringReader (expected);
                JDReflectionUtil.callMethod_V(ps, "setClob", 1, r, (long) 6);
                ps.executeUpdate ();
                ps.close ();
    ...
    try {
      pstestSet = JDPSTest.getPstestSet(connection_);
        if (checkJdbc40())
        {
            try
            {
                PreparedStatement ps = connection_.prepareStatement("INSERT INTO " + pstestSet.getName() +
								    " (C_BLOB) VALUES (?)");
...
if (checkJdbc40 ()) {
            try {
                ...
                JDReflectionUtil.callMethod_V(ps, "setClob", 1, r, (long) 13);
                ps.executeUpdate(); ps.close ();
                failed ("Didn't throw SQLException");
            }
            catch (Exception e) {
...
if (checkJdbc40 ()) {
            if (checkDatalinkSupport ()) {
                try {
                    ...
                    JDReflectionUtil.callMethod_V(ps, "setClob", 1, r, (long) url.length());
                    ps.executeUpdate ();
                    ps.close ();
	...
	String clobString=null; 
        if (checkJdbc40 ()) {
		    ...
		    ps.setInt(1,1); 
                    ...
                    JDReflectionUtil.callMethod_V(ps, "setClob", 2, r, (long) length);
                    ps.executeUpdate ();
                    ps.close ();
...
if (checkJdbc40 ()) {
		...
		ps.setNull(1, Types.SMALLINT); 
                JDReflectionUtil.callMethod_V(ps, "setClob", 2, r, (long) 0);
    ...
    /**
    setCharacterStream() - Should throw exception when the length is too large.
    **/
        public void Var040()
        {
    JDSerializeFile pstestSet = null;
    try {
            ...
            if (checkJdbc40 ()) {
                try {
                    PreparedStatement ps = connection_.prepareStatement (
                        ...
                        + " (C_VARCHAR_50) VALUES (?)");
                    Reader r = new StringReader ("Hampton");
                    JDReflectionUtil.callMethod_V(ps, "setClob", 1, r, 3000000000L);
                    failed ("Didn't throw SQLException");
                }
                catch (Exception e) {
                    assertExceptionIsInstanceOf (e, "java.sql.SQLException");
      ...
      if (pstestSet != null) {
        ...
        /**
         setCharacterStream() - Set a DECFLOAT parameter.
         **/
        public void Var041()
        {
...
**/
	public void setXML(int table, String data, String expected) {
		...
		if (checkXmlSupport ()) {
			...
			JDReflectionUtil.callMethod_V(ps, "setClob", 1, r, (long) data.length());
...
**/
	...
	public void setInvalid(String column, String inputValue, String exceptionInfo)  {
		...
		JDReflectionUtil.callMethod_V(ps, "setClob", 1, r, (long) inputValue.length());
