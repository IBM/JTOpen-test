...
/**
 * Testcase JDDSProperties. This tests the following methods of the JDBC Driver
 * class:
 * 
 * <ul>
 ...
 * </ul>
 **/
public class JDDSProperties extends JDTestcase {
   ...
   * Constructor.
   **/
  public JDDSProperties(AS400 systemObject, Hashtable<String, Vector<String>> namesAndVars, int runMode,
      FileOutputStream fileOutputStream, String password, String powerUserID, String powerPassword) {
    super(systemObject, "JDDSProperties", namesAndVars, runMode, fileOutputStream, password, powerUserID,
        powerPassword);
  }
  ...
  /*
   * The proto for variations - set the property - bind the context to the data
   * source - get the property - unbind the context from the data source
   */

  /**
   * getDataSourceName() - call getDataSourceName to check that the value set
   * before is returned.
   **/
  public void Var001() {
  ...
  /**
   * setDataSourceName(),getDataSourceName() - set the dataSourceName property and
  ...
  /**
   * getDatabaseName() - call getDatabaseName to check that the value set before
   * is returned.
   **/
  public void Var003() {
    if (checkJdbc20StdExt()) {
      try {
        ...
        assertCondition(databaseName.equals(expectedValue),
            "databaseName='" + databaseName + "' sb '" + expectedValue + "'");
        ctx_.unbind(bindName_);
      } catch (Exception e) {
        failed(e, "Unexpected Exception");
      }
  ...
  /**
   * setDatabaseName(),getDatabaseName() - set the databaseName property and then
   * verify it was set.
   **/
  public void Var004() {
    if (checkJdbc20StdExt()) {
  ...
  /**
   * getDescription() - call getDescription to check that the value set before is
   * returned.
   **/
  public void Var005() {
    if (checkJdbc20StdExt()) {
  ...
  /**
   * setDescription(),getDescription() - set the Description property and then
   * verify it was set.
   **/
  public void Var006() {
    if (checkJdbc20StdExt()) {
  ...
  /**
   * getLogWriter() - call getLogWriter to check that the default value is
   * returned.
   **/
  public void Var007() {
    if (checkJdbc20StdExt()) {
  ...
  /**
   * setLogWriter(),getLogWriter() - set the LogWriter property and then verify it
   * was set.
   **/
  public void Var008() {
    if (checkJdbc20StdExt()) {
  ...
  /**
   * getLoginTimeout() - call getLoginTimeout to check that the default value is
   * returned.
   **/
  public void Var009() {
    if (checkJdbc20StdExt()) {
  ...
  /**
   * setLoginTimeout(),getLoginTimeout() - set the LoginTimeout property and then
   * verify it was set.
   **/
  public void Var010() {
    if (checkJdbc20StdExt()) {
  ...
  /**
   * setAccess(),getAccess() - set the Access property and then verify it was set.
   **/
  public void Var012() {
    if (checkJdbc20StdExt()) {
      try {
  ...
  /**
   * setAccess(),getAccess() - set an invalid Access property. Should throw
   * exception.
   **/
  public void Var013() {
    if (checkJdbc20StdExt()) {
  ...
  /**
   * getDateFormat() - call getDateFormat to check that the default value is
   * returned.
   **/
  public void Var014() {
    if (checkJdbc20StdExt()) {
  ...
  /**
   * setDateFormat(),getDateFormat() - set the DateFormat property and then verify
   * it was set.
   **/
  public void Var015() {
    if (checkJdbc20StdExt()) {
  ...
  /**
   * setDateFormat(),getDateFormat() - set an invalid DateFormat property. Should
   * throw exception.
   **/
  public void Var016() {
    if (checkJdbc20StdExt()) {
  ...
  /**
   * getDateSeparator() - call getDateSeparator to check that the default value is
   * returned.
   **/
  public void Var017() {
    if (checkJdbc20StdExt()) {
  ...
  /**
   * setDateSeparator(),getDateSeparator() - set the DateSeparator property and
   * then verify it was set.
   **/
  public void Var018() {
    if (checkJdbc20StdExt()) {
  ...
  /**
   * setDateSeparator(),getDateSeparator() - set an invalid DateSeparator
  ...
  /**
   * getDecimalSeparator() - call getDecimalSeparator to check that the default
   * value is returned.
   **/
  public void Var020() {
    if (checkJdbc20StdExt()) {
  ...
  /**
   * setDecimalSeparator(),getDecimalSeparator() - set the DecimalSeparator
   * property and then verify it was set.
   **/
  public void Var021() {
    if (checkJdbc20StdExt()) {
      try {
  ...
  /**
   * setDecimalSeparator(),getDecimalSeparator() - set an invalid DecimalSeparator
   * property. Should throw exception.
   **/
  public void Var022() {
    if (checkJdbc20StdExt()) {
  ...
  /**
   * setUser(),getUser() - set the User property and then verify it was set.
   **/
  public void Var024() {
    if (checkJdbc20StdExt()) {
      try {
  ...
  /**
   * setPassword(),getPassword() - set the Password property and then verify it
   * was set.
   **/
  public void Var026() {
    if (getDriver() == JDTestDriver.DRIVER_TOOLBOX) {
  ...
  /**
   * getTimeFormat() - call getTimeFormat to check that the default value is
   * returned.
   **/
  public void Var029() {
    if (checkJdbc20StdExt()) {
  ...
  /**
   * setTimeFormat(),getTimeFormat() - set the TimeFormat property and then verify
   * it was set.
   **/
  public void Var030() {
    if (checkJdbc20StdExt()) {
  ...
  /**
   * setTimeFormat(),getTimeFormat() - set an invalid TimeFormat property. Should
   * throw exception.
   **/
  public void Var031() {
    if (checkJdbc20StdExt()) {
  ...
  /**
   * getTimeSeparator() - call getTimeSeparator to check that the default value is
   * returned.
   **/
  public void Var032() {
    if (checkJdbc20StdExt()) {
  ...
  /**
   * setTimeSeparator(),getTimeSeparator() - set the TimeSeparator property and
   * then verify it was set.
   **/
  public void Var033() {
    if (checkJdbc20StdExt()) {
  ...
  /**
   * setTimeSeparator(),getTimeSeparator() - set an invalid TimeSeparator
   * property. Should throw exception.
   **/
  public void Var034() {
    if (checkJdbc20StdExt()) {
  ...
  /**
   * setNamingOption(),getNamingOption() - set the naming property and then verify
   * it was set.
   **/
  public void Var036() {
    if (checkJdbc20StdExt()) {
  ...
  /**
   * setNamingOption() - set the Naming property to an invalid value. Exception
   * should be thrown
   **/
  public void Var037() {
    if (checkJdbc20StdExt()) {
   ...
   * variations, these depend on the value of the "naming" property. In the
   * default case where "naming" is "sql", the default library is the same name as
   * the user profile. If "naming" is set to "system", the default lib will be the
   * top lib in the users library list.
   */

  /**
   * getLibraries() - call getLibraries to check that the default value is
   * returned.
   **/
  public void Var038() {
    if (checkJdbc20StdExt()) {
      try {
        ...
        JDReflectionUtil.callMethod_V(dataSource_, "setPassword",
            PasswordVault.decryptPasswordLeak(encryptedPassword_, "JDDProperties.38"));
        ctx_.rebind(bindName_, dataSource_);
        Object ds = ctx_.lookup(bindName_);
  ...
  /**
   * getLibraries() - set the "naming" to "system", call getLibraries to check
   * that the correct (default) value is returned. The default library when using
   * system naming is that there isn't one. This was changed for V4R4 from QGPL.
   **/
  public void Var039() {
    if (checkJdbc20StdExt()) {
      try {
        JDReflectionUtil.callMethod_V(dataSource_, "setUser", userId_);
        JDReflectionUtil.callMethod_V(dataSource_, "setPassword",
            PasswordVault.decryptPasswordLeak(encryptedPassword_, "JDDSProperties.39"));
        if (getDriver() == JDTestDriver.DRIVER_TOOLBOX) {
  ...
  /**
   * setLibraries(),getLibraries() - set the Libraries property and then verify it
   * was set.
   **/
  public void Var040() {
    if (checkJdbc20StdExt()) {
  ...
  /**
   * setTrace(),getTrace() - set the Trace property and then verify it was set.
   **/
  ...
  /**
   * getTransactionIsolationLevel() - call getTransactionIsolationLevel to check
   * that the default value is returned.
   **/
  public void Var043() {
    if (checkJdbc20StdExt()) {
      try {
  ...
  public void Var044() {
    if (checkJdbc20StdExt()) {
      try {
        ...
        assertCondition("read committed".equals(setting),
            "For " + getMethod + " got " + setting + " sb read committed");
        ctx_.unbind(bindName_);
      } catch (Exception e) {
        failed(e, "Unexpected Exception");
      }
  ...
  /**
   * setTransactionIsolationLevel(),getTransactionIsolationLevel() - set an
   * invalid TransactionIsolationLevel property. Should throw exception.
   **/
  public void Var045() {
    if (checkJdbc20StdExt()) {
      try {
  ...
  /**
   * setUseBlocking(),getUseBlocking() - set the UseBlocking property and then
   * verify it was set.
   **/
  public void Var047() {
    if (getDriver() == JDTestDriver.DRIVER_TOOLBOX) {
  ...
  /**
   * setBlockSize(),getBlockSize() - set the BlockSize property and then verify it
   * was set.
   **/
  public void Var049() {
    if (checkJdbc20StdExt()) {
  ...
  /**
   * setBlockSize(),getBlockSize() - set the BlockSize property to an invalid
   * value. Exception should be thrown.
   **/
  public void Var050() {
    if (checkJdbc20StdExt()) {
      try {
...
//NERYKAL
  /**
   * getAutoCommit() - call getAutoCommit to check the default. it is important
   * that TransactionIsolation level is set to its default value because
   * AutoCommit is dependent of that value
   **/
  public void Var051() {
    if (checkJdbc20StdExt()) {
      try {
        ...
        ctx_.rebind(bindName_, dataSource_);
        Object ds = ctx_.lookup(bindName_);
        assertCondition(JDReflectionUtil.callMethod_B(ds, getAutoCommitMethod) == true,
            "New native property (toolbox will need) Auto Commit = "
                + JDReflectionUtil.callMethod_B(ds, getAutoCommitMethod));
        ctx_.unbind(bindName_);
  ...
  /**
   * setAutoCommit(),getAutoCommit() - set AutoCommit property and then verify it
   * was set.
   **/
  public void Var052() {
    if (checkJdbc20StdExt()) {
      try {
        ...
        ctx_.rebind(bindName_, dataSource_);
        Object ds = ctx_.lookup(bindName_);
        assertCondition(JDReflectionUtil.callMethod_B(ds, getMethod) == false,
            "New native property (toolbox will need)");
        ctx_.unbind(bindName_);
      } catch (Exception e) {
        failed(e, "Unexpected Exception New native property (toolbox will need)");
      }
  ...
  /**
   * setAutoCommit(),getAutoCommit() - set AutoCommit property to an invalid value
   * and verify that it was set
   **/
  public void Var053() {
    if (checkJdbc20StdExt()) {
      try {
  ...
  /**
   * error should be thrown when invalid number is entered for minimum divide
   * scale
   **/
  public void Var065() {
    if (checkJdbc20StdExt()) {
  ...
  public void Var066() {
    if (checkJdbc20StdExt()) {
      try {
        ...
        assertCondition(property.equalsIgnoreCase("character"),
            "Expecting: \"character\" Received: \"" + property + "\" -- New native property (toolbox will need)");
        ctx_.unbind(bindName_);
      } catch (Exception e) {
        failed(e, "Unexpected Exception New native property (toolbox will need)");
      }
  ...
  /**
   * set translate hex to its only other valid value "binary" and check that it
   * was changed
   **/
  public void Var068() {
    if (checkJdbc20StdExt()) {
      try {
        ...
        Object ds = ctx_.lookup(bindName_);
        String property = JDReflectionUtil.callMethod_S(ds, "getTranslateHex");
        assertCondition(property.equalsIgnoreCase("binary"),
            "Expecting: \"binary\" Received: \"" + property + "\" -- New native property (toolbox will need)");
        ctx_.unbind(bindName_);
      } catch (Exception e) {
        failed(e, "Unexpected Exception New native property (toolbox will need)");
      }
  ...
  /**
   * getCursorSensitivity() -- call getCursorSensitivity() to check the default
   * value, should be "asensitive"
   **/
  public void Var070() {
    if (checkJdbc20StdExt()) {
      try {
        ...
        assertCondition(property.equalsIgnoreCase("asensitive"), "Expecting: \"asensitive\" Received: \"" + property
            + "\" -- New native property (toolbox will need) added by native 01/16/04");
  ...
  /**
   * setCursorSensitivity(), getCursorSensitivity() -- call setCursorSensitivity()
   * to set it to "asensitive" and check that it was changed correctly
   **/
  public void Var071() {
    if (checkJdbc20StdExt()) {
      try {
  ...
  /**
   * setCursorSensitivity(), getCursorSensitivity() -- call setCursorSensitivity()
   * to set it to "insensitive" and check that it was changed correctly
   **/
  public void Var072() {
    if (checkJdbc20StdExt()) {
      try {
        ...
        Object ds = ctx_.lookup(bindName_);
        String property = JDReflectionUtil.callMethod_S(ds, "getCursorSensitivity");
        assertCondition(property.equalsIgnoreCase("insensitive"), "Expecting: \"insensitive\" Received: \"" + property
            + "\" -- New native property (toolbox will need) added by native 01/16/04");
  ...
  /**
   * setCursorSensitivity(), getCursorSensitivity() -- call setCursorSensitivity()
   * to set it to "sensitive" and check that it was changed correctly
   **/
  public void Var073() {
    if (checkJdbc20StdExt()) {
      try {
        if (getDriver() == JDTestDriver.DRIVER_TOOLBOX) {
          ...
          assertCondition(property.equalsIgnoreCase("sensitive"), "Expecting: \"sensitive\" Received: \"" + property
              + "\" -- New native property (toolbox will need) added by native 01/16/04");
        } else {
  ...
  /**
   * setCursorSensitivity() -- call setCursorSensitivity() with an invalid value
  ...
  /**
   * getReturnExtendedMetaData() -- call getReturnExtendedMetaData() to check the
    ...
    if (checkJdbc20StdExt()) {
      try {
        if (getDriver() == JDTestDriver.DRIVER_TOOLBOX) {
          ...
          assertCondition(!property, "Expecting: \"false\" Received: \"" + property
              + "\" -- New native property (toolbox will need) added by native 02/03/04");
        } else {
          ctx_.rebind(bindName_, dataSource_);
          Object ds = ctx_.lookup(bindName_);
  ...
  /**
   * setReturnExtendedMetaData(), getReturnExtendedMetaData() -- call
   * setReturnExtendedMetaData() to set it to "false" and check that it was
   * changed correctly
   **/
  public void Var076() {
    if (checkJdbc20StdExt()) {
  ...
  /**
   * setReturnExtendedMetaData(), getReturnExtendedMetaData() -- call
   * setExtendedMetaData() to set it to "true" and check that it was changed
   * correctly
   **/
  public void Var077() {
    if (checkJdbc20StdExt()) {
      try {
        if (getDriver() == JDTestDriver.DRIVER_TOOLBOX) {
          ...
          AS400JDBCDataSource dsTB = (AS400JDBCDataSource) ctx_.lookup(bindName_); // new AS400JDBCDataSource();
          boolean property = JDReflectionUtil.callMethod_B(dsTB, "isExtendedMetaData");
          assertCondition(property, "Expecting: \"true\" Received: \"" + property
              + "\" -- New native property (toolbox will need) added by native 02/03/04");
        } else {
  ...
  /**
   * getDirectMap() -- call getDirectMap() to check the default value, should be
   * "false"
   **/
  public void Var078() {
    if (true && (getDriver() == JDTestDriver.DRIVER_NATIVE)) {
      if (checkJdbc20StdExt()) {
        try {
          ...
          assertCondition(!property,
              "Expecting: \"false\" Received: \"" + property + "\" -- New native property added by native 12/30/05");
          ctx_.unbind(bindName_);
        } catch (Exception e) {
  ...
  /**
   * setDirectMap(), getDirectMap() -- call setDirectMap() to set it to "false"
  ...
  /**
   * setDirectMap(), getDirectMap() -- call setDirectMap() to set it to "true" and
    ...
    if (true && (getDriver() == JDTestDriver.DRIVER_NATIVE)) {
      if (checkJdbc20StdExt()) {
        try {
          ...
          boolean property = JDReflectionUtil.callMethod_B(ds, "getDirectMap");
          assertCondition(property,
              "Expecting: \"true\" Received: \"" + property + "\" -- New native property added by native 12/30/05");
          ctx_.unbind(bindName_);
        } catch (Exception e) {
          failed(e, "Unexpected Exception -- New native property  added by native 12/30/05");
        }
  ...
  /**
   * getQueryOptimizeGoal() -- call getQueryOptimizeGoal() to check the default
   * value, should be "2" for native 0 for toolbox
   **/
  public void Var081() {
    ...
    if (checkJdbc20StdExt()) {
      try {
        ...
        if (getDriver() == JDTestDriver.DRIVER_TOOLBOX) {
          ...
          assertCondition(expected.equals(property),
              "Expecting: \"" + expected + "\" Received: \"" + property + "\" " + added);
        } else {
          ctx_.rebind(bindName_, dataSource_);
          Object ds = ctx_.lookup(bindName_);
  ...
  /**
   * setQueryOptimizeGoal(), getQueryOptimizeGoal() -- call setQueryOptimizeGoal()
   * to set it to "2" and check that it was changed correctly
   **/
  public void Var082() {
    String added = " -- new v5r4 property added by native 01/19/2006";
    if (checkJdbc20StdExt()) {
  ...
  public void Var084() {
    ...
    if (checkJdbc20StdExt()) {
      try {
        ...
        String[] propsNVM = { "access", "read call", "getAccess", "behavior override", "1", "getBehaviorOverride",
            "bidi string type", "6", "getBidiStringType", "big decimal", "false", "isBigDecimal", "block size", "128",
            "getBlockSize", "block criteria", "1", "getBlockCriteria", "cursor hold", "false", "isCursorHold",
            "cursor sensitivity", "sensitive", "getCursorSensitivity", "data compression", "false", "isDataCompression",
            "data truncation", "false", "isDataTruncation", "database name", "testdb", "getDatabaseName", "date format",
            "julian", "getDateFormat", "date separator", ".", "getDateSeparator", "decimal separator", ",",
            "getDecimalSeparator", "driver", "native", "getDriver", "errors", "full", "getErrors", "extended dynamic",
            "true", "isExtendedDynamic", "extended metadata", "true", "isExtendedMetaData", "full open", "true",
            "isFullOpen", "hold input locators", "false", "isHoldInputLocators", "key ring name", "keyname", "",
            "key ring password", "keypass", "", "lazy close", "true", "isLazyClose", "libraries", "testlib",
            "getLibraries", "lob threshold", "1", "getLobThreshold", "maximum precision", "63", "getMaximumPrecision",
            "maximum scale", "9", "getMaximumScale", "minimum divide scale", "4", "getMinimumDivideScale", "naming",
            "system", "getNaming", "package", "testpack", "getPackage", "package add", "false", "isPackageAdd",
            "package cache", "true", "isPackageCache", "package ccsid", "1200", "getPackageCCSID", "package clear",
            "false", "isPackageClear", "package criteria", "select", "getPackageCriteria", "package error", "warning",
            "getPackageError", "package library", "packlib", "getPackageLibrary", "password", "testpw", "", "prefetch",
            "false", "isPrefetch", "prompt", "false", "isPrompt", "proxy server", "pxy", "getProxyServer", "remarks",
            "sql", "getRemarks", "secondary URL", "testurl", "getSecondaryUrl", "secure", "true", "isSecure", "sort",
            "table", "getSort", "sort language", "lang", "getSortLanguage", "sort table", "sorttab", "getSortTable",
            "sort weight", "unique", "getSortWeight", "thread used", "false", "isThreadUsed", "time format", "iso",
            "getTimeFormat", "time separator", ".", "getTimeSeparator", "trace", "false", "isTrace", "server trace",
            "1", "getServerTraceCategories", "toolbox trace", "none", "getToolboxTraceCategory",
            "transaction isolation", "serializable", "getTransactionIsolation", "translate binary", "true",
            "isTranslateBinary", "translate hex", "binary", "getTranslateHex", "user", "TESTUSR", "getUser",
            "qaqqinilib", "whatlib", "getQaqqiniLibrary", "login timeout", "100", "getLoginTimeout", "true autocommit",
            "true", "isTrueAutoCommit", "bidi implicit reordering", "false", "isBidiImplicitReordering",
            "bidi numeric ordering", "true", "isBidiNumericOrdering", "hold statements", "true", "isHoldStatements",
            "rollback cursor hold", "true", "isRollbackCursorHold", "variable field compression", "false",
            "isVariableFieldCompression", "query optimize goal", "2", "getQueryOptimizeGoal", "keep alive", "true",
            "getKeepAlive", "receive buffer size", "111", "getReceiveBufferSize", "send buffer size", "222",
            "getSendBufferSize", "XA loosely coupled support", "1", "getXALooselyCoupledSupport", "translate boolean",
            "false", "isTranslateBoolean", "metadata source", "1", "getMetadataSource", "query storage limit", "-1",
            "getQueryStorageLimit", "decfloat rounding mode", "half even", "getDecfloatRoundingMode",
            "autocommit exception", "false", "isAutocommitException", "auto commit", "true", "isAutoCommit" };
        ...
        for (int x = 0; x < count; x++) {
          int ind = x * 3;
          String value = null;
          // rather than adding return types from getters to array, just try each method
          // for now
          try {
          ...
          if ((value != "") && (value.equals(propsNVM[ind + 1]) == false)) {
            System.out
                .println("Property: " + propsNVM[ind] + ", set to " + propsNVM[ind + 1] + ", but get back " + value);
            passed = false;
          }
  ...
  /**
   * getDecfloatRoundingMode() -- call getDecfloatRoundingMode() to check the
   * default value, should be "round half even"
   **/
  public void Var085() {
  ...
  /**
   * setDecfloatRoundingMode(), getDecfloatRoundingMode() -- call
   * setDecfloatRoundingMode() to set it to "round half even" and check that it
  ...
  public void Var086() {
    ...
    if (checkDecFloatSupport()) {
      try {
        ...
        Object ds = ctx_.lookup(bindName_);
        String property = JDReflectionUtil.callMethod_S(ds, "getDecfloatRoundingMode");
        assertCondition(testValue.equals(property),
            "Expecting: \"" + testValue + "\" Received: \"" + property + "\" " + added);
  ...
  /**
   * setSort() to test toolbox ptf to not throw exception if sort=job, but to use
   * default
   */
  public void Var093() {
  ...
  /**
   * getQaqqinilib() -- call getQaqqinilib() to check the default value, should be
   * "QUSRSYS"
   **/
  public void Var094() {
  ...
  /**
   * getIgnoreWarnings() -- call getIgnoreWarnings() to check the default value,
   * should be ""
   **/
  public void Var096() {
    String added = " -- new V5R5 property added by native driver 05/22/07";
  ...
  /**
   * setIgnoreWarnings(), getIgnoreWarnings() -- call setIgnoreWarnings() to set
   * it to "0100C" and check that it was changed correctly
   **/
  public void Var097() {
    String added = " -- new V5R5 property added by native driver 05/22/07";
    if (true && (getDriver() == JDTestDriver.DRIVER_NATIVE)) {
      try {
        ...
        Object ds = ctx_.lookup(bindName_);
        String property = JDReflectionUtil.callMethod_S(ds, "getIgnoreWarnings");
        assertCondition("0100C".equals(property0) && "0100C".equals(property),
            "Expecting: \"0100C\" Received: \"" + property0 + "\" \"" + property + "\"" + added);
        ctx_.unbind(bindName_);
      } catch (Exception e) {
        failed(e, "Unexpected Exception" + added);
      }
  ...
  /**
   * getServermodeSubsystem() -- call getServermodeSubsystem() to check the
   * default value, should be "QSYSWRK"
   **/
  public void Var098() {
  ...
  /**
   * setServermodeSubsystem(), getServermodeSubsystem() -- call
   * setServermodeSubsystem() to set it to "QUSRWRK" and check that it was changed
   * correctly
   **/
  public void Var099() {
    String added = " -- new V7R1 property added by native driver 01/09/09";
  ...
  /**
   * getConcurrentAccessResolution() -- call getConcurrentAccessResolution() to
   * check the default value, should be "QSYSWRK"
   **/
  public void Var100() {
    String added = " -- new V7R1 property added by native driver 01/09/09";
    if (checkJdbc20StdExt()) {
      try {
        if (getDriver() == JDTestDriver.DRIVER_TOOLBOX) {
          ...
          assertCondition(property == 0, "Expecting: 0 Received: " + property + " " + added);
          ctx_.unbind(bindName_);
        } else {
          ctx_.rebind(bindName_, dataSource_);
          Object ds = ctx_.lookup(bindName_);
  ...
  /**
   * setConcurrentAccessResolution(), getConcurrentAccessResolution() -- call
   * setConcurrentAccessResolution() to set it to "QUSRWRK" and check that it was
   * changed correctly
   **/
  public void Var101() {
    String added = " -- new V7R1 property added by native driver 01/09/09";
    try {
      if (getDriver() == JDTestDriver.DRIVER_TOOLBOX) {
        ...
        DataSource ds = (DataSource) ctx_.lookup(bindName_);
        int property = JDReflectionUtil.callMethod_I(ds, "getConcurrentAccessResolution");
        assertCondition(property == 1, "Expecting: 1 Received: " + property + " " + added);
        ctx_.unbind(bindName_);
      } else {
  ...
  /**
   * setConcurrentAccessResolution(), getConcurrentAccessResolution() -- call
   * setConcurrentAccessResolution() to set it to 2 and check that it was changed
   * correctly
   **/
  public void Var102() {
    String added = " -- new V7R1 property added by native driver 01/09/09";
    try {
      if (getDriver() == JDTestDriver.DRIVER_TOOLBOX) {
        ...
        DataSource ds = (DataSource) ctx_.lookup(bindName_);
        int property = JDReflectionUtil.callMethod_I(ds, "getConcurrentAccessResolution");
        assertCondition(property == 2, "Expecting: 2 Received: " + property + " " + added);
        ctx_.unbind(bindName_);
      } else {
  ...
  public void Var103() {
    ...
    try {
      if (getDriver() == JDTestDriver.DRIVER_TOOLBOX) {
        ...
        DataSource ds = (DataSource) ctx_.lookup(bindName_);
        int property = JDReflectionUtil.callMethod_I(ds, "getConcurrentAccessResolution");
        assertCondition(property == 3, "Expecting: 3 Received: " + property + " " + added);
        ctx_.unbind(bindName_);
      } else {
  ...
  /**
   * set the maximum blocked input rows to a valid number and see that it was
   * changed
   **/
  public void Var105() {
    if (checkJdbc20StdExt()) {
  ...
  /**
   * getQueryReplaceTruncatedParameter() -- call
   * getQueryReplaceTruncatedParameter() to check the default value, should be ""
   **/
  public void Var110() {
  ...
  /**
   * setQueryReplaceTruncatedParameter(), getQueryReplaceTruncatedParameter() --
   * call setQueryReplaceTruncatedParameter() to set it to "@@@@@@" and check that
  ...
  /**
   * setAdditionalAuthenticationFactor(), getAdditionalAuthenticationFactor() --
   * call setAdditionalAuthenticationFactor() to set it to "@@@@@@" and check that
   * it was changed correctly
   **/
  public void Var113() {
    String added = " -- new V7R5+ property added by native driver";
    if (checkNative() && checkRelease760(added)) {
      try {
        Object ds;
        ds = dataSource_;
        ...
        assertCondition("123456".equals(propertyAfterSerialization) && "123456".equals(propertyBeforeSerialization),
            "Expecting: \"123456\" BeforeSerialization: \"" + propertyBeforeSerialization + "\" AfterSerialization: \""
                + propertyAfterSerialization + "\"" + added);
        ctx_.unbind(bindName_);
      } catch (Exception e) {
        failed(e, "Unexpected Exception" + added);
      }
  ...
  /**
   * getAuthenticationVerificationId() -- call getAuthenticationVerificationId()
   * to check the default value, should be ""
   **/
  public void Var114() {
    String added = " -- new V7R5+ property added by native driver";
    if (checkRelease760(added)) {
  ...
  /**
   * setAuthenticationVerificationId(), getAuthenticationVerificationId() -- call
   * setAuthenticationVerificationId() to set it to "@@@@@@" and check that it was
   * changed correctly
   **/
  public void Var115() {
    String added = " -- new V7R5+ property added by native driver";
    if (checkNative() && checkRelease760(added)) {
      try {
        ...
        assertCondition(
            "MY_SUPER_APP".equals(propertyAfterSerialization) && "MY_SUPER_APP".equals(propertyBeforeSerialization),
            "Expecting: \"MY_SUPER_APP\" BeforeSerialization: \"" + propertyBeforeSerialization
                + "\" AfterSerialization: \"" + propertyAfterSerialization + "\"" + added);
        ctx_.unbind(bindName_);
      } catch (Exception e) {
        failed(e, "Unexpected Exception" + added);
      }
  ...
  /**
   * getAuthenticationLocalIP() -- call getAuthenticationLocalIP() to check the
  ...
  /**
   * setAuthenticationLocalIP(), getAuthenticationLocalIP() -- call
   * setAuthenticationLocalIP() to set it to "@@@@@@" and check that it was
   * changed correctly
   **/
  public void Var117() {
    String added = " -- new V7R5+ property added by native driver";
  ...
  /**
   * getAuthenticationRemoteIP() -- call getAuthenticationRemoteIP() to check the
   * default value, should be ""
   **/
  public void Var118() {
    String added = " -- new V7R5+ property added by native driver";
  ...
  /**
   * setAuthenticationRemoteIP(), getAuthenticationRemoteIP() -- call
   * setAuthenticationRemoteIP() to set it to "@@@@@@" and check that it was
   * changed correctly
   **/
  public void Var119() {
    String added = " -- new V7R5+ property added by native driver";
  ...
  /**
   * getAuthenticationLocalPort() -- call getAuthenticationLocalPort() to check
  ...
  /**
   * setAuthenticationLocalPort(), getAuthenticationLocalPort() -- call
   * setAuthenticationLocalPort() to set it to "@@@@@@" and check that it was
   * changed correctly
   **/
  public void Var121() {
    String added = " -- new V7R5+ property added by native driver";
    if (checkNative() && checkRelease760(added)) {
      try {
        ...
        assertCondition(12345 == portAfterSerialization && 12345 == portBeforeSerialization,
            "Expecting: 123456\" BeforeSerialization: \"" + portBeforeSerialization + "\" AfterSerialization: \""
                + portAfterSerialization + "\"" + added);
        ctx_.unbind(bindName_);
      } catch (Exception e) {
        failed(e, "Unexpected Exception" + added);
      }
  ...
  /**
   * getAuthenticationRemotePort() -- call getAuthenticationRemotePort() to check
   * the default value, should be ""
   **/
  public void Var122() {
    String added = " -- new V7R5+ property added by native driver";
  ...
  /**
   * setAuthenticationRemotePort(), getAuthenticationRemotePort() -- call
   * setAuthenticationRemotePort() to set it to "@@@@@@" and check that it was
   * changed correctly
   **/
  public void Var123() {
    String added = " -- new V7R5+ property added by native driver";
    if (checkNative() && checkRelease760(added)) {
      try {
        ...
        assertCondition((12345 == portAfterSerialization) && (12345 == portBeforeSerialization),
            "Expecting: \"12345\" BeforeSerialization: \"" + portBeforeSerialization + "\" AfterSerialization: \""
                + portAfterSerialization + "\"" + added);
        ctx_.unbind(bindName_);
      } catch (Exception e) {
        failed(e, "Unexpected Exception" + added);
  ...
  public void Var124() {
    ...
    if (checkNative() && checkRelease760(addedInfo) && checkAdditionalAuthenticationFactor(systemName)
      ...
      try {
        ...
        ;
        Connection pwrConnection_ = (Connection) JDReflectionUtil.callMethod_O(driver_, "connect", argTypes, baseURL_,
            properties, charPassword);
