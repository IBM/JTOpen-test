...
/**
 * Testcase JDRSUpdateNClob. This tests the following method of the JDBC
 * ResultSet class:
 * 
 * <ul>
 * <li>updateNClob()
 * </ul>
 **/
public class JDRSUpdateNClob extends JDTestcase {
   ...
   * Constructor.
   **/
  public JDRSUpdateNClob(AS400 systemObject, Hashtable<String, Vector<String>> namesAndVars, int runMode,
      FileOutputStream fileOutputStream,

      String password) {
    super(systemObject, "JDRSUpdateNClob", namesAndVars, runMode, fileOutputStream, password);
  }
  ...
  protected void setup() throws Exception {
    ...
    if (isJdbc40()) {
     ...
     statement_ = connection_.createStatement(ResultSet.TYPE_SCROLL_SENSITIVE, ResultSet.CONCUR_UPDATABLE);
      ...
      statement_.executeUpdate("INSERT INTO " + JDRSTest.RSTEST_UPDATE + " (C_KEY) VALUES ('DUMMY_UPDNCLOB')");
  ...
  /**
   * updateNClob() - Should throw exception when the result set is closed.
   **/
  public void Var001() {
    if (checkJdbc40()) {
  ...
  /**
   * updateNClob() - Should throw exception when the result set is not updatable.
   **/
  public void Var002() {
    if (checkJdbc40()) {
  ...
  /**
   * updateNClob() - Should throw exception when cursor is not pointing to a row.
   **/
  public void Var003() {
    if (checkJdbc40()) {
  ...
  /**
   * updateNClob() - Should throw an exception when the column is an invalid
   * index.
   **/
  public void Var004() {
    if (checkJdbc40()) {
  ...
  /**
   * updateNClob() - Should throw an exception when the column is 0.
   **/
  public void Var005() {
    if (checkJdbc40()) {
  ...
  /**
   * updateNClob() - Should throw an exception when the column is -1.
   **/
  public void Var006() {
    if (checkJdbc40()) {
  ...
  /**
   * updateNClob() - Should throw an exception when the column name is null.
   **/
  public void Var008() {
    if (checkJdbc40()) {
  ...
  /**
   * updateNClob() - Should throw an exception when the column name is an empty
   * string.
   **/
  public void Var009() {
    if (checkJdbc40()) {
  ...
  /**
   * updateNClob() - Should throw an exception when the column name is invalid.
   **/
  public void Var010() {
    if (checkJdbc40()) {
  ...
  /**
   * updateNClob() - Should update to SQL NULL when the column value is null.
   **/
  public void Var012() {
    if (checkJdbc40()) {
  ...
  /**
   * updateNClob() - Should be reflected by get, even if update has not yet been
  ...
  /**
   * updateNClob() - Should be reflected by get, after update has been issued, but
   * cursor has not been repositioned.
   **/
  public void Var015() {
    if (checkJdbc40()) {
  ...
  /**
   * updateNClob() - Should be reflected by get, after update has been issued and
  ...
  /**
   * updateNClob() - Should work when the current row is the insert row.
   **/
  public void Var017() {
    if (checkJdbc40()) {
  ...
  /**
   * updateNClob() - Should be reflected by get on insert row, even if insert has
  ...
  public void Var019() {
    if (checkJdbc40()) {
      ...
      try {
        ...
        JDRSTest.position(rs_, "DUMMY_UPDNCLOB");
        rs_.deleteRow();
        Object nClob = JDReflectionUtil.callMethod_O(connection_, "createNClob");
  ...
  /**
   * updateNClob() - Update a VARCHAR, with the length equal to the full stream.
   **/
  public void Var043() {
    if (checkJdbc40()) {
  ...
  /**
   * updateNClob() - Update a VARCHAR, with the length less than the full stream.
   * 
  ...
  /**
   * updateNClob() - Update a VARCHAR, with the length greater than the full
   * stream.
   **/
  public void Var045() {
    notApplicable();
  ...
  public void Var049() {
    if (checkJdbc40()) {
      ...
      try {
        ...
        JDReflectionUtil.callMethod_V(rs_, "updateNClob", "C_VARCHAR_50", nClob);// , "The greater Washington, D.C.
  ...
  public void Var058() {
    if (checkJdbc40()) {
      ...
      try {
        ...
        if (isToolboxDriver()) {
          assertCondition(e.getMessage().indexOf("Data type mismatch.") >= 0,
              "got error " + e.getMessage() + " should have Data type mismatch");
          return;
        }
        failed(e, "Unexpected Exception");
      } 
  ...
  public void Var064() {
    if (checkJdbc40()) {
      if (checkLobSupport()) {
         ...
         * "updateNClob", "C_DATALINK", JDRelectionUtil.callMethod_OS(connection_,
         * "createNClob", "Providence")); failed ("Didn't throw SQLException"); } catch
  ...
  /**
   * updateNClob() - Update a BLOB. Native will fail because they do not support
   * -- see Var057
   **/
  public void Var069() {
    if (checkJdbc40()) {
    ...
    if (checkJdbc40())
      if (checkDecFloatSupport()) {
        ...
        try {
          ...
          ResultSet rs2 = statement2_.executeQuery("SELECT * FROM " + JDRSTest.RSTEST_UPDDFP16);
          rs2.next();
          ...
          if (isToolboxDriver()) {
            assertCondition(e.getMessage().indexOf("Data type mismatch") != -1,
                "Expected Data type mismatch received " + e.getMessage());
            return;
          }
          failed(e, "Unexpected Exception");
        } 
    ...
    if (checkJdbc40())
      if (checkDecFloatSupport()) {
        ...
        try {
          ...
          ResultSet rs2 = statement2_.executeQuery("SELECT * FROM " + JDRSTest.RSTEST_UPDDFP34);
          rs2.next();
          String v = rs2.getString(1);
          rs2.close();
          rs.close();
