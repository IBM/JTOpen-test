...
//
// Filename:  JDRSStressScroll.java
//
...
**/
public class JDRSStressScroll
extends JDRSStress
{
  public static void main(String args[]) throws Exception {
    String[] newArgs = new String[args.length+2];
     newArgs[0] = "-tc";
     newArgs[1] = "JDRSStressScroll";
...
Constructor.
**/
    public JDRSStressScroll (AS400 systemObject,
                                    ...
                                    String password)
    {
        super (systemObject, "JDRSStressScroll",
