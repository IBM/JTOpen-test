...
/**
 * Testcase JDRSUpdateNCharacterStream. This tests the following method of the
 ...
 * </ul>
 **/
public class JDRSUpdateNCharacterStream extends JDTestcase {
   ...
   * Constructor.
   **/
  public JDRSUpdateNCharacterStream(AS400 systemObject, Hashtable<String, Vector<String>> namesAndVars, int runMode,
      FileOutputStream fileOutputStream,

      String password) {
    super(systemObject, "JDRSUpdateNCharacterStream", namesAndVars, runMode, fileOutputStream, password);
  }
  ...
  protected void setup() throws Exception {
    ...
    if (isJdbc40()) {
      ...
      statement_.executeUpdate("INSERT INTO " + JDRSTest.RSTEST_UPDATE + " (C_KEY) VALUES ('DUMMY_UPDNCS')");
  ...
  /**
   * updateNCharacterStream() - Should throw exception when the result set is not
   * updatable.
   **/
  public void Var002() {
    if (checkJdbc40()) {
  ...
  /**
   * updateNCharacterStream() - Should throw an exception when the column is an
   * invalid index.
   **/
  public void Var004() {
    if (checkJdbc40()) {
  ...
  /**
   * updateNCharacterStream() - Should throw an exception when the column is 0.
   **/
  public void Var005() {
    if (checkJdbc40()) {
      try {
  ...
  /**
   * updateNCharacterStream() - Should throw an exception when the column is -1.
   **/
  public void Var006() {
    if (checkJdbc40()) {
      try {
  ...
  /**
   * updateNCharacterStream() - Should throw an exception when the column name is
   * null.
   **/
  public void Var008() {
    if (checkJdbc40()) {
  ...
  public void Var010() {
    if (checkJdbc40()) {
      try {
        JDRSTest.position(rs_, key_);
        JDReflectionUtil.callMethod_V(rs_, "updateNCharacterStream", "INVALID", new StringReader("Colorado Springs"),
            16L);
        failed("Didn't throw SQLException");
      } catch (Exception e) {
        assertExceptionIsInstanceOf(e, "java.sql.SQLException");
  ...
  /**
   * updateNCharacterStream() - Should update to SQL NULL when the column value is
   * null.
   **/
  public void Var012() {
    if (checkJdbc40()) {
  ...
  /**
   * updateNCharacterStream() - Should throw an exception when the length is
   * invalid.
   **/
  public void Var013() {
    if (checkJdbc40()) {
  ...
  /**
   * updateNCharacterStream() - Should be reflected by get, even if update has not
   * yet been issued (i.e. update is still pending).
   **/
  public void Var014() {
    if (checkJdbc40()) {
      try {
  ...
  /**
   * updateNCharacterStream() - Should be reflected by get, after update has been
  ...
  public void Var019() {
    if (checkJdbc40()) {
      try {
        JDRSTest.position(rs_, "DUMMY_UPDNCS");
        rs_.deleteRow();
  ...
  /**
   * updateNCharacterStream() - Update a SMALLINT, when the string is not a
   * number.
   **/
  public void Var022() {
    if (checkJdbc40()) {
  ...
  public void Var024() {
    if (checkJdbc40()) {
      try {
        JDRSTest.position(rs_, key_);
        JDReflectionUtil.callMethod_V(rs_, "updateNCharacterStream", "C_INTEGER", new StringReader("435353487623"),
            12L);
        failed("Didn't throw SQLException");
      } catch (Exception e) {
        assertExceptionIsInstanceOf(e, "java.sql.SQLException");
  ...
  /**
   * updateNCharacterStream() - Update an INTEGER, when the string is not a
   * number.
   **/
  public void Var025() {
    if (checkJdbc40()) {
  ...
  public void Var027() {
    if (checkJdbc40()) {
      try {
        JDRSTest.position(rs_, key_);
        JDReflectionUtil.callMethod_V(rs_, "updateNCharacterStream", "C_REAL", new StringReader("453433335.4437623"),
            17L);
        rs_.updateRow();
  ...
  public void Var030() {
    if (checkJdbc40()) {
      try {
        JDRSTest.position(rs_, key_);
        JDReflectionUtil.callMethod_V(rs_, "updateNCharacterStream", "C_FLOAT",
            new StringReader("453435.4434556337633"), 20L);
        rs_.updateRow();
  ...
  public void Var033() {
    if (checkJdbc40()) {
      try {
        JDRSTest.position(rs_, key_);
        JDReflectionUtil.callMethod_V(rs_, "updateNCharacterStream", "C_DOUBLE",
            new StringReader("453342035.44445532333"), 21L);
        rs_.updateRow();
  ...
  public void Var036() {
    if (checkJdbc40()) {
      ...
      try {
        ...
        JDReflectionUtil.callMethod_V(rs_, "updateNCharacterStream", "C_DECIMAL_40", new StringReader("5333644511"),
            10L);
        rs_.updateRow();
        failed("Didn't throw SQLException");
      } catch (Exception e) {
        if (e instanceof DataTruncation) {
          ...
          assertCondition((dt.getIndex() == expectedColumn) && (dt.getParameter() == false) && (dt.getRead() == false)
              && (dt.getDataSize() == 10) && (dt.getTransferSize() == 4));
        } else {
  ...
  public void Var037() {
    if (checkJdbc40()) {
      try {
        JDRSTest.position(rs_, key_);
        JDReflectionUtil.callMethod_V(rs_, "updateNCharacterStream", "C_DECIMAL_105", new StringReader("Terre Haute"),
            11L);
        failed("Didn't throw SQLException");
      } catch (Exception e) {
        assertExceptionIsInstanceOf(e, "java.sql.SQLException");
  ...
  public void Var038() {
    if (checkJdbc40()) {
      try {
        JDRSTest.position(rs_, key_);
        JDReflectionUtil.callMethod_V(rs_, "updateNCharacterStream", "C_NUMERIC_105", new StringReader("-9333.455"),
            9L);
        rs_.updateRow();
        ResultSet rs2 = statement2_.executeQuery(select_);
        JDRSTest.position(rs2, key_);
    ...
    if (checkJdbc40()) {
      ...
      try {
        ...
        if (e instanceof DataTruncation) {
          DataTruncation dt = (DataTruncation) e;
          assertCondition((dt.getIndex() == expectedColumn) && (dt.getParameter() == false) && (dt.getRead() == false)
              && (dt.getDataSize() == 7) && (dt.getTransferSize() == 4));
        } else {
          assertSqlException(e, -99999, "07006", "Data type mismatch",
              "Mismatch instead of truncation in latest toolbox");
        }
  ...
  public void Var043() {
    if (checkJdbc40()) {
      try {
        JDRSTest.position(rs_, key_);
        JDReflectionUtil.callMethod_V(rs_, "updateNCharacterStream", "C_VARCHAR_50", new StringReader("Rehoboth Beach"),
            14L);
        rs_.updateRow();
        ResultSet rs2 = statement2_.executeQuery(select_);
        JDRSTest.position(rs2, key_);
  ...
  public void Var049() {
    if (checkJdbc40()) {
      ...
      try {
        ...
        JDReflectionUtil.callMethod_V(rs_, "updateNCharacterStream", "C_VARCHAR_50",
            new StringReader("The greater Washington, D.C. Metropolitan Area and surrounding communities"), 74L);
        rs_.updateRow();
        failed("Didn't throw SQLException");
      } catch (Exception e) {
        if (e instanceof DataTruncation) {
          ...
          assertCondition(
              (dt.getIndex() == expectedColumn) && (dt.getParameter() == false) && (dt.getRead() == false)
                  && (dt.getDataSize() == 74) && (dt.getTransferSize() == 50),
              "dt.getIndex()=" + dt.getIndex() + " sb " + expectedColumn + "\n" + "dt.getParameter()="
                  + dt.getParameter() + " sb false\n" + "dt.getRead()=" + dt.getRead() + " sb false\n"
  ...
  /**
   * updateNCharacterStream() - Update a DATE, when the string is not a valid
   * date.
   **/
  public void Var059() {
    if (checkJdbc40()) {
  ...
  /**
   * updateNCharacterStream() - Update a TIME, when the string is not a valid
   * time.
   **/
  public void Var061() {
    if (checkJdbc40()) {
  ...
  public void Var062() {
    if (checkJdbc40()) {
      try {
        JDRSTest.position(rs_, key_);
        JDReflectionUtil.callMethod_V(rs_, "updateNCharacterStream", "C_TIMESTAMP",
            new StringReader("1969-11-18 15:22:23.4329"), 24L);
        rs_.updateRow();
        ResultSet rs2 = statement2_.executeQuery(select_);
        JDRSTest.position(rs2, key_);
  ...
  /**
   * updateNCharacterStream() - Update a TIMESTAMP, when the string is not a valid
   * timestamp.
   **/
  public void Var063() {
    if (checkJdbc40()) {
  ...
  public void Var064() {
    if (checkJdbc40()) {
      if (checkLobSupport()) {
        ...
        /*
         * try { JDRSTest.position (rs_, key_); JDReflectionUtil.callMethod_V(rs_,
         * "updateNCharacterStream", "C_DATALINK", new StringReader ("Providence"),9L);
         * failed ("Didn't throw SQLException"); } catch (Exception e) {
         * assertExceptionIsInstanceOf (e, "java.sql.SQLException"); }
         */
      }
    }
  ...
  public void Var067() {
    if (checkJdbc40()) {
      if (checkBigintSupport()) {
        try {
          JDRSTest.position(rs_, key_);
          JDReflectionUtil.callMethod_V(rs_, "updateNCharacterStream", "C_BIGINT",
              new StringReader("4353534432176864587623"), 22L);
          failed("Didn't throw SQLException");
        } catch (Exception e) {
          assertExceptionIsInstanceOf(e, "java.sql.SQLException");
        }
  ...
  /**
   * updateNCharacterStream() - Update a BIGINTEGER, when the string is not a
   * number.
   **/
  public void Var068() {
    if (checkJdbc40()) {
      if (checkBigintSupport()) {
        try {
          JDRSTest.position(rs_, key_);
          JDReflectionUtil.callMethod_V(rs_, "updateNCharacterStream", "C_BIGINT", new StringReader("Baton Rouge"),
              11L);
          failed("Didn't throw SQLException");
        } catch (Exception e) {
          assertExceptionIsInstanceOf(e, "java.sql.SQLException");
  ...
  /**
   * updateNCharacterStream() - Update a BLOB. Native will fail because they do
   * not support -- see Var057
   **/
  public void Var069() {
    if (checkJdbc40()) {
      if (checkLobSupport()) {
    ...
    if (checkJdbc40())
      if (checkDecFloatSupport()) {
        try {
          ...
          rs.next();
          JDReflectionUtil.callMethod_V(rs, "updateNCharacterStream", 1, new StringReader("Hannover"), 8L);
          rs.close(); 
          s.close(); 
          failed("Didn't throw SQLException ");
        } catch (Exception e) {
