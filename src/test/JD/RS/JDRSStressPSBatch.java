...
//
// Filename:  JDRSStressPSBatch.java
//
...
**/
public class JDRSStressPSBatch
extends JDRSStress
{
  public static void main(String args[]) throws Exception {
    String[] newArgs = new String[args.length+2];
     newArgs[0] = "-tc";
     newArgs[1] = "JDRSStressPSBatch";
...
Constructor.
**/
    public JDRSStressPSBatch (AS400 systemObject,
                                    ...
                                    String password)
    {
        super (systemObject, "JDRSStressPSBatch",
