...
//
// Filename:  JDRSStressScrollPSDirectMap.java
//
...
**/
public class JDRSStressScrollPSDirectMap
extends JDRSStress
{
  public static void main(String args[]) throws Exception {
    String[] newArgs = new String[args.length+2];
     newArgs[0] = "-tc";
     newArgs[1] = "JDRSStressScrollPSDirectMap";
...
Constructor.
**/
    public JDRSStressScrollPSDirectMap (AS400 systemObject,
                                    ...
                                    String password)
    {
        super (systemObject, "JDRSStressScrollPSDirectMap",
