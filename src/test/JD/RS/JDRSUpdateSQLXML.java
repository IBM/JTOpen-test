...
/**
Testcase JDRSUpdateSQLXML.  This tests the following method
  ...
  public static void main(String args[]) throws Exception {
    ...
    **/
    public JDRSUpdateSQLXML (AS400 systemObject,
                                      ...
                                      String password)
    {
        super (systemObject, "JDRSUpdateSQLXML",
    ...
    **/
	...
	nodecl = (isToolboxDriver()) || (getRelease() >= JDTestDriver.RELEASE_V7R1M0);
        ...
        if(isJdbc40 ())
        {
            ...
            statementOther_ = connection_.createStatement (ResultSet.TYPE_SCROLL_SENSITIVE,
                                                      ResultSet.CONCUR_UPDATABLE);
            statement2Other_ = connection_.createStatement (ResultSet.TYPE_SCROLL_INSENSITIVE,
                                                       ResultSet.CONCUR_READ_ONLY);

            statementOther_.executeUpdate ("INSERT INTO " + JDRSTest.RSTEST_UPDATE
            ...
            statementXML_ = connection_.createStatement (ResultSet.TYPE_SCROLL_SENSITIVE,
                                                      ResultSet.CONCUR_UPDATABLE);
    ...
    **/
    ...
    /**
    updateSQLXML() - Should throw exception when the result set is
    closed.
    **/
    public void Var001()
    {   
    ...
    **/
    ...
    /**
    updateSQLXML() - Should throw exception when cursor is not pointing
    to a row.
    **/
    public void Var003()
    {
    ...
    /**
    updateSQLXML() - Should throw an exception when the column
    is an invalid index.
    **/
    public void Var004()
    {
    ...
    **/
    ...
    /**
    updateSQLXML() - Should update to SQL NULL when the column
    value is null.
    **/
    public void Var012()
    {
    ...
    **/
    ...
    /**
    updateSQLXML() - Should be reflected by get, even if update has
    ...
    **/
    ...
    /**
    updateSQLXML() - Should be reflected by get, after update has
    ...
    **/
    ...
    /**
    updateSQLXML() - Should work when the current row is the insert
    row.
    **/
    public void Var017()
    {
		...
		while (rsXML_.next() && rsXML_.getInt(1) != 170) {
                ...
                assertCondition (rsXML_.getString ("C_CLOB0037").equals (expected),"v="+rsXML_.getString ("C_CLOB0037")+" sb="+expected);
            }
            catch(Exception e)
            {
                failed (e, "Unexpected Exception");
    ...
    /**
    updateSQLXML() - Should be reflected by get on insert row, even if
    ...
    **/
    ...
    /**
    updateSQLXML() - Update a VARCHAR, with the length equal to the
    full stream.
    **/
    public void Var043 ()
    {
    ...
    /**
    updateSQLXML() - Update a VARCHAR, with the length less than the
    full stream.
    ...
    **/
    ...
    /**
    updateSQLXML() - Update a VARCHAR, with the length greater than the
    full stream.
    **/
    public void Var045 ()
    {
    ...
    **/
    ...
    /**
    updateSQLXML() - Update a TIMESTAMP, when the string is not a valid timestamp.
    **/
    public void Var063 ()
    {
        if(checkJdbc40 ())
