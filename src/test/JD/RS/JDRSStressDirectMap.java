...
//
// Filename:  JDRSStressDirectMap.java
//
...
**/
public class JDRSStressDirectMap
extends JDRSStress
{
  public static void main(String args[]) throws Exception {
    String[] newArgs = new String[args.length+2];
     newArgs[0] = "-tc";
     newArgs[1] = "JDRSStressDirectMap";
...
Constructor.
**/
    public JDRSStressDirectMap (AS400 systemObject,
                                    ...
                                    String password)
    {
        super (systemObject, "JDRSStressDirectMap",
