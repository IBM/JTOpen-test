...
//    		System.out.println("SQL: " + "DELETE FROM "+table_name);
    		...
    		//st.executeUpdate("DELETE FROM "+table_name+" WHERE "+column_name+"='ABC ���'");
    		st.close();    		
    	}
    ...
    public void DisplayVisualResult(){
    	...
    	try
    	{
    		...
    		//ResultSet resultSet = st.executeQuery("SELECT * FROM "+table_name+" WHERE "+column_name+"='ABC ���'"); 
    ...
    public void CallableInsert(Connection db2Conn, int param){//test Insert & Update    	
    	try
    	{
    		...
    		st.setInt(1, 1); 
    		st.setInt(2, 4); 
    		st.setString(3, mixed_string);//"ABC ���"); 
    		st.executeUpdate();
    ...
    public void Insert(Connection db2Conn, int param){//test Insert & Update    	
    	try
    	{
    		...
    		//st.executeUpdate("insert into "+table_name+" values(1, 1, 'ABC ���')");
    		st.executeUpdate("insert into "+table_name+" values(1, 1, '" + mixed_string + "')");
    		st.executeUpdate("insert into "+table_name+" values(1, 2, 'xxx')");
    		//st.executeUpdate("UPDATE "+table_name+"  SET "+column_name+"='ABC ���' WHERE I2=2");    		    		
