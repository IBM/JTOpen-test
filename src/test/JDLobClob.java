...
/**
Testcase JDLobClob.  This tests the following method
...
extends JDTestcase
{
    ...
    **/
    ...
    Constructor.
    **/
    public JDLobClob (AS400 systemObject,
                      Hashtable namesAndVars,
                      int runMode,
                      FileOutputStream fileOutputStream,
                      String password)
    {
        super (systemObject, "JDLobClob",
...
if(getDriver() == JDTestDriver.DRIVER_NATIVE &&					// @K9
    ...
    **/
    ...
    /**
    getSubString() - Should throw an exception when start is less
    than 0.
    **/
    public void Var007()
    {
    ...
    **/
    ...
    /**
    getSubString() - Should throw an exception when start is greater
    than the length of the lob.

    @K6: Native driver extracts with padding for specified length exceeding actual length but within limits of maxLength
    **/
    public void Var009()
    {
        if (checkJdbc20 ()) {
		...
		failed (connection_, e, "Unexpected Exception -- Updated 10/02/2013  should not throw expection for requesting at length+1");
            }
        }
    }
    ...
    /**
    getSubString() - Should throw an exception when length is less
    than 0.
    **/
    public void Var010()
    {
    ...
    /**
    getSubString() - Should throw an exception when length extends
    ...
    **/
    public void Var011()
    {
		...
		succeeded();					// @K6
                ...
                failed (connection_, e, "Unexpected Exception -- Updated 10/02/2013  should not throw exception for requesting too much");
            }
        }
    }
...
//                assertExceptionIsInstanceOf (e, "java.sql.SQLException");       // @B1C
    ...
    **/
    ...
    /**
    position(String,long) - Should throw an exception when start is 
    ...
    **/
    ...
    /**
    position(String,long) - Should return -1 when the pattern is not found at all.
    **/
    public void Var025()
    {
        if (checkJdbc20 ()) {
    ...
    **/
    ...
    /**
    position(String,long) - Should return 0 when the pattern is found at
    the beginning of the lob.
    **/
    public void Var027()
    {
	if (v5r2nativeFunctions_) {
	    notApplicable("Known position problems in V5R2"); 
	} else { 
    ...
    **/
    ...
    /**
    position(Clob,long) - Should throw an exception when start is 
    greater than the length of the lob.
    **/
    public void Var039()
    {
    ...
    **/
    ...
    /**
    position(Clob,long) - Should return 0 when the pattern is found at
    the beginning of the lob.
    **/
    public void Var042()
    {
    ...
    /**
    position(Clob,long) - Should return the position when the pattern is 
    found in the middle of the lob, and start is 1.
    **/
    public void Var043()
    {
    ...
    **/
    ...
    /**
    position(Clob,long) - Should return 0 when the pattern is the empty
    lob and start is 1.
    **/
    public void Var048()
    {
    ...
    /**
    position(Clob,long) - Should return start when the pattern is the empty
    ...
    **/
    ...
    /**
    setString(long, String) - Should throw an exception when start is less
    than 0.
    **/
    public void Var051()                                                                
    {                                                                                   
...
//                }
    ...
    /**
    setString(long, String) - Changed to not expect an exception when length of string
    to insert is greater than length of lob.
    **/
    public void Var054()                                                                
    {                                                                                   
        if (checkUpdateableLobsSupport ()) {                                            
		...
		String output = clob1.getSubString(1, expected.length()); 
                assertCondition (output.equals(expected) && written == expected.length(),
				 "output("+output+") != expected("+expected+") or written("+written+") != expected.length("+expected.length()+")");                                     
                rs2_.close();                                    
            }
            catch (Exception e) {                                                                                                                                                                              
                failed (e, "Unexpected Exception");                                 
...
//                }
    ...
    **/
    ...
    {                                                                                   
        if (checkUpdateableLobsSupport ()) {                                            
            try {                                                                       
                ...
                rs2_.absolute(4);
                Clob clob1 = rs2_.getClob("C_VARCHAR");                                 
                assertCondition (clob1.getSubString(1, MEDIUM_.length()).equals("Really huge objects.")
                                 && written == 20);                                     
                rs2_.close();                                                           
            }
            catch (Exception e) {                                                       
    ...
    /**
    setString(long, String) - Should work to set the first part of a non-empty lob.
    **/
    public void Var057()                                                                
    {                                                                                   
        if (checkUpdateableLobsSupport ()) {                                            
            try {                                                                       
                ...
                rs2_.absolute(4);
                Clob clob1 = rs2_.getClob("C_VARCHAR");                                 
                assertCondition (clob1.getSubString(1, 12).equals("Really small")       
                                 && written == 12);                                     
                rs2_.close();                                                           
            }
            catch (Exception e) {                                                       
    ...
    {                                                                                   
        if (checkUpdateableLobsSupport ()) {                                            
            try {                                                                       
                ...
                rs2_.absolute(4);
                Clob clob1 = rs2_.getClob("C_VARCHAR");                                 
                assertCondition (clob1.getSubString(5, 4).equals("cool")                
                                 && written == 4 );                                     
                rs2_.close();                                                           
            }
            catch (Exception e) {                                                       
    ...
    **/
    ...
    {                                                                                   
        if (checkUpdateableLobsSupport ()) {                                            
            try {                                                                       
                ...
                rs2_.absolute(4);
                Clob clob1 = rs2_.getClob ("C_VARCHAR");                                
                assertCondition (clob1.getSubString(14, 7).equals("insect.")            
                                 && written == 7 );                                     
                rs2_.close();                                                           
            }
            catch (Exception e) {                                                       
    ...
    /**
    setString(long, String, int, int) - Should throw an exception when start is less
    than 0.
    **/
    public void Var060()                                                                
    {                                                                                   
    ...
    /**
    setString(long, String, int, int) - Should throw an exception when start is 0.
    **/
    public void Var061()                                                                
    {                                                                                   
        if (checkUpdateableLobsSupport ()) {                                            
    ...
    /**
    setString(long, String, int, int) - Should throw an exception when start is greater
    than the length of the lob.
    @CRS - This variation should succeed. Only when you try to write past the
    max column size will it be an exception.
    **/
...
//                }
    ...
    // @K2 removed +1 in assertCondition; because the parameter expected is length and not the lastIndex
    // @K2 commented parts of code so that exception is not expected
    //@C2C Changed to not expect exception
    /**
    setString(long, String, int, int) - Should not throw an exception when length of string
    to insert is greater than length of lob.
    **/
    public void Var063()                                                                
    {                                                                                   
        if (checkUpdateableLobsSupport ()) {                                            
            try {                                                                       
                ...
                rs2_.absolute(4);
                Clob clob1 = rs2_.getClob("C_VARCHAR");                                 
                assertCondition (clob1.getSubString(1, expected.length()/* +1*/).equals(expected)
                                 && written == expected.length());  // @K2
...
//               }
    ...
    /**
    setString(long, String, int, int) - Should throw an exception on an empty lob.
    @CRS - This variation should succeed. Only when you try to write past the
    max column size will it be an exception.
    **/
    public void Var064()                                                                
...
//                }
    ...
    **/
    ...
    {                                                                                   
        if (checkUpdateableLobsSupport ()) {                                            
            try {                                                                       
                ...
                rs2_.absolute(4);
                Clob clob1 = rs2_.getClob("C_VARCHAR");                                 
                assertCondition (clob1.getSubString(1, MEDIUM_.length()).equals("Really tiny objects.")
                                 && written == 20);                                     
                rs2_.close();                                                           
            }
            catch (Exception e) {                                                       
    ...
    /**
    setString(long, String, int, int) - Should work to set the first part of a non-empty lob.
    **/
    public void Var066()                                                                
    {                                                                                   
        if (checkUpdateableLobsSupport ()) {                                            
    ...
    /**
    setString(long, String, int, int) - Should work to set the middle part of a non-empty lob.
    **/
    public void Var067()                                                                
    {                                                                                   
        if (checkUpdateableLobsSupport ()) {                                            
    ...
    **/
	...
	{                                                                       
		...
		clob.truncate (25);
		if (v5r2nativeFunctions_) {
		    failed("Didn't throw SQLException -- V5R3 wont throw exception ");
		} else { 
		    rs2_.close();                                                   
		    succeeded();
		}
    ...
    **/
    ...
    /**
    setAsciiStream() - When the lob is not empty starting at a position other than 1.
    **/
    public void Var073()                                                        
    {                                                                           
        if (checkUpdateableLobsSupport ()) {                                    
...
//                }
    ...
    **/
    ...
    /**
    setCharacterStream() - When the lob is not empty starting at a position other than 1.
    **/
    public void Var078()                                                        
    {                                                                           
        if (checkUpdateableLobsSupport ()) {                                    
...
//                }
    ...
    **/
    ...
    /**
    setString(long, String, int, int) - Should throw an exception when string offset is less than 0.
    **/
    ...
    /**
    setString(long, String, int, int) - Should throw an exception when the string is null
    **/
    ...
    /**
    setString(long, String, int, int) - Should throw an exception when string offset is greater than string length.
    **/
...
//@K3
    /**
    setString(long, String, int, int) - test where offset is not 0
    setString(POS in Clob, STR in mind, OFFSET into str, LEN chars to be written)
    **/
    public void Var093()                                                                
    {                                                                                   
	if (v5r2nativeFunctions_) {
		...
		try {                                                                       
		    ...
		    assertCondition (str1.equalsIgnoreCase("ob") && str2.equalsIgnoreCase("xy") && written == 2, "str1 = "+str1+" str2 = "+str2+" written = "+written+" SB 2");
		    rs2_.close();                                                           
		}
		catch (Exception e) {                                                       
		    failed(e, "Unexpected Exception");               
 ...
 **/
    ...
    **/
    ...
    {                                                                           
		...
		w.write(c);
                ...
                Reader r = clob1.getCharacterStream();                          
                sb.setLength(0); 
                assertCondition(compare (r, "IT WORKS!",sb), clob1.getSubString(1, (int)clob1.length())+" SB \"IT WORKS!\" "+sb);
                rs2_.close();                                                     
            }
            catch (Exception e) {                                               
                failed (e, "Unexpected Exception");                             
    ...
    **/
    ...
    /**
    setCharacterStream() - When the lob is not empty starting at position 1.
    and trying to write an ARRAY OF CHARACTERS with an offset specified not as 0
    **/
    ...
    /**
    setCharacterStream() - When the lob is not empty starting at position 1.
    and trying to write an ARRAY OF CHARACTERS with an offset specified LESS than 0
    **/
    ...
    **/
	...
	if (v5r2nativeFunctions_) {
		...
		try { 
		    ...
		    Reader r = clob1.getCharacterStream();                          
	      sb.setLength(0); 
		    assertCondition(compare (r, "WRITER TEST!",sb), clob1.getSubString(1, (int)clob1.length())+" SB \"WRITER TEST!\"");
		    rs2_.close();                                                     
		}
		catch (Exception e) {                                               
		    failed (e, "Unexpected Exception");                             
    ...
    **/
	...
	if (v5r2nativeFunctions_) {
		...
		try { 
		    ...
		    Reader r = clob1.getCharacterStream();                          
	      sb.setLength(0); 
		    assertCondition(compare (r, "LOB WRITER TESTING",sb), clob1.getSubString(1, (int)clob1.length())+" SB \"LOB WRITER TESTING\"");
		    rs2_.close();                                                     
		}
		catch (Exception e) {                                               
		    failed (e, "Unexpected Exception");                             
    ...
    /**
    getSubString() - Should throw an exception when length exceeds maxLength_ of clob
        10/02/03 -- no longer throw exception if length is too long 
    **/
    public void Var103()                // @K4: added this var
    {
		...
		assertCondition(expected.equals(outString), "got '"+outString+"' sb '"+expected+"' -- updated 10/2/2103"); 
            }
            catch (Exception e) {
    ...
    /**
    setString(long, String) - prePadding required for data if it is past the length but less than the maximum possible length of the clob
    **/
	...
	if (v5r2nativeFunctions_) {
		...
		// Some cleaning for the testcase to work
		    ...
		    rs2_.absolute(4);
		    Clob clob1 = rs2_.getClob("C_VARCHAR");                                 
		    assertCondition (clob1.getSubString(3, (int)clob1.length()-2).equals("  msp")
				     && written == 3, "l1 = "+l1);                                     
		    rs2_.close();                                    
		}
		catch (Exception e) {                                                                                                                                                                              
...
//		    System.out.println("res is '"+extracted+"' sb 3 spaces");
    ...
    **/
    ...
    /**
    free() getAsciiStream() -- Make sure another method throws an exception after free
    **/
   public void Var109()
   {
        if (checkJdbc40 ()) {
   ...
   /**
   free() getCharacterStream() -- Make sure another method throws an exception after free
   **/
  public void Var110()
  {
        if (checkJdbc40 ()) {
  ...
  /**
  free() getSubString() -- Make sure another method throws an exception after free
  **/
 public void Var111()
 {
        if (checkJdbc40 ()) {
...
/**
free() setAsciiStream() -- Make sure another method throws an exception after free
**/
public void Var114()
{
       if (checkJdbc40 ()) {
...
/**
free() setCharacterStream() -- Make sure another method throws an exception after free
**/
public void Var115()
{
       if (checkJdbc40 ()) {
