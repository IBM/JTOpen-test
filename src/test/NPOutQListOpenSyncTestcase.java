...
public class NPOutQListOpenSyncTestcase extends Testcase
{
	...
	try
	{
            ...
            if (cmd.run("CRTOUTQ OUTQ(NPJAVA/LSTOSTST) AUTCHK(*DTAAUT)") == false)
                {
            ...
            if (cmd.run("GRTOBJAUT OBJ(NPJAVA/LSTOSTST) OBJTYPE(*OUTQ) USER(*PUBLIC)") == false)
                {
...
$$$ TO DO $$$ - delete this line */
            ...
            if (cmd.run("CLROUTQ OUTQ(NPJAVA/LSTOSTST)") == false)
                {
            ...
            if (cmd.run("DLTOUTQ OUTQ(NPJAVA/LSTOSTST)") == false)
                {
