...
public class SecVrmTestcase extends Testcase
{
  ...
  static String V7R3_SYSTEM_NAME = "SQ730.rch.stglabs.ibm.com";
  static String V7R4_SYSTEM_NAME = "SQ740.rch.stglabs.ibm.com";
  static String V7R5_SYSTEM_NAME = "SQ750.rch.stglabs.ibm.com";
  static String V7R6_SYSTEM_NAME = "SQ760.rch.stglabs.ibm.com";

  static {
      /* Read in the system names from ini/systems.ini */
    Properties systemsProperties = new Properties();
    try {
      String property; 
      ...
      property = systemsProperties.getProperty("V7R4_SYSTEM_NAME"); 
      if (property != null) { V7R4_SYSTEM_NAME = property; } else {System.out.println("Warning: V7R3_SYSTEM_NAME not found in ini/systems.ini"); } 

      property = systemsProperties.getProperty("V7R5_SYSTEM_NAME"); 
      if (property != null) { V7R5_SYSTEM_NAME = property; } else {System.out.println("Warning: V7R5_SYSTEM_NAME not found in ini/systems.ini"); } 
      property = systemsProperties.getProperty("V7R3_SYSTEM_NAME"); 
      if (property != null) { V7R3_SYSTEM_NAME = property; } else {System.out.println("Warning: V7R3_SYSTEM_NAME not found in ini/systems.ini"); } 
    ...
    System.out.println("SecVrmTestcase read system names from ini/systems.ini "+
		       V7R3_SYSTEM_NAME +","+
		       V7R4_SYSTEM_NAME +","+
		       V7R5_SYSTEM_NAME +","+
		       V7R6_SYSTEM_NAME 
    ...
    /**
     Signon to a V7R2 system and verify the version.
     **/
    public void Var009()
    {
        try
        {
	    System.out.println("  Var009: connecting to "+V7R6_SYSTEM_NAME); 
   char[] charPassword = PasswordVault.decryptPassword(encryptedPassword_);
            AS400 system = new AS400(V7R6_SYSTEM_NAME, userId_, charPassword);
   PasswordVault.clearPassword(charPassword);
            system.setMustUseSockets(mustUseSockets_);
            system.connectService(AS400.FILE);
            try
            {
                assertCondition(system.getVersion() == 7, "Incorrect version - test runs to " + V7R6_SYSTEM_NAME);
            }
            finally
            {
        ...
        {
            failed(e, "Unexpected exception - test runs to " + V7R6_SYSTEM_NAME);
        }
    }
   ...
   PasswordVault.clearPassword(charPassword);
		...
		int release = system.getRelease(); 
                assertCondition(release  == 6, "Incorrect release ="+release+" - test runs to " + V7R6_SYSTEM_NAME);
            }
            finally
            {
