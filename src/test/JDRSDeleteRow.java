...
**/
    public void Var006()
    {
        if(isToolboxDriver() && getRelease()<= JDTestDriver.RELEASE_V5R3M0)
        {
            //in v5r3, var 5 interfers with var6 since the delete()->direct() will collapse the remaining rows in the cursor.
            //in v5r4+ in TB and Native this does not happen.
            notApplicable("V5R3 hostserver TB diff");
            return;
        }
        if (checkJdbc20 ()) {
            try {
