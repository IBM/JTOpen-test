...
//
// Filename:  NLSGetDoubleByteTableRequest.java
//
...
// ----------------------------------------------------
public class NLSGetDoubleByteTableRequest extends NLSGetTableRequest
{
    ...
    public NLSGetDoubleByteTableRequest(int fromCcsid)
    {
      super();
