...
public class CleanupPsrwJobs {
  ...
  public static void clean(String system, String userid, String password, PrintWriter out)
      throws PropertyVetoException, AS400SecurityException, ErrorCompletingRequestException, InterruptedException,
