...
//  $A1              V5R2M0  10/08/02 bpwallen changed to expect the right exception for NTS
//                   v5r4m0t 01/18/06 pauldev  Move isNTS to JTATestcase and misc toolbox fixes
//                   v5r4m0t 01/25/06 pauldev  RC > 0 try{}
//                   v5r4m01 02/28/06 pauldev  toolbox specific updates
//  $B1              v6r1m0t 07/31/06 coover   Updated var 11,12 so the end properly
////////////////////////////////////////////////////////////////////////
package test;
  ...
  public void Var003() {
    ...
    if (checkJdbc20StdExt()) {
      try {
        ...
        TestXid Xid1 = new TestXid();
        TestXid Xid2 = new TestXid();
