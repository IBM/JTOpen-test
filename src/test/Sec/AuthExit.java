...
public class AuthExit  {
  ...
  /* 
   * Creates and registers the AUTHEXIT program, if it has not yet been done. 
   * The caller is responsible for determining that the connected system supports 
   * the AUTHEXIT.
   * Registers the userid to use MFA and the exit program.  
   */
