...
//
// Filename:  SecEventTestcase.java
//
...
/**
 Testcase SecEventTestcase.
 **/
public class SecEventTestcase extends Testcase implements ConnectionListener
{
  public static void main(String args[]) throws Exception {
    String[] newArgs = new String[args.length+2];
     newArgs[0] = "-tc";
     newArgs[1] = "SecEventTestcase";
    ...
    String verifyConnect(AS400 sys, int serv)
    {
        String failMsg = "";
        if (connectSrc == null)
        {
    ...
    String verifyDisconnect(AS400 sys, int serv)
    {
        String failMsg = "";
        if (disconnectSrc == null)
        {
