 ...
 **/
public class JDDMDTest extends JDTestDriver {
...
// Constants.
   ...
   * @exception Exception If an exception occurs.
   **/
  public JDDMDTest() throws Exception {
    super();
  }
   ...
   * @exception Exception If an exception occurs.
   **/
  public JDDMDTest(String[] args) throws Exception {
    super(args);
  }
  ...
  public void setup() throws Exception {
    ...
    connection_ = getConnection(getBaseURL(), systemObject_.getUserId(), encryptedPassword_);
    ...
    JDSetupCollection.create(systemObject_, connection_, COLLECTION2, out_);
    JDSetupCollection.create(systemObject_, connection_, COLLECTIONXX, out_);
    JDSetupCollection.create(systemObject_, connection_, SCHEMAS_LEN128, out_);
   ...
   **/
  public static boolean checkColumnNames(ResultSetMetaData rsmd, String[] expectedNames, StringBuffer message)
      throws SQLException {
    boolean rc = true;
   ...
   * @exception SQLException If an exception occurs.
   **/
  public static boolean checkColumnTypes(ResultSetMetaData rsmd, int[] expectedTypes, StringBuffer message)
      throws SQLException {
    boolean rc = true;
    int count = rsmd.getColumnCount();
   ...
   * @return
   */
  public static boolean check(String result, String expected, String messageColumnName, String info,
      StringBuffer message, boolean success) {
    boolean checkOk;
    if (result == null) {
  ...
  public static boolean check(int result, int expected, String messageColumnName, String info, StringBuffer message,
      boolean success) {
    boolean checkOk;
  ...
  public void createTestcases2() {
    ...
    addTestcase(new JDDMDAxx(systemObject_, namesAndVars_, runMode_, fileOutputStream_, password_));

    addTestcase(new JDDMDDxx(systemObject_, namesAndVars_, runMode_, fileOutputStream_, password_));

    addTestcase(new JDDMDGetBestRowIdentifier(systemObject_, namesAndVars_, runMode_, fileOutputStream_, password_));

    addTestcase(new JDDMDGetCatalogs(systemObject_, namesAndVars_, runMode_, fileOutputStream_, password_));

    addTestcase(new JDDMDGetColumnPrivileges(systemObject_, namesAndVars_, runMode_, fileOutputStream_, password_));

    addTestcase(new JDDMDGetColumns(systemObject_, namesAndVars_, runMode_, fileOutputStream_, password_));

    addTestcase(new JDDMDGetCrossReference(systemObject_, namesAndVars_, runMode_, fileOutputStream_, password_));

    addTestcase(new JDDMDGetExportedKeys(systemObject_, namesAndVars_, runMode_, fileOutputStream_, password_));

    addTestcase(new JDDMDGetFunctions(systemObject_, namesAndVars_, runMode_, fileOutputStream_, password_));

    addTestcase(new JDDMDGetFunctionColumns(systemObject_, namesAndVars_, runMode_, fileOutputStream_, password_));

    addTestcase(new JDDMDGetImportedKeys(systemObject_, namesAndVars_, runMode_, fileOutputStream_, password_));

    addTestcase(new JDDMDGetIndexInfo(systemObject_, namesAndVars_, runMode_, fileOutputStream_, password_));

    addTestcase(new JDDMDGetPrimaryKeys(systemObject_, namesAndVars_, runMode_, fileOutputStream_, password_));

    addTestcase(new JDDMDGetProcedureColumns(systemObject_, namesAndVars_, runMode_, fileOutputStream_, password_));

    addTestcase(new JDDMDGetProcedures(systemObject_, namesAndVars_, runMode_, fileOutputStream_, password_));

    addTestcase(new JDDMDGetSchemas(systemObject_, namesAndVars_, runMode_, fileOutputStream_, password_));

    addTestcase(new JDDMDGetTablePrivileges(systemObject_, namesAndVars_, runMode_, fileOutputStream_, password_));

    addTestcase(new JDDMDGetTablePrivileges3(systemObject_, namesAndVars_, runMode_, fileOutputStream_, password_));

    addTestcase(new JDDMDGetTables(systemObject_, namesAndVars_, runMode_, fileOutputStream_, password_));

    addTestcase(new JDDMDGetTableTypes(systemObject_, namesAndVars_, runMode_, fileOutputStream_, password_));

    addTestcase(new JDDMDGetTypeInfo(systemObject_, namesAndVars_, runMode_, fileOutputStream_, password_));

    addTestcase(new JDDMDGetUDTs(systemObject_, namesAndVars_, runMode_, fileOutputStream_, password_));

    addTestcase(new JDDMDGetVersionColumns(systemObject_, namesAndVars_, runMode_, fileOutputStream_, password_));
    addTestcase(new JDDMDGetPseudoColumns(systemObject_, namesAndVars_, runMode_, fileOutputStream_, password_));

    addTestcase(new JDDMDGetXxx(systemObject_, namesAndVars_, runMode_, fileOutputStream_, password_));

    addTestcase(new JDDMDIsXxx(systemObject_, namesAndVars_, runMode_, fileOutputStream_, password_));

    addTestcase(new JDDMDMisc(systemObject_, namesAndVars_, runMode_, fileOutputStream_, password_));

    addTestcase(new JDDMDNullXxx(systemObject_, namesAndVars_, runMode_, fileOutputStream_, password_));

    addTestcase(new JDDMDStoresXxx(systemObject_, namesAndVars_, runMode_, fileOutputStream_, password_));

    addTestcase(new JDDMDSupportsXxx(systemObject_, namesAndVars_, runMode_, fileOutputStream_, password_));

    addTestcase(new JDDMDUsesXxx(systemObject_, namesAndVars_, runMode_, fileOutputStream_, password_));

    addTestcase(new JDDMDXxxAreXxx(systemObject_, namesAndVars_, runMode_, fileOutputStream_, password_));
    addTestcase(new JDDMDWrapper(systemObject_, namesAndVars_, runMode_, fileOutputStream_, password_));
    addTestcase(new JDDMDPerformance(systemObject_, namesAndVars_, runMode_, fileOutputStream_, password_));

    addTestcase(new JDDMDCCSID65535(systemObject_, namesAndVars_, runMode_, fileOutputStream_, password_));
