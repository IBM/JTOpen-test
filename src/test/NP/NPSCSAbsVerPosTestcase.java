...
//
// Filename:  NPSCSAbsVerPosTestcase.java
//
...
/**
  Testcase NPSCSAbsVerPosTestcase.
  Test the absoluteVerticalPosition method of the SCS5219Writer class.
  **/
public class NPSCSAbsVerPosTestcase extends Testcase
{
  public static void main(String args[]) throws Exception {
    String[] newArgs = new String[args.length+2];
     newArgs[0] = "-tc";
     newArgs[1] = "NPSCSAbsVerPosTestcase";
...
/**
  ...
  **/
  public NPSCSAbsVerPosTestcase(AS400            systemObject,
                         ...
                         FileOutputStream fileOutputStream)
  {
    ...
    // in this testcase.
    super(systemObject, "NPSCSAbsVerPosTestcase", 3,
...
/**
  Tests the absoluteVerticalPosition method of the SCS5219Writer class 
  ...
  **/
  public void Var001()
  {
    ...
    try
    {
        ...
        writer.absoluteVerticalPosition(0);
        writer.absoluteVerticalPosition(255);
        writer.close();
        succeeded();
    }
    catch (Exception e)
...
/**
  Tests the absoluteVerticalPosition method of the SCS5219Writer 
  ...
  **/
  public void Var002()
  {
    ...
    {
        SCS5219Writer writer = new SCS5219Writer(out, systemObject_.getCcsid(), systemObject_);
        writer.absoluteVerticalPosition(-1);
        writer.close();
