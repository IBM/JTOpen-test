  ...
  public static void main(String args[]) throws Exception {
	...
	boolean allVariations = (variationsToRun_.size() == 0);
        ...
        try
            ...
            if (cmd.run("CRTOUTQ OUTQ(NPJAVA/USRDTST) AUTCHK(*DTAAUT)") == false)
                {
            ...
            if (cmd.run("GRTOBJAUT OBJ(NPJAVA/USRDTST) OBJTYPE(*OUTQ) USER(*PUBLIC)") == false)
                {
...
$$$ TO DO $$$ - delete this line */
            ...
            if (cmd.run("CLROUTQ OUTQ(NPJAVA/USRDTST)") == false)
                {
            ...
            if (cmd.run("DLTOUTQ OUTQ(NPJAVA/USRDTST)") == false)
                {
