...
//
// Filename:  NPSCSUnderlineTestcase.java
//
...
/**
  Testcase NPSCSUnderlineTestcase.
  Test the setUnderline method of the SCS5219Writer class.
  **/
public class NPSCSUnderlineTestcase extends Testcase
{
  public static void main(String args[]) throws Exception {
    String[] newArgs = new String[args.length+2];
     newArgs[0] = "-tc";
     newArgs[1] = "NPSCSUnderlineTestcase";
...
/**
  ...
  **/
  public NPSCSUnderlineTestcase(AS400            systemObject,
                         ...
                         FileOutputStream fileOutputStream)
  {
    ...
    // in this testcase.
    super(systemObject, "NPSCSUnderlineTestcase", 1,
...
/**
  Tests the setUnderline method of the SCS5219Writer class.
  **/
  public void Var001()
  {
    setVariation(1);
