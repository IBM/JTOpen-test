...
public class NPOutQListQueueFilterTestcase extends Testcase
{
  public static void main(String args[]) throws Exception {
	...
	try
            ...
            if (cmd.run("QSYS/CRTOUTQ OUTQ(NPJAVA/LISTQTST) AUTCHK(*DTAAUT)") == false)
                {
            ...
            if (cmd.run("QSYS/GRTOBJAUT OBJ(NPJAVA/LISTQTST) OBJTYPE(*OUTQ) USER(*PUBLIC)") == false)
                {
...
$$$ TO DO $$$ - delete this line */
            ...
            if (cmd.run("QSYS/CLROUTQ OUTQ(NPJAVA/LISTQTST)") == false)
                {
            ...
            if (cmd.run("QSYS/DLTOUTQ OUTQ(NPJAVA/LISTQTST)") == false)
                {
