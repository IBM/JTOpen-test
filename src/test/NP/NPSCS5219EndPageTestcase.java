...
//
// Filename:  NPSCS5219EndPageTestcase.java
//
...
/**
  Testcase NPSCS5219EndPageTestcase.
  Test the endPage method of the SCS5219Writer class.
  **/
public class NPSCS5219EndPageTestcase extends Testcase
{
  public static void main(String args[]) throws Exception {
    String[] newArgs = new String[args.length+2];
     newArgs[0] = "-tc";
     newArgs[1] = "NPSCS5219EndPageTestcase";
...
/**
  ...
  **/
  public NPSCS5219EndPageTestcase(AS400            systemObject,
                         ...
                         FileOutputStream fileOutputStream)
  {
    ...
    // in this testcase.
    super(systemObject, "NPSCS5219EndPageTestcase", 1,
...
/**
  Tests the endPage method of the SCS5219Writer class.
  **/
  public void Var001()
  {
    setVariation(1);
