...
//
// Filename:  NPOutQListSystemTestcase.java
//
...
/**
 Testcase NPOutQListSystemTestcase.
 **/
public class NPOutQListSystemTestcase extends Testcase
{
  public static void main(String args[]) throws Exception {
    String[] newArgs = new String[args.length+2];
     newArgs[0] = "-tc";
     newArgs[1] = "NPOutQListSystemTestcase";
     ...
     **/
    public NPOutQListSystemTestcase(AS400            systemObject,
	...
	// in this testcase.
        super(systemObject, "NPOutQListSystemTestcase", 8,
    ...
    public void run()
    {
        output_.println("NPPrintTest::NPOutQListSystemTestcase");
...
$$$ TO DO $$$ - delete this line */
    ...
    /**
     * Tests setting the OutputQueueList's system name to null.
     **/
    public void Var001()
    {
        try
    ...
    /**
     * Tests retrieving the OutputQueueList's system name before it is set.
     **/
    public void Var002()
    {
        try
    ...
    /**
     * Tests retrieving the Output Queue List system name.
     **/
    public void Var003()
    {
        try
     ...
     * OutputQueueList's system is set.
     **/
     ...
     * OutputQueueList's system property change is vetoed.
     **/
    public void Var006()
    {
        // Define inner class to listen for property change events
...
} // end NPOutQListSystemTestcase class
