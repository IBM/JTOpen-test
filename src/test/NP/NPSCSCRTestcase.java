...
/**
  Testcase NPSCSCRTestcase.
  Test the carriageReturn method of the SCS5256Writer class.
  **/
public class NPSCSCRTestcase extends Testcase
{
  public static void main(String args[]) throws Exception {
    String[] newArgs = new String[args.length+2];
     newArgs[0] = "-tc";
     newArgs[1] = "NPSCSCRTestcase";
...
/**
  ...
  **/
  public NPSCSCRTestcase(AS400            systemObject,
                       ...
                       FileOutputStream fileOutputStream)
  {
    ...
    // in this testcase.
    super(systemObject, "NPSCSCRTestcase", 1,
...
/**
  Tests the carriageReturn method of the SCS5256Writer class.
  **/
  public void Var001()
  {
    setVariation(1);
