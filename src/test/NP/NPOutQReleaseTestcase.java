...
public class NPOutQReleaseTestcase extends Testcase
{
  public static void main(String args[]) throws Exception {
    String[] newArgs = new String[args.length+2];
     newArgs[0] = "-tc";
     newArgs[1] = "NPOutQReleaseTestcase";
	...
	try
	{
            ...
            if (cmd.run("QSYS/CRTOUTQ OUTQ(NPJAVA/RLSTST) AUTCHK(*DTAAUT)") == false)
                {
            ...
            if (cmd.run("QSYS/GRTOBJAUT OBJ(NPJAVA/RLSTST) OBJTYPE(*OUTQ) USER(*PUBLIC)") == false)
                {
...
$$$ TO DO $$$ - delete this line */
         ...
         if (cmd.run("QSYS/CLROUTQ OUTQ(NPJAVA/RLSTST)") == false)
             {
         ...
         if (cmd.run("QSYS/DLTOUTQ OUTQ(NPJAVA/RLSTST)") == false)
             {
