  ...
  public static void main(String args[]) throws Exception {
    ...
    public void run()
    {
        ...
        try
            ...
            if (cmd.run("QSYS/CRTOUTQ OUTQ(NPJAVA/CLEARTST) AUTCHK(*DTAAUT)") == false)
                {
            ...
            if (cmd.run("QSYS/GRTOBJAUT OBJ(NPJAVA/CLEARTST) OBJTYPE(*OUTQ) USER(*PUBLIC)") == false)
                {
...
$$$ TO DO $$$ - delete this line */
	    ...
	    if (cmd.run("QSYS/CLROUTQ OUTQ(NPJAVA/CLEARTST)") == false)
                {
	    ...
	    // delete the output queue we created.
            if (cmd.run("QSYS/DLTOUTQ OUTQ(NPJAVA/CLEARTST)") == false)
                {
