...
//
// Filename:  NPAFPRNameTestcase.java
//
...
/**
 Testcase NPAFPRNameTestcase.
 **/
public class NPAFPRNameTestcase extends Testcase
{
  public static void main(String args[]) throws Exception {
    String[] newArgs = new String[args.length+2];
     newArgs[0] = "-tc";
     newArgs[1] = "NPAFPRNameTestcase";
     ...
     **/
    public NPAFPRNameTestcase(AS400            systemObject,
	...
	// in this testcase.
	super(systemObject, "NPAFPRNameTestcase", 1,
    ...
    public void run()
    {
        output_.println("NPPrintTest::NPAFPRNameTestcase");
...
$$$ TO DO $$$ - delete this line */
    ...
    /**
     Tests retrieving the AFP Resource name.
     **/
    public void Var001()
    {
        try
            ...
            if (res.getName().trim().equals("C0D0GB10")) succeeded();
            else failed("Could not retrive AFP Resource name");
