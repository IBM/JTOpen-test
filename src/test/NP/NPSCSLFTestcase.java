...
/**
  Testcase NPSCSLFTestcase.
  Test the lineFeed method of the SCS5256Writer class.
  **/
public class NPSCSLFTestcase extends Testcase
{
  public static void main(String args[]) throws Exception {
    String[] newArgs = new String[args.length+2];
     newArgs[0] = "-tc";
     newArgs[1] = "NPSCSLFTestcase";
...
/**
  ...
  **/
  public NPSCSLFTestcase(AS400            systemObject,
                       ...
                       FileOutputStream fileOutputStream)
  {
    ...
    // in this testcase.
    super(systemObject, "NPSCSLFTestcase", 1,
...
/**
  Tests the lineFeed method of the SCS5256Writer class.
  **/
  public void Var001()
  {
    setVariation(1);
