...
//
// Filename:  NPSCSCloseTestcase.java
//
...
/**
  Testcase NPSCSCloseTestcase.
  Test the close method of the SCS5256Writer class.
  **/
public class NPSCSCloseTestcase extends Testcase
{
  public static void main(String args[]) throws Exception {
    String[] newArgs = new String[args.length+2];
     newArgs[0] = "-tc";
     newArgs[1] = "NPSCSCloseTestcase";
...
/**
  ...
  **/
  public NPSCSCloseTestcase(AS400            systemObject,
                         ...
                         FileOutputStream fileOutputStream)
  {
    ...
    // in this testcase.
    super(systemObject, "NPSCSCloseTestcase", 1,
...
/**
  Tests the close method of the SCS5256Writer class.
  **/
  public void Var001()
  {
    setVariation(1);
