...
//
// Filename:  NPSCSFlushTestcase.java
//
...
/**
  Testcase NPSCSFlushTestcase.
  Test the flush method of the SCS5256Writer class.
  **/
public class NPSCSFlushTestcase extends Testcase
{
  public static void main(String args[]) throws Exception {
    String[] newArgs = new String[args.length+2];
     newArgs[0] = "-tc";
     newArgs[1] = "NPSCSFlushTestcase";
...
/**
  ...
  **/
  public NPSCSFlushTestcase(AS400            systemObject,
                         ...
                         FileOutputStream fileOutputStream)
  {
    ...
    // in this testcase.
    super(systemObject, "NPSCSFlushTestcase", 3,
...
/**
  Tests the flush method of the SCS5256Writer class with no data to flush.
  **/
  public void Var001()
  {
    setVariation(1);
...
/**
  Tests the flush method of the SCS5256Writer class with data to flush.
  **/
  public void Var002()
  {
    setVariation(2);
    ...
    {
        SCS5256Writer writer = new SCS5256Writer(out, systemObject_.getCcsid(), systemObject_);
        writer.write("Here is some sample data.");
        writer.flush();
        writer.close();
        succeeded();
    }
...
/**
  Tests the flush method of the SCS5256Writer class on a closed stream.
