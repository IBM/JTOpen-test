...
//
// Filename:  NPWrtJListSystemTestcase.java
//
...
/**
 Testcase NPWrtJListSystemTestcase.
 **/
public class NPWrtJListSystemTestcase extends Testcase
{
  public static void main(String args[]) throws Exception {
    String[] newArgs = new String[args.length+2];
     newArgs[0] = "-tc";
     newArgs[1] = "NPWrtJListSystemTestcase";
	...
	// in this testcase.
        super(systemObject, "NPWrtJListSystemTestcase", 8,
    ...
    public void run()
    {
        output_.println("NPPrintTest::NPWrtJListSystemTestcase");
...
$$$ TO DO $$$ - delete this line */
    ...
    /**
     * Tests setting the Writer Job List's system name to null.
     **/
    public void Var001()
    {
        try
    ...
    /**
     * Tests retrieving the Writer Job List's system name before it is set.
     **/
    public void Var002()
    {
        try
    ...
    /**
     * Tests retrieving the Writer Job List system name.
     **/
    public void Var003()
    {
        try
    ...
    public void Var004()
    {
        ...
        try
            {
            // create an Writer Job List object using the default constructor
            WriterJobList list = new WriterJobList();
     ...
     * WriterJobList's system property change is vetoed.
     **/
    public void Var006()
    {
        // Define inner class to listen for property change events
...
} // end NPWrtJListSystemTestcase class
