...
public class NPOutQSerializeTestcase extends Testcase
{
	...
	boolean allVariations = (variationsToRun_.size() == 0);
        ...
        try
            ...
            if (cmd.run("CRTOUTQ OUTQ(NPJAVA/SERTST) AUTCHK(*DTAAUT)") == false)
                {
            ...
            if (cmd.run("GRTOBJAUT OBJ(NPJAVA/SERTST) OBJTYPE(*OUTQ) USER(*PUBLIC)") == false)
                {
...
$$$ TO DO $$$ - delete this line */
            ...
            if (cmd.run("CLROUTQ OUTQ(NPJAVA/SERTST)") == false)
                {
            ...
            if (cmd.run("DLTOUTQ OUTQ(NPJAVA/SERTST)") == false)
                {
