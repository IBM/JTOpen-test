...
public class NPOutQNameTestcase extends Testcase
{
  public static void main(String args[]) throws Exception {
	...
	try
            ...
            if (cmd.run("QSYS/CRTOUTQ OUTQ(NPJAVA/NAMETST) AUTCHK(*DTAAUT)") == false)
                {
            ...
            if (cmd.run("QSYS/GRTOBJAUT OBJ(NPJAVA/NAMETST) OBJTYPE(*OUTQ) USER(*PUBLIC)") == false)
                {
...
$$$ TO DO $$$ - delete this line */
            ...
            if (cmd.run("QSYS/CLROUTQ OUTQ(NPJAVA/NAMETST)") == false)
                {
            ...
            if (cmd.run("QSYS/DLTOUTQ OUTQ(NPJAVA/NAMETST)") == false)
                {
