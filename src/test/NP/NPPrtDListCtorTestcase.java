...
//
// Filename:  NPPrtDListCtorTestcase.java
//
...
/**
 Testcase NPPrtDListCtorTestcase.
 **/
public class NPPrtDListCtorTestcase extends Testcase

{
  public static void main(String args[]) throws Exception {
    String[] newArgs = new String[args.length+2];
     newArgs[0] = "-tc";
     newArgs[1] = "NPPrtDListCtorTestcase";
                                  ...
                                  FileOutputStream fileOutputStream)
    {
        ...
        // in this testcase.
        super(systemObject, "NPPrtDListCtorTestcase", 2,
    ...
    public void run()
    {
        output_.println("NPPrintTest::NPPrtDListCtorTestcase");
...
$$$ TO DO $$$ - delete this line */
    ...
    /**
     * Tests constructing an Printer Device List with good system parameter.
    ...
    public void Var001()
    {
        try
            {
            // create an Printer Device list object
    ...
    /**
     * Tests constructing an Printer Device List with null system parameter.
     * Expects NullPointerException
     **/
    public void Var002()
    {
        try
            {
            // create an Printer Device list object
            PrinterList prtDList = new PrinterList(null);
...
} // end NPPrtDListCtorTestcase class
