...
//
// Filename:  NPPrtFListSystemTestcase.java
//
...
/**
 Testcase NPPrtFListSystemTestcase.
 **/
public class NPPrtFListSystemTestcase extends Testcase
{
  public static void main(String args[]) throws Exception {
    String[] newArgs = new String[args.length+2];
     newArgs[0] = "-tc";
     newArgs[1] = "NPPrtFListSystemTestcase";
	...
	// in this testcase.
        super(systemObject, "NPPrtFListSystemTestcase", 8,
    ...
    public void run()
    {
        output_.println("NPPrintTest::NPPrtFListSystemTestcase");
...
$$$ TO DO $$$ - delete this line */
    ...
    /**
     * Tests setting the Printer File List's system name to null.
     **/
    public void Var001()
    {
        try
    ...
    /**
     * Tests retrieving the Printer File List's system name before it is set.
     **/
    public void Var002()
    {
        try
    ...
    /**
     * Tests retrieving the Printer File List system name.
     **/
    public void Var003()
    {
        try
            ...
            if (prtFList.getSystem().equals(systemObject_)) succeeded();
            else failed("Could not retrive Printer File List system name.");
     ...
     * PrinterFileList's system is set.
     **/
    ...
    public void Var004()
    {
        ...
        try
            {
            // create an Printer File Listobject using the default constructor
            PrinterFileList list = new PrinterFileList();
     ...
     * PrinterFileList's system property change is vetoed.
     **/
    public void Var006()
    {
        // Define inner class to listen for property change events
...
} // end NPPrtFListSystemTestcase class
