...
//
// Filename:  NPSplFListSystemTestcase.java
//
...
/**
 Testcase NPSplFListSystemTestcase.
 **/
public class NPSplFListSystemTestcase extends Testcase
{
  public static void main(String args[]) throws Exception {
    String[] newArgs = new String[args.length+2];
     newArgs[0] = "-tc";
     newArgs[1] = "NPSplFListSystemTestcase";
     ...
     **/
    public NPSplFListSystemTestcase(AS400            systemObject,
	...
	// in this testcase.
        super(systemObject, "NPSplFListSystemTestcase", 8,
    ...
    public void run()
    {
        output_.println("NPPrintTest::NPSplFListSystemTestcase");
...
$$$ TO DO $$$ - delete this line */
    ...
    /**
     * Tests setting the Spooled File List's system name to null.
     **/
    public void Var001()
    {
        try
    ...
    /**
     * Tests retrieving the Spooled File List's system name before it is set.
     **/
    public void Var002()
    {
        try
    ...
    /**
     * Tests retrieving the Spooled File List system name.
     **/
    public void Var003()
    {
        try
            ...
            if (splFList.getSystem().equals(systemObject_)) succeeded();
            else failed("Could not retrive Spooled File List system name.");
     ...
     * SpooledFileList's system is set.
     **/
    ...
    public void Var004()
    {
        ...
        try
            {
            // create an Spooled File Listobject using the default constructor
            SpooledFileList list = new SpooledFileList();
     ...
     * SpooledFileList's system property change is vetoed.
     **/
    public void Var006()
    {
        // Define inner class to listen for property change events
...
} // end NPSplFListSystemTestcase class
