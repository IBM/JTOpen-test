...
//
// Filename:  DDMFormat3Field3KeyShort.java
//
...
class DDMFormat3Field3KeyShort extends RecordFormat
{
  private static final long serialVersionUID = 1L;

  DDMFormat3Field3KeyShort(AS400 sys)
  {
    super("Fld3Key3");
    AS400Text txt = new AS400Text(10, sys.getCcsid(), sys);
