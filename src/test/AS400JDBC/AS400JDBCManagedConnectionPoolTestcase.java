  ...
  public static void main(String args[]) throws Exception {
    ...
    public void setup()
    {
	    ...
	    PasswordVault.clearPassword(charPassword);
            ...
            if (DEBUG) System.out.println("setup: lookup(\"StatementPoolingDataSource\"" + ")");
            ...
            try
            {
              ...
              { // Request another connection.
                ...
                else
                {
                  ...
                  if (DEBUG) System.out.println("ConnectionGetter("+threadName_+") - get( pwd="+new String(charPassword)+",***)");
