...
//
// Filename:  AS400JDBCManagedConnectionPoolTestcase.java
//
...
/**
  Testcase AS400JDBCManagedConnectionPoolTestcase.
 **/
public class AS400JDBCManagedConnectionPoolTestcase extends Testcase
{
  public static void main(String args[]) throws Exception {
     ...
     **/
    public AS400JDBCManagedConnectionPoolTestcase(AS400 systemObject,
                                           ...
                                           ///int duration)
    {
        super(systemObject, "AS400JDBCManagedConnectionPoolTestcase", variationsToRun,
    ...
    public void setup()
    {
	    ...
	    PasswordVault.clearPassword(charPassword);
            ...
            if (DEBUG) output_.println("setup: Constructing AS400JDBCManagedDataSource (mds0)");
            AS400JDBCManagedDataSource mds0 = new AS400JDBCManagedDataSource(/*systemObject_*/);
            ...
            if (DEBUG) output_.println("setup: lookup(\"StatementPoolingDataSource\"" + ")");
            dataSource_ = (DataSource)ctx.lookup("StatementPoolingDataSource");
    ...
    **/
	...
	char[] charPassword = PasswordVault.decryptPassword(encryptedPassword_);
	Connection c2 = ((AS400JDBCManagedDataSource)dataSource_).getConnection(systemObject_.getUserId(), charPassword);
	PasswordVault.clearPassword(charPassword);
            ...
            try
            {
              ...
              { // Request another connection.
                ...
                else
                {
                  ...
                  if (DEBUG) output_.println("ConnectionGetter("+threadName_+") - get( pwd="+new String(charPassword)+",***)");
