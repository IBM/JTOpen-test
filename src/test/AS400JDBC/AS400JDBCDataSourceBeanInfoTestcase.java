...
public class AS400JDBCDataSourceBeanInfoTestcase extends Testcase
{
  public static void main(String args[]) throws Exception {
   ...
   public AS400JDBCDataSourceBeanInfoTestcase(AS400 systemObject,
                                 ...
                                 String password)
   {
      super(systemObject, "AS400JDBCDataSourceBeanInfoTestcase", variationsToRun,
   ...
   /**
   Verify the constructor, AS400JDBCDataSourceBeanInfo().
   <br>
   Expected results:
   <ul>
   ...
   **/
   ...
   /**
   Verify AS400JDBCDataSourceBeanInfo::getBeanDescriptor().
   <br>
   Expected results:
   <ul>
   ...
   **/
   public void Var002()
   {
      try
      {
         ...
         if (!bd.getBeanClass().getName().equals("com.ibm.as400.access.AS400JDBCDataSource") || bd.getCustomizerClass() != null)
         {
   ...
   **/
   ...
   /**
   Verify AS400JDBCDataSourceBeanInfo::getPropertyDescriptors().
   <br>
   Expected results:
   <ul>
