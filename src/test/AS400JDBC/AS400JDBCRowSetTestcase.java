...
public class AS400JDBCRowSetTestcase extends Testcase
{
  public static void main(String args[]) throws Exception {
     ...
     **/
    public AS400JDBCRowSetTestcase(AS400 systemObject,
    ...
    {
        super(systemObject, "AS400JDBCRowSetTestcase", variationsToRun,
   ...
   PasswordVault.clearPassword(charPassword);
            ...
            s.executeUpdate("CREATE TABLE " + collName_ + "." + dbaseName_ + " (NAME VARCHAR(10), ID INTEGER, STATE VARCHAR(2), WORTH DOUBLE)");
            s.close();

            PreparedStatement ps = c.prepareStatement("INSERT INTO " + collName_ + "." + dbaseName_ + " (NAME, ID, STATE, WORTH) VALUES (?,?,?,?)");
            for (int i=0; i< 50; i++)
            {
    ...
    /**
    *  Validates that absolute(int) updates the position of the result set as expected.
    **/
    public void Var001()
    {
        try
   ...
   PasswordVault.clearPassword(charPassword);
    ...
    /**
    *  Validates that afterLast(int) updates the position of the result set as expected.
    **/
    public void Var002()
    {
        try
   ...
   PasswordVault.clearPassword(charPassword);
    ...
    /**
    *  Validates that beforeFirst(int) updates the position of the result set as expected.
    **/
    public void Var003()
    {
        try
   ...
   PasswordVault.clearPassword(charPassword);
    ...
    /**
    *  Validates that isBeforeFirst() returns the position of the result set as expected.
    **/
    public void Var005()
    {
        try
   ...
   PasswordVault.clearPassword(charPassword);
    ...
    /**
    *  Validates that addRowSetListener(RowSetListener) notifies listeners when the row set changes.
    **/
    public void Var014()
    {
        try
   ...
   PasswordVault.clearPassword(charPassword);
    ...
    /**
    *  Validates that addRowSetListener(RowSetListener) notifies listeners when the cursor moves - absolute.
    **/
    public void Var015()
    {
        try
   ...
   PasswordVault.clearPassword(charPassword);
    ...
    /**
    *  Validates that addRowSetListener(RowSetListener) notifies listeners when the cursor moves - afterLast.
    **/
    public void Var016()
    {
        try
   ...
   PasswordVault.clearPassword(charPassword);
    ...
    /**
    *  Validates that addRowSetListener(RowSetListener) notifies listeners when the cursor moves - beforeFirst.
    **/
    public void Var017()
    {
        try
   ...
   PasswordVault.clearPassword(charPassword);
    ...
    /**
    *  Validates that addRowSetListener(RowSetListener) notifies listeners when the cursor moves - first.
    **/
    public void Var018()
    {
        try
   ...
   PasswordVault.clearPassword(charPassword);
    ...
    /**
    *  Validates that addRowSetListener(RowSetListener) notifies listeners when the cursor moves - last.
    **/
    public void Var019()
    {
        try
   ...
   PasswordVault.clearPassword(charPassword);
    ...
    /**
    *  Validates that addRowSetListener(RowSetListener) notifies listeners when the cursor moves - moveToCurrentRow.
    **/
    public void Var020()
    {
        try
   ...
   PasswordVault.clearPassword(charPassword);
    ...
    /**
    *  Validates that addRowSetListener(RowSetListener) notifies listeners when the cursor moves - moveToInsertRow.
    **/
    public void Var021()
    {
        try
   ...
   PasswordVault.clearPassword(charPassword);
    ...
    /**
    *  Validates that addRowSetListener(RowSetListener) notifies listeners when the cursor moves - next.
    **/
    public void Var022()
    {
        try
   ...
   PasswordVault.clearPassword(charPassword);
    ...
    /**
    *  Validates that addRowSetListener(RowSetListener) notifies listeners when the cursor moves - previous.
    **/
    public void Var023()
    {
        try
   ...
   PasswordVault.clearPassword(charPassword);
    ...
    /**
    *  Validates that addRowSetListener(RowSetListener) notifies listeners when the cursor moves - relative.
    **/
    public void Var024()
    {
        try
   ...
   PasswordVault.clearPassword(charPassword);
            ...
            checkLog("as400: RowSet", "execute().",sb) &&
            checkLog("as400: RowSet", "connect().",sb); 
    ...
    /**
    *  Validates that execute() throws an ExtendedIllegalStateException if the data source name is not found in JNDI.
    **/
    public void Var029()
    {
        AS400JDBCRowSet rowset = null;
   ...
   PasswordVault.clearPassword(charPassword);
    ...
    /**
    *  Validates execute() throws an ExtendedIllegalStateException if the dataSourceName is null.
    **/
    public void Var030()
    {
        AS400JDBCRowSet rowset = null;
   ...
   PasswordVault.clearPassword(charPassword);
    ...
    /**
    *  Validates that addPropertyChangeListener(listener) throws a NullPointerException is the listener is null.
    **/
    public void Var031()
    {
        try
    ...
    /**
    *  Validates that removePropertyChangeListener(listener) throws a NullPointerException is the listener is null.
    **/
    public void Var032()
    {
        try
    ...
    /**
    *  Validates that execute() throws an ExtendedIllegalStateException if the url is null.
    **/
    public void Var033()
    {
        AS400JDBCRowSet rowset = null;
   ...
   PasswordVault.clearPassword(charPassword);
    ...
    /**
    *  Validates that the url with username and password can be used to make a connection.
    **/
    public void Var035()
    {
        AS400JDBCRowSet rowset = null;
   ...
   PasswordVault.clearPassword(charPassword);
    ...
    /**
    *  Validates that addPropertyChangeListener(listener) notifies the listeners as expected.
    **/
    public void Var036()
    {
        try
    ...
    **/
    public void Var037()
    {
        try
        {
            ...
            assertCondition(!listener.isChanged() && rowset.getCommand().equals("SELECT CUSTID FROM QIWS.QCUSTCDT WHERE CUSTID > 1000"), "before="+before);
        }
        catch (Exception e)
        {
            failed(e, "Unexpected exception.");
    ...
    /**
    *  Validates that the transaction isolation can be set before the connection is made.
    **/
    public void Var038()
    {
        AS400JDBCRowSet rowset = null;
   ...
   PasswordVault.clearPassword(charPassword);
    ...
    /**
    *  Validates that getConcurrency() returns the expected value after an execute is completed.
    **/
    public void Var039()
    {
        AS400JDBCRowSet rowset = null;
   ...
   PasswordVault.clearPassword(charPassword);
    ...
    /**
    *  Validates that getFetchDirection() returns the expected value from the statement if the result set doesn't exist.
    **/
    public void Var040()
    {
        AS400JDBCRowSet rowset = null;
   ...
   PasswordVault.clearPassword(charPassword);
    ...
    /**
    *  Validates that getFetchSize() returns the expected value from the statement if the result set doesn't exist.
    **/
    public void Var041()
    {
        AS400JDBCRowSet rowset = null;
   ...
   PasswordVault.clearPassword(charPassword);
    ...
    /**
    *  Validates that setCommand(String) throws a NullPointerException if the command is null.
    **/
    public void Var042()
    {
        AS400JDBCRowSet rowset = null;
   ...
   PasswordVault.clearPassword(charPassword);
    ...
    /**
    *  Validates that setConcurrency(int) throws a ExtendedIllegalArgumentException if the concurrency is invalid.
    **/
    public void Var043()
    {
        AS400JDBCRowSet rowset = null;
   ...
   PasswordVault.clearPassword(charPassword);
    ...
    /**
    *  Validates that setType(int) throws a ExtendedIllegalArgumentException if the type is invalid.
    **/
    public void Var045()
    {
        AS400JDBCRowSet rowset = null;
   ...
   PasswordVault.clearPassword(charPassword);
    ...
    /**
    *  Validates that setReadOnly(boolean) works as expected after the connection is made.
    **/
    public void Var046()
    {
        AS400JDBCRowSet rowset = null;
   ...
   PasswordVault.clearPassword(charPassword);
    ...
    /**
    *  Validates that setTypeMap(String) throws a NullPointerException if the type map is null.
    **/
    public void Var047()
    {
        AS400JDBCRowSet rowset = null;
   ...
   PasswordVault.clearPassword(charPassword);
	    ...
	    // 10/15/2015 added @setConcurrency
            assertCondition (checkLog("as400@setConcurrency: RowSet","concurrency = \"" + ResultSet.CONCUR_UPDATABLE + "\".", sb), 
   ...
   PasswordVault.clearPassword(charPassword);
            ...
            rowset.execute();
            StringBuffer sb = new StringBuffer(); 
            assertCondition (checkLog("as400@setType: RowSet ","type = \"" + ResultSet.TYPE_FORWARD_ONLY + "\".", sb), sb.toString()+" 10/15/2014 added @setType");
        }
        catch (Exception e)
        {
            failed(e, "Unexpected exception.");
    ...
    /**
    *  Validates that setUsername(String) throws an ExtendedIllegalStateException if the connection is active.
    **/
    public void Var052()
    {
        AS400JDBCRowSet rowset = null;
   ...
   PasswordVault.clearPassword(charPassword);
    ...
    //@A4A
    /**
    *  Validates that setContext(Context) throws a NullPointerException if the command is null.
    **/
    public void Var054()
    {
        AS400JDBCRowSet rowset = null;
   ...
   PasswordVault.clearPassword(charPassword);
    ...
    //@A8A
    /**
    *  Validates that setEnvironment(environment) throws a NullPointerException if the environment is null.
    **/
    public void Var055()
    {
        AS400JDBCRowSet rowset = null;
