 ...
 **/
public class ODTest extends TestDriver
{
    /**
    ...
    public static void main(String args[])
    {
        try
        {
            TestDriver.runApplication(new ODTest(args));
        }
        catch (Exception e)
        {
     ...
     **/
    public ODTest() throws Exception
    {
        super();
    }
    ...
    /**
     ...
     @exception  Exception  If an exception occurs.
     **/
    public ODTest(String[] args) throws Exception
    {
        super(args);
    }
