...
public class JTAStdUpdate extends JTATestcase {
  public static void main(String args[]) throws Exception {
    String[] newArgs = new String[args.length+2];
     newArgs[0] = "-tc";
     newArgs[1] = "JTAStdUpdate";
   ...
   private String basTbl = JTATest.COLLECTION + ".CHARTABUPD";
...
**/
   public JTAStdUpdate (AS400 systemObject,
                        ...
                        String password) {
      super (systemObject, "JTAStdUpdate",
...
**/
   ...
   throws Exception
   {
      ...
      basTbl = JTATest.COLLECTION + ".CHARTABUPD";
      if (isJdbc20StdExt ()) {
