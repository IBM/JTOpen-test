 ...
 **/
public class FATest extends TestDriver
{
    /**
    ...
    public static void main(String args[])
    {
        try
        {
            TestDriver.runApplication(new FATest(args));
        }
        catch (Exception e)
        {
     ...
     **/
    public FATest() throws Exception
    {
        super();
    }
    ...
    /**
     ...
     @exception  Exception  If an exception occurs.
     **/
    public FATest(String[] args) throws Exception
    {
        super(args);
    }
    ...
    public void createTestcases()
    {
        ...
        for (int i = 0; i < testcases.length; ++i)
        {
            testcases[i].setTestcaseParameters(systemObject_, pwrSys_, systemName_, userId_, password_, proxy_, 
            		mustUseSockets_, isNative_, isLocal_, onAS400_, namesAndVars_, runMode_, fileOutputStream_,  pwrSysUserID_, pwrSysPassword_);
