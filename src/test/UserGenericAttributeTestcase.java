...
public class UserGenericAttributeTestcase extends Testcase
{
     ...
     **/
    static boolean verifyAttributeMetaData(ResourceMetaData amd, Object attributeID, Class attributeType, boolean readOnly, int possibleValueCount, Object defaultValue, boolean valueLimited, boolean multipleAllowed)
    {
