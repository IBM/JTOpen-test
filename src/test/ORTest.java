 ...
 **/
public class ORTest extends TestDriver
{
    public static String COLLECTION = "ORTEST"; 
    /**
    ...
    public static void main(String args[])
    {
        try
        {
            TestDriver.runApplication(new ORTest(args));
        }
        catch (Exception e)
        {
     ...
     **/
    public ORTest() throws Exception
    {
        super();
    }
    ...
    /**
     ...
     @exception  Exception  If an exception occurs.
     **/
    public ORTest(String[] args) throws Exception
    {
        super(args);
    }
