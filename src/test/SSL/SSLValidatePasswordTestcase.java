...
{
    /**
     Create a default SecureAS400 object and try to validate the user without having the system set.
    ...
    /**
     Create a default SecureAS400 and try to validate with null for user ID.
    ...
    /**
     Create a default SecureAS400 and try to validate with a null for password.
     A NullPointerException should be thrown.
     (validateSignon(String, String))
     **/
    public void Var003()
    ...
    /**
     ...
     An AS400SecurityException should be thrown, with a return code of INCORRECT_PASSWORD.
     (validateSignon(String, String))
     **/
    public void Var005()
    {
