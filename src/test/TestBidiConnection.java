...
public class TestBidiConnection extends TestBidiBasic {
	...
	public TestBidiConnection() {
		super();	  
		metadata_reordering = false;
		driverUrlBase="jdbc:as400://"; 
	}

	public TestBidiConnection(String driverUrlBase, String host, String username, String password) {
		super();	  
		metadata_reordering = false;  
		this.host = host;
	...
	public static void main(String[] args) {						
		...
		TestBidiConnection t = new TestBidiConnection("jdbc:as400://", args[0], args[1], args[2]);
