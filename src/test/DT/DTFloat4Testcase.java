  ...
  public static void main(String args[]) throws Exception {
    ...
    public void Var001()
    {
        try
        {
            ...
            assertCondition(true, "conv is "+conv);; 
        }
        catch (Exception e)
        {
    ...
    public void Var038()
    {
        ...
        try
        {
            ...
            failed("no exception thrown for to small array"+f);
        }
        catch (Exception e)
        {
            if (exceptionIs(e, "ArrayIndexOutOfBoundsException"))
    ...
    public void Var039()
    {
        ...
        try
        {
            ...
            failed("no exception thrown for null pointer"+f);
        }
        catch (Exception e)
        {
            if (exceptionIs(e, "NullPointerException"))
    ...
    public void Var042()
    {
        ...
        try
        {
            ...
            failed("no exception thrown for not enough space"+f);
        }
        catch (Exception e)
        {
            if (exceptionIs(e, "ArrayIndexOutOfBoundsException"))
    ...
    public void Var043()
    {
        ...
        try
        {
            ...
            failed("no exception thrown for negative value"+f);
        }
        catch (Exception e)
        {
            if (exceptionIs(e, "ArrayIndexOutOfBoundsException"))
